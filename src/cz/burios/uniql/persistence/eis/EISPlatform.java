...
public class EISPlatform extends DatasourcePlatform {
    ...
    public void appendParameter(Call call, Writer writer, Object parameter) {
        ...
        } else if (parameter instanceof cz.burios.uniql.persistence.oxm.record.DOMRecord) {
            String xml = ((cz.burios.uniql.persistence.oxm.record.DOMRecord)parameter).transformToXML();
