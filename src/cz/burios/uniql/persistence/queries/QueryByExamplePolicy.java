...
public class QueryByExamplePolicy implements java.io.Serializable {
     ...
     * <p>
     * Any comparison operation in {@link cz.burios.uniql.persistence.expressions.Expression Expression} which takes the example attribute as a parameter
     ...
     * options are {@link cz.burios.uniql.persistence.expressions.Expression#isNull() isNull} (default) and
     * {@link cz.burios.uniql.persistence.expressions.Expression#notNull() notNull}.  See
     ...
     * @see cz.burios.uniql.persistence.expressions.Expression#equal equal (default)
     * @see cz.burios.uniql.persistence.expressions.Expression#notEqual notEqual
     * @see cz.burios.uniql.persistence.expressions.Expression#equalsIgnoreCase equalsIgnoreCase
     * @see cz.burios.uniql.persistence.expressions.Expression#lessThan lessThan
     * @see cz.burios.uniql.persistence.expressions.Expression#lessThanEqual lessThanEqual
     * @see cz.burios.uniql.persistence.expressions.Expression#greaterThan greaterThan
     * @see cz.burios.uniql.persistence.expressions.Expression#greaterThanEqual greaterThanEqual
     * @see cz.burios.uniql.persistence.expressions.Expression#like like
     * @see cz.burios.uniql.persistence.expressions.Expression#likeIgnoreCase likeIgnoreCase
     * @see cz.burios.uniql.persistence.expressions.Expression#containsAllKeyWords containsAllKeyWords
     * @see cz.burios.uniql.persistence.expressions.Expression#containsAnyKeyWords containsAnyKeyWords
     * @see cz.burios.uniql.persistence.expressions.Expression#containsSubstring(java.lang.String) containsSubstring
     * @see cz.burios.uniql.persistence.expressions.Expression#containsSubstringIgnoringCase(java.lang.String) containsSubstringIgnoringCase
     */
