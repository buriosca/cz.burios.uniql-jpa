...
import cz.burios.uniql.persistence.config.ParameterDelimiterType;
...
public abstract class DatabaseQuery implements Cloneable, Serializable {
     ...
     * SQL queries.
     * @see cz.burios.uniql.persistence.sessions.Project#setAllowNativeSQLQueries(boolean) Project.setAllowNativeSQLQueries(boolean)
     */
    ...
    public List<String> getArgumentTypeNames() {
        if (argumentTypeNames == null) {
            argumentTypeNames = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance();
        }
     ...
     * argument list.
     * 
     * @see #prepareCall(cz.burios.uniql.persistence.sessions.Session, cz.burios.uniql.persistence.sessions.Record) prepareCall(Session, Record)
     */
     ...
     * 
     * @see #prepareCall(cz.burios.uniql.persistence.sessions.Session, Record)
     */
    public String getTranslatedSQLString(cz.burios.uniql.persistence.sessions.Session session, Record translationRow) {
     ...
     * @see #prepareCall(cz.burios.uniql.persistence.sessions.Session, cz.burios.uniql.persistence.sessions.Record) prepareCall(Session, Record)
     */
    public List getTranslatedSQLStrings(cz.burios.uniql.persistence.sessions.Session session, Record translationRow) {
        prepareCall(session, translationRow);
        CallQueryMechanism queryMechanism = (CallQueryMechanism) getQueryMechanism();
     ...
     * @see #getCall()
     * @see #getSQLString()
     * @see #getTranslatedSQLString(cz.burios.uniql.persistence.sessions.Session,
     *      Record)
     */
    public void prepareCall(cz.burios.uniql.persistence.sessions.Session session, Record translationRow) throws QueryException {
        // CR#2859559 fix to use Session and Record interfaces not impl classes.
