    ...
    protected void prepareInternal(AbstractSession session) {
        if (hasCustomSQLArguments()) {
            ...
            if (getParameters().size() > 0) {
                ...
                setParameters(cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance());
                updatedParameterTypes = getParameterTypes();
                setParameterTypes(cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance());
            }
