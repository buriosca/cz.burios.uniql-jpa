    ...
    protected void buildResult(ReportQuery query, AbstractRecord row, Vector toManyData) {
        ...
        for (int index = 0; index < itemSize; index++) {
            ...
            if (item.isConstructorItem()) {
                ...
                ClassDescriptor descriptor = ((cz.burios.uniql.persistence.internal.expressions.ClassTypeExpression)item.getAttributeExpression()).getContainingDescriptor(query);
