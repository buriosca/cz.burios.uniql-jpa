 ...
 ******************************************************************************/  
package cz.burios.uniql.persistence.internal.oxm.record.namespaces;

import cz.burios.uniql.persistence.internal.oxm.Namespace;
import cz.burios.uniql.persistence.internal.oxm.NamespacePrefixMapper;
...
public class PrefixMapperNamespaceResolver extends NamespaceResolver {
    ...
    private cz.burios.uniql.persistence.internal.oxm.NamespaceResolver contextualNamespaces;
    
    public PrefixMapperNamespaceResolver(NamespacePrefixMapper mapper, cz.burios.uniql.persistence.internal.oxm.NamespaceResolver nestedResolver) {
        prefixMapper = mapper;
