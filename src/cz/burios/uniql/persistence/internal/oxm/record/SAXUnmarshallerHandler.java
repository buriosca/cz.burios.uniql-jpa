...
import cz.burios.uniql.persistence.internal.oxm.Context;
import cz.burios.uniql.persistence.internal.oxm.ConversionManager;
import cz.burios.uniql.persistence.internal.oxm.OXMSystemProperties;
...
import cz.burios.uniql.persistence.internal.oxm.mappings.UnmarshalKeepAsElementPolicy;
...
import cz.burios.uniql.persistence.oxm.MediaType;
import cz.burios.uniql.persistence.platform.xml.SAXDocumentBuilder;
        ...
        try {                   	
            ...
            if(xmlDescriptor == null){  
                ...
                if(xmlDescriptor.hasInheritance()){
                    ...
                    Class classValue = xmlDescriptor.getInheritancePolicy().classFromRow(new cz.burios.uniql.persistence.oxm.record.UnmarshalRecord(tmpUnmarshalRecord), (CoreAbstractSession) session);
                    if (classValue == null) {
                    ...
                    if (classValue != null) {                	 
                       ...
                       if (Modifier.isAbstract(xmlDescriptor.getJavaClass().getModifiers())) {
                           ...
                           throw DescriptorException.missingClassIndicatorField((XMLRecord) tmpUnmarshalRecord, (cz.burios.uniql.persistence.oxm.XMLDescriptor)xmlDescriptor.getInheritancePolicy().getDescriptor());
                       }
                   }
                }
            }
