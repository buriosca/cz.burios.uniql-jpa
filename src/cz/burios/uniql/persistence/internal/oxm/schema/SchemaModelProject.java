...
import cz.burios.uniql.persistence.internal.oxm.schema.model.*;
...
import cz.burios.uniql.persistence.oxm.mappings.*;
import cz.burios.uniql.persistence.oxm.mappings.nullpolicy.NullPolicy;
import cz.burios.uniql.persistence.sessions.Project;

/**
 * <p><b>Purpose</b>: TopLink OX project to map cz.burios.uniql.persistence.internal.schema.model.*
...
public class SchemaModelProject extends Project {
    ...
    private XMLDescriptor buildSimpleTypeDescriptor() {
        ...
        listMapping.setReferenceClass(cz.burios.uniql.persistence.internal.oxm.schema.model.List.class);
    ...
    private XMLDescriptor buildListDescriptor() {
        XMLDescriptor descriptor = new XMLDescriptor();
        descriptor.setJavaClass(cz.burios.uniql.persistence.internal.oxm.schema.model.List.class);
        descriptor.setNamespaceResolver(namespaceResolver);
    ...
    */
    /*
        private XMLDescriptor buildTypeDefParticleDescriptor() {
            ...
            //descriptor.getInheritancePolicy().setClassIndicatorField(new cz.burios.uniql.persistence.oxm.XMLField(""));
            XMLDirectMapping minOccursMapping = new XMLDirectMapping();
            minOccursMapping.setAttributeName("minOccurs");
            minOccursMapping.setXPath("@minOccurs");
            minOccursMapping.setNullValue(Occurs.ONE);
