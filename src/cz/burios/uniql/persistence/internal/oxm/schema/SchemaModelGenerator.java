...
******************************************************************************/
package cz.burios.uniql.persistence.internal.oxm.schema;
...
import cz.burios.uniql.persistence.core.descriptors.CoreInheritancePolicy;
...
import cz.burios.uniql.persistence.internal.oxm.Constants;
import cz.burios.uniql.persistence.internal.oxm.ConversionManager;
...
import cz.burios.uniql.persistence.internal.oxm.mappings.AnyAttributeMapping;
import cz.burios.uniql.persistence.internal.oxm.mappings.AnyCollectionMapping;
import cz.burios.uniql.persistence.internal.oxm.mappings.AnyObjectMapping;
import cz.burios.uniql.persistence.internal.oxm.mappings.BinaryDataCollectionMapping;
import cz.burios.uniql.persistence.internal.oxm.mappings.BinaryDataMapping;
import cz.burios.uniql.persistence.internal.oxm.mappings.ChoiceCollectionMapping;
import cz.burios.uniql.persistence.internal.oxm.mappings.ChoiceObjectMapping;
import cz.burios.uniql.persistence.internal.oxm.mappings.CollectionReferenceMapping;
import cz.burios.uniql.persistence.internal.oxm.mappings.CompositeCollectionMapping;
import cz.burios.uniql.persistence.internal.oxm.mappings.CompositeObjectMapping;
import cz.burios.uniql.persistence.internal.oxm.mappings.Descriptor;
import cz.burios.uniql.persistence.internal.oxm.mappings.DirectCollectionMapping;
import cz.burios.uniql.persistence.internal.oxm.mappings.DirectMapping;
...
import cz.burios.uniql.persistence.internal.oxm.mappings.ObjectReferenceMapping;
import cz.burios.uniql.persistence.internal.oxm.schema.model.Any;
import cz.burios.uniql.persistence.internal.oxm.schema.model.AnyAttribute;
import cz.burios.uniql.persistence.internal.oxm.schema.model.Attribute;
import cz.burios.uniql.persistence.internal.oxm.schema.model.Choice;
import cz.burios.uniql.persistence.internal.oxm.schema.model.ComplexContent;
import cz.burios.uniql.persistence.internal.oxm.schema.model.ComplexType;
import cz.burios.uniql.persistence.internal.oxm.schema.model.Element;
import cz.burios.uniql.persistence.internal.oxm.schema.model.Extension;
import cz.burios.uniql.persistence.internal.oxm.schema.model.Import;
import cz.burios.uniql.persistence.internal.oxm.schema.model.Occurs;
import cz.burios.uniql.persistence.internal.oxm.schema.model.Restriction;
import cz.burios.uniql.persistence.internal.oxm.schema.model.Schema;
import cz.burios.uniql.persistence.internal.oxm.schema.model.Sequence;
import cz.burios.uniql.persistence.internal.oxm.schema.model.SimpleContent;
import cz.burios.uniql.persistence.internal.oxm.schema.model.SimpleType;
...
public class SchemaModelGenerator {
            ...
            for(Entry<QName, Type> entry : additionalGlobalElements.entrySet()) {
                ...
                if (type instanceof Class) {
                    ...
                    if (typeAsQName == null) {
                        ...
                        if (schema == null) {
                            schema = buildNewSchema(nsKey, new cz.burios.uniql.persistence.oxm.NamespaceResolver(), schemaForNamespace.size(), properties);
    ...
    protected void processDescriptor(Descriptor desc, HashMap<String, Schema> schemaForNamespace, Schema workingSchema, SchemaModelGeneratorProperties properties, List<Descriptor> descriptors) {
        ...
        XMLSchemaReference schemaRef = desc.getSchemaReference();
        if (schemaRef != null) {
            if (schemaRef.getType() == cz.burios.uniql.persistence.platform.xml.XMLSchemaReference.COMPLEX_TYPE) {
            ...
            } else if (schemaRef.getType() == cz.burios.uniql.persistence.platform.xml.XMLSchemaReference.SIMPLE_TYPE) {
                workingSchema.addTopLevelSimpleTypes(buildSimpleType(desc, workingSchema, true));
            } else if (schemaRef.getType() == cz.burios.uniql.persistence.platform.xml.XMLSchemaReference.ELEMENT) {
    ...
    protected void processXMLCompositeDirectCollectionMapping(DirectCollectionMapping mapping, Sequence seq, ComplexType ct, HashMap<String, Schema> schemaForNamespace, Schema workingSchema, SchemaModelGeneratorProperties properties) {
        ...
        if (xmlField.usesSingleNode()) {
            SimpleType st = new SimpleType();
            cz.burios.uniql.persistence.internal.oxm.schema.model.List list = new cz.burios.uniql.persistence.internal.oxm.schema.model.List();
