...
import cz.burios.uniql.persistence.internal.oxm.WeakObjectWrapper;
...
public class XMLObjectBuilder extends ObjectBuilder {
   ...
   public AbstractRecord buildIntoNestedRow(AbstractRecord row, Object originalObject, Object object, AbstractSession session, Descriptor refDesc, Field xmlField, boolean wasXMLRoot) {
    ...
    public NamespaceResolver getNamespaceResolver() {
        ...
        } else if (getDescriptor() instanceof cz.burios.uniql.persistence.eis.EISDescriptor) {
            namespaceResolver = ((cz.burios.uniql.persistence.eis.EISDescriptor)getDescriptor()).getNamespaceResolver();
        }
