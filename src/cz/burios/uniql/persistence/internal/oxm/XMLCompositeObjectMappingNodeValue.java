...
import cz.burios.uniql.persistence.core.queries.CoreAttributeItem;
...
import cz.burios.uniql.persistence.internal.oxm.record.deferred.CompositeObjectMappingContentHandler;
	            ...
	            if (xmlDescriptor.hasInheritance()) {
	                ...
	                if (clazz != null) {
	                    ...
	                    if (Modifier.isAbstract(xmlDescriptor.getJavaClass().getModifiers())) {
	                        ...
	                        throw DescriptorException.missingClassIndicatorField(unmarshalRecord, (cz.burios.uniql.persistence.oxm.XMLDescriptor)xmlDescriptor.getInheritancePolicy().getDescriptor());
	                    }
	                }
	            }
