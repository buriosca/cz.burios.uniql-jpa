...
public final class OXMSystemProperties {
     ...
     * @since 2.6.0
     */
    public static final String JSON_TYPE_COMPATIBILITY = "cz.burios.uniql.persistence.json.type-compatibility";
     ...
     * @since 2.6.0
     */
    public static final String JSON_USE_XSD_TYPES_PREFIX = "cz.burios.uniql.persistence.json.use-xsd-types-prefix";
