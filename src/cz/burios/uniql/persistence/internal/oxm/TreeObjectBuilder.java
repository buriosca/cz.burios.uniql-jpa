...
public class TreeObjectBuilder extends XMLObjectBuilder implements ObjectBuilder<AbstractRecord, AbstractSession, ClassDescriptor, XMLMarshaller> {
    ...
    public void initialize(cz.burios.uniql.persistence.internal.sessions.AbstractSession session) {
    ...
    @Override
    public AbstractRecord buildRow(AbstractRecord record, Object object, cz.burios.uniql.persistence.internal.sessions.AbstractSession session, WriteType writeType) {
        return (AbstractRecord) buildRow((XMLRecord) record, object, session, null, null);
    }

    public cz.burios.uniql.persistence.internal.oxm.record.XMLRecord buildRow(cz.burios.uniql.persistence.internal.oxm.record.XMLRecord record, Object object, CoreAbstractSession session, XMLMarshaller marshaller, XPathFragment rootFragment) {
    ...
    public AbstractRecord createRecord(AbstractSession session) {
        xPathObjectBuilder.lazyInitialize();
        cz.burios.uniql.persistence.internal.oxm.record.UnmarshalRecordImpl uRec = new cz.burios.uniql.persistence.internal.oxm.record.UnmarshalRecordImpl(this);
    ...
    @Override
    public Class classFromRow(cz.burios.uniql.persistence.internal.oxm.record.UnmarshalRecord unmarshalRecord, AbstractSession session) {
    ...
    private static class InheritanceRecord extends cz.burios.uniql.persistence.oxm.record.XMLRecord {
