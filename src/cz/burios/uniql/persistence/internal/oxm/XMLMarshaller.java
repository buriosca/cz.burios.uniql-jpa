...
import cz.burios.uniql.persistence.internal.oxm.record.namespaces.PrefixMapperNamespaceResolver;
import cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper;
import cz.burios.uniql.persistence.oxm.JSONWithPadding;
import cz.burios.uniql.persistence.oxm.attachment.XMLAttachmentMarshaller;
import cz.burios.uniql.persistence.oxm.record.ContentHandlerRecord;
import cz.burios.uniql.persistence.oxm.record.FormattedOutputStreamRecord;
import cz.burios.uniql.persistence.oxm.record.FormattedWriterRecord;
import cz.burios.uniql.persistence.oxm.record.JSONFormattedWriterRecord;
import cz.burios.uniql.persistence.oxm.record.JSONWriterRecord;
import cz.burios.uniql.persistence.oxm.record.MarshalRecord;
import cz.burios.uniql.persistence.oxm.record.NodeRecord;
import cz.burios.uniql.persistence.oxm.record.OutputStreamRecord;
import cz.burios.uniql.persistence.oxm.record.ValidatingMarshalRecord;
import cz.burios.uniql.persistence.oxm.record.WriterRecord;
import cz.burios.uniql.persistence.oxm.schema.XMLSchemaReference;
import cz.burios.uniql.persistence.platform.xml.XMLPlatform;
...
public abstract class XMLMarshaller<
    ...
    private static final String XML_STREAM_WRITER_RECORD_CLASS_NAME = "cz.burios.uniql.persistence.oxm.record.XMLStreamWriterRecord";
    private static final String XML_EVENT_WRITER_RECORD_CLASS_NAME = "cz.burios.uniql.persistence.oxm.record.XMLEventWriterRecord";
    ...
    private static final String DOM_TO_STREAM_WRITER_CLASS_NAME = "cz.burios.uniql.persistence.internal.oxm.record.DomToXMLStreamWriter";
    private static final String DOM_TO_EVENT_WRITER_CLASS_NAME = "cz.burios.uniql.persistence.internal.oxm.record.DomToXMLEventWriter";
    ...
    */
     ...
     * See cz.burios.uniql.persistence.oxm.MediaType for the media types supported by EclipseLink MOXy
     * @param mediaType
     */
