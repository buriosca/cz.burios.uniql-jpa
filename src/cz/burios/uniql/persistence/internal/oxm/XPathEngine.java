...
import cz.burios.uniql.persistence.internal.oxm.mappings.UnionField;
...
import cz.burios.uniql.persistence.platform.xml.XMLNodeList;
...
>{
    ...
    *
    * @exception cz.burios.uniql.persistence.oxm.exceptions.XMLMarshalException Thrown if passed an invalid XPath string
    */
    ...
    */
    ...
    private NamespaceResolver getNamespaceResolverForField(Field field){
        NamespaceResolver nr = (cz.burios.uniql.persistence.oxm.NamespaceResolver) field.getNamespaceResolver();
        if(nr == null){
            field.setNamespaceResolver(new NamespaceResolver());
        }
        return (cz.burios.uniql.persistence.oxm.NamespaceResolver) field.getNamespaceResolver();
    }
