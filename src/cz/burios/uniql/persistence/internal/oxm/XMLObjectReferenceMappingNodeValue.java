 ...
 * 
 * <p>When unmarshalling, an instance of cz.burios.uniql.persistence.internal.oxm.Reference is 
 * created on a per mapping basis (keyed on source object instance) and sotred 
 * on the associated session's cz.burios.uniql.persistence.internal.oxm.ReferenceResolver 
 ...
 * 
 * @see cz.burios.uniql.persistence.internal.oxm.Reference
 * @see cz.burios.uniql.persistence.internal.oxm.ReferenceResolver
 * @see cz.burios.uniql.persistence.oxm.mappings.XMLObjectReferenceMapping
 */
...
public class XMLObjectReferenceMappingNodeValue extends MappingNodeValue {
     ...
     * cz.burios.uniql.persistence.internal.oxm.Reference instance to be used during 
