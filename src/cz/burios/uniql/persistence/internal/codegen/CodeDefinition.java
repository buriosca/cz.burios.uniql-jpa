...
public abstract class CodeDefinition {
    ...
    protected static final String TOPLINK_INDIRECTION_PACKAGE_NAME = "cz.burios.uniql.persistence.indirection";
    ...
    /**
     * Used for calculating imports.  @see cz.burios.uniql.persistence.internal.codegen.ClassDefinition#calculateImports()
     */
    ...
    public void write(CodeGenerator generator) {
        if (getComment().length() > 0) {
            ...
            String cr = cz.burios.uniql.persistence.internal.helper.Helper.cr();
            int lastLineIndex = 0;
