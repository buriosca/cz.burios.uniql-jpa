...
import cz.burios.uniql.persistence.internal.jpa.QueryImpl;
import cz.burios.uniql.persistence.internal.jpa.transaction.EntityTransactionWrapper;
 ...
 *
 * @see cz.burios.uniql.persistence.internal.jpa.transaction.EntityTransactionImpl
 */
    ...
    public void commit() {
        ...
        try {
            ...
            if (exception instanceof RollbackException) {
                throw exception;
            } else if (exception instanceof cz.burios.uniql.persistence.exceptions.OptimisticLockException) {
