 ...
 *****************************************************************************/
package cz.burios.uniql.persistence.internal.jpa;

import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.DDL_GENERATION;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.NONE;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_CREATE_ACTION;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_CREATE_DATABASE_SCHEMAS;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_CREATE_SCRIPT_SOURCE;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_CREATE_SOURCE;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_DATABASE_ACTION;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_DROP_ACTION;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_DROP_AND_CREATE_ACTION;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_DROP_SCRIPT_SOURCE;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_DROP_SOURCE;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_METADATA_SOURCE;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_METADATA_THEN_SCRIPT_SOURCE;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_NONE_ACTION;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_SCRIPTS_ACTION;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_SCRIPTS_CREATE_TARGET;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_SCRIPTS_DROP_TARGET;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_SCRIPT_SOURCE;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_SCRIPT_THEN_METADATA_SOURCE;
import static cz.burios.uniql.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_SQL_LOAD_SCRIPT_SOURCE;
import static cz.burios.uniql.persistence.internal.jpa.EntityManagerFactoryProvider.generateDefaultTables;
import static cz.burios.uniql.persistence.internal.jpa.EntityManagerFactoryProvider.getConfigProperty;
import static cz.burios.uniql.persistence.internal.jpa.EntityManagerFactoryProvider.getConfigPropertyAsString;
import static cz.burios.uniql.persistence.internal.jpa.EntityManagerFactoryProvider.getConfigPropertyAsStringLogDebug;
import static cz.burios.uniql.persistence.internal.jpa.EntityManagerFactoryProvider.getConfigPropertyLogDebug;
import static cz.burios.uniql.persistence.internal.jpa.EntityManagerFactoryProvider.hasConfigProperty;
import static cz.burios.uniql.persistence.internal.jpa.EntityManagerFactoryProvider.login;
import static cz.burios.uniql.persistence.internal.jpa.EntityManagerFactoryProvider.mergeMaps;
import static cz.burios.uniql.persistence.internal.jpa.EntityManagerFactoryProvider.translateOldProperties;
import static cz.burios.uniql.persistence.internal.jpa.EntityManagerFactoryProvider.warnOldProperties;
...
import cz.burios.uniql.persistence.annotations.IdValidation;
import cz.burios.uniql.persistence.config.BatchWriting;
import cz.burios.uniql.persistence.config.CacheCoordinationProtocol;
import cz.burios.uniql.persistence.config.DescriptorCustomizer;
import cz.burios.uniql.persistence.config.ExclusiveConnectionMode;
import cz.burios.uniql.persistence.config.LoggerType;
import cz.burios.uniql.persistence.config.ParserType;
import cz.burios.uniql.persistence.config.PersistenceUnitProperties;
import cz.burios.uniql.persistence.config.ProfilerType;
import cz.burios.uniql.persistence.config.PropertiesUtils;
import cz.burios.uniql.persistence.config.RemoteProtocol;
import cz.burios.uniql.persistence.config.SessionCustomizer;
import cz.burios.uniql.persistence.descriptors.ClassDescriptor;
import cz.burios.uniql.persistence.descriptors.MultitenantPolicy;
import cz.burios.uniql.persistence.descriptors.SchemaPerMultitenantPolicy;
import cz.burios.uniql.persistence.descriptors.TimestampLockingPolicy;
...
import cz.burios.uniql.persistence.eis.EISConnectionSpec;
import cz.burios.uniql.persistence.eis.EISLogin;
import cz.burios.uniql.persistence.eis.EISPlatform;
...
import cz.burios.uniql.persistence.exceptions.EclipseLinkException;
import cz.burios.uniql.persistence.exceptions.EntityManagerSetupException;
import cz.burios.uniql.persistence.exceptions.ExceptionHandler;
import cz.burios.uniql.persistence.exceptions.IntegrityException;
import cz.burios.uniql.persistence.exceptions.PersistenceUnitLoadingException;
import cz.burios.uniql.persistence.exceptions.ValidationException;
import cz.burios.uniql.persistence.internal.databaseaccess.BatchWritingMechanism;
import cz.burios.uniql.persistence.internal.databaseaccess.DatabaseAccessor;
import cz.burios.uniql.persistence.internal.databaseaccess.DatasourcePlatform;
import cz.burios.uniql.persistence.internal.databaseaccess.Platform;
import cz.burios.uniql.persistence.internal.descriptors.OptimisticLockingPolicy;
import cz.burios.uniql.persistence.internal.descriptors.OptimisticLockingPolicy.LockOnChange;
import cz.burios.uniql.persistence.internal.helper.ClassConstants;
import cz.burios.uniql.persistence.internal.helper.ConcurrencyManager;
import cz.burios.uniql.persistence.internal.helper.Helper;
import cz.burios.uniql.persistence.internal.helper.JPAClassLoaderHolder;
import cz.burios.uniql.persistence.internal.helper.JPAConversionManager;
import cz.burios.uniql.persistence.internal.jpa.deployment.BeanValidationInitializationHelper;
import cz.burios.uniql.persistence.internal.jpa.deployment.PersistenceUnitProcessor;
import cz.burios.uniql.persistence.internal.jpa.deployment.SEPersistenceUnitInfo;
import cz.burios.uniql.persistence.internal.jpa.jdbc.DataSourceImpl;
import cz.burios.uniql.persistence.internal.jpa.metadata.MetadataHelper;
import cz.burios.uniql.persistence.internal.jpa.metadata.MetadataLogger;
import cz.burios.uniql.persistence.internal.jpa.metadata.MetadataProcessor;
import cz.burios.uniql.persistence.internal.jpa.metadata.MetadataProject;
import cz.burios.uniql.persistence.internal.jpa.metadata.accessors.objects.MetadataAsmFactory;
import cz.burios.uniql.persistence.internal.jpa.metadata.xml.XMLEntityMappingsReader;
import cz.burios.uniql.persistence.internal.jpa.metamodel.ManagedTypeImpl;
import cz.burios.uniql.persistence.internal.jpa.metamodel.MetamodelImpl;
import cz.burios.uniql.persistence.internal.jpa.metamodel.proxy.AttributeProxyImpl;
import cz.burios.uniql.persistence.internal.jpa.metamodel.proxy.CollectionAttributeProxyImpl;
import cz.burios.uniql.persistence.internal.jpa.metamodel.proxy.ListAttributeProxyImpl;
import cz.burios.uniql.persistence.internal.jpa.metamodel.proxy.MapAttributeProxyImpl;
import cz.burios.uniql.persistence.internal.jpa.metamodel.proxy.SetAttributeProxyImpl;
import cz.burios.uniql.persistence.internal.jpa.metamodel.proxy.SingularAttributeProxyImpl;
import cz.burios.uniql.persistence.internal.jpa.weaving.ClassDetails;
import cz.burios.uniql.persistence.internal.jpa.weaving.PersistenceWeaver;
import cz.burios.uniql.persistence.internal.jpa.weaving.TransformerFactory;
import cz.burios.uniql.persistence.internal.localization.ExceptionLocalization;
import cz.burios.uniql.persistence.internal.localization.LoggingLocalization;
...
import cz.burios.uniql.persistence.internal.security.PrivilegedGetDeclaredField;
import cz.burios.uniql.persistence.internal.security.PrivilegedGetDeclaredFields;
import cz.burios.uniql.persistence.internal.security.PrivilegedGetDeclaredMethod;
import cz.burios.uniql.persistence.internal.security.PrivilegedGetValueFromField;
import cz.burios.uniql.persistence.internal.security.PrivilegedMethodInvoker;
import cz.burios.uniql.persistence.internal.security.PrivilegedNewInstanceFromClass;
import cz.burios.uniql.persistence.internal.security.SecurableObjectHolder;
...
import cz.burios.uniql.persistence.internal.sessions.remote.RemoteConnection;
import cz.burios.uniql.persistence.jpa.metadata.FileBasedProjectCache;
import cz.burios.uniql.persistence.jpa.metadata.MetadataSource;
import cz.burios.uniql.persistence.jpa.metadata.ProjectCache;
...
import cz.burios.uniql.persistence.logging.DefaultSessionLog;
import cz.burios.uniql.persistence.logging.SessionLog;
import cz.burios.uniql.persistence.platform.database.converters.StructConverter;
import cz.burios.uniql.persistence.platform.database.events.DatabaseEventListener;
import cz.burios.uniql.persistence.platform.database.partitioning.DataPartitioningCallback;
import cz.burios.uniql.persistence.platform.server.CustomServerPlatform;
import cz.burios.uniql.persistence.platform.server.ServerPlatform;
import cz.burios.uniql.persistence.platform.server.ServerPlatformBase;
import cz.burios.uniql.persistence.platform.server.ServerPlatformUtils;
import cz.burios.uniql.persistence.queries.QueryResultsCachePolicy;
import cz.burios.uniql.persistence.sequencing.Sequence;
import cz.burios.uniql.persistence.sessions.Connector;
import cz.burios.uniql.persistence.sessions.DatabaseLogin;
import cz.burios.uniql.persistence.sessions.DatasourceLogin;
import cz.burios.uniql.persistence.sessions.DefaultConnector;
import cz.burios.uniql.persistence.sessions.ExternalTransactionController;
import cz.burios.uniql.persistence.sessions.JNDIConnector;
import cz.burios.uniql.persistence.sessions.Project;
import cz.burios.uniql.persistence.sessions.Session;
import cz.burios.uniql.persistence.sessions.SessionEventListener;
import cz.burios.uniql.persistence.sessions.SessionProfiler;
import cz.burios.uniql.persistence.sessions.broker.SessionBroker;
import cz.burios.uniql.persistence.sessions.coordination.MetadataRefreshListener;
import cz.burios.uniql.persistence.sessions.coordination.RemoteCommandManager;
import cz.burios.uniql.persistence.sessions.coordination.TransportManager;
import cz.burios.uniql.persistence.sessions.coordination.jms.JMSPublishingTransportManager;
import cz.burios.uniql.persistence.sessions.coordination.jms.JMSTopicTransportManager;
// $ import cz.burios.uniql.persistence.sessions.coordination.rmi.RMITransportManager;
import cz.burios.uniql.persistence.sessions.factories.SessionManager;
import cz.burios.uniql.persistence.sessions.factories.XMLSessionConfigLoader;
import cz.burios.uniql.persistence.sessions.remote.RemoteSession;
import cz.burios.uniql.persistence.sessions.remote.rmi.RMIConnection;
import cz.burios.uniql.persistence.sessions.remote.rmi.RMIServerSessionManager;
import cz.burios.uniql.persistence.sessions.remote.rmi.RMIServerSessionManagerDispatcher;
import cz.burios.uniql.persistence.sessions.serializers.JavaSerializer;
import cz.burios.uniql.persistence.sessions.serializers.Serializer;
import cz.burios.uniql.persistence.sessions.server.ConnectionPolicy;
import cz.burios.uniql.persistence.sessions.server.ConnectionPool;
import cz.burios.uniql.persistence.sessions.server.ExternalConnectionPool;
import cz.burios.uniql.persistence.sessions.server.ReadConnectionPool;
import cz.burios.uniql.persistence.sessions.server.ServerSession;
import cz.burios.uniql.persistence.tools.profiler.PerformanceMonitor;
import cz.burios.uniql.persistence.tools.profiler.PerformanceProfiler;
import cz.burios.uniql.persistence.tools.profiler.QueryMonitor;
import cz.burios.uniql.persistence.tools.schemaframework.SchemaManager;

/**
 * INTERNAL: This class handles deployment of a persistence unit. In predeploy
 * the meta-data is processed and weaver transformer is returned to allow
 * weaving of the persistent classes. In deploy the project and session are
 * initialize and registered.
 */
public class EntityManagerSetupImpl implements MetadataRefreshListener {
	/*
	 * Design Pattern in use: Builder pattern EntityManagerSetupImpl,
	 * MetadataProcessor and MetadataProject play the role of director, builder and
	 * product respectively. See processORMetadata which is the factory method.
	 * 
	 */
	...
	/**
	 * Holds a reference to the weaver class transformer so it can be cleared after
	 * login.
	 */
	...
	// true if predeploy called by createContainerEntityManagerFactory; false -
	...
	// indicates whether weaving was used on the first run through predeploy (in
	// STATE_INITIAL)
	...
	// 266912: Criteria API and Metamodel API (See Ch 5 of the JPA 2.0
	// Specification)
	/**
	 * Reference to the Metamodel for this deployment and session. Please use the
	 * accessor and not the instance variable directly
	 */
	...
	// for compositeMember factoryCount is always 0; session is never stored in
	// SessionBroker
	// the session has not yet connected for the first time or failed to connect for
	// the first time
	...
	/**
	 * Initial -----------> PredeployFailed --- | | V | Predeployed --->
	 * DeployFailed -- | | | | V V V HalfDeployed --> Deployed -> Undeployed | ^ V |
	 * DeployFailed -------------------
	 * 
	 */
	 ...
	 */
	public static String[] connectionPropertyNames = { PersistenceUnitProperties.TRANSACTION_TYPE,
			PersistenceUnitProperties.JTA_DATASOURCE, PersistenceUnitProperties.NON_JTA_DATASOURCE,
			PersistenceUnitProperties.JDBC_URL, PersistenceUnitProperties.JDBC_USER,
			PersistenceUnitProperties.NOSQL_CONNECTION_SPEC, PersistenceUnitProperties.NOSQL_CONNECTION_FACTORY,
			PersistenceUnitProperties.NOSQL_USER, PersistenceUnitProperties.JDBC_CONNECTOR };
	...
	/*
	 * In HalfPredeployedCompositeMember predeploy method called several times, each
	 * call uses mode, then updating it before returning. So mode value could be
	 * viewed as a substate of HalfPredeployedCompositeMember state. The mode is
	 * required for staging of processing OR metadata for composite members: each
	 * processing stage should be completed for ALL composite members before any one
	 * of then could proceed to the next processing stage.
	 */
	 ...
	 * EntityManagerSetupImpl has been refreshed. This means this
	 * EntityManagerSetupImpl will no longer be associated with new
	...
	protected enum TableCreationType {
		NONE, CREATE, DROP, DROP_AND_CREATE, EXTEND
	};
	...
	/*
	 * Return session name if specified. Otherwise build one from the connection
	 * properties names and values. Note that specifying value "" in properties
	 * causes the property value specified in PersistenceUnitInfo to be ignored.
	 * Never returns null.
	 */
	public static String getOrBuildSessionName(Map properties, PersistenceUnitInfo puInfo,
			String persistenceUnitUniqueName) {
		// Weblogic server was found to prefix the file path on Windows platform with a
		// slash, so mandating that for compatibility
		String persistenceUnitName = assertCompatiblePersistenceUnitName(persistenceUnitUniqueName);

		// if SESSION_NAME is specified in either properties or puInfo properties - use
		// it as session name (unless it's an empty String).
		...
		// Specifying empty String in properties allows to remove SESSION_NAME specified
		// in puInfo properties.
		...
		if (isComposite(puInfo)) {
			...
			// by concatenating persistenceUnitUniqueName and suffix build of connection
			...
			if (value != null) {
				...
				if (value instanceof String) {
					...
					if (value instanceof javax.sql.DataSource) {
						// value of JTA_DATASOURCE / NON_JTA_DATASOURCE may be a DataSource (we would
						// prefer DataSource name)
	...
	/*
	 * Should only be called when emSetupImpl created during SE initialization is
	 * set into a new EMF. emSetupImpl must be in PREDEPLOYED state.
	 */
	public void changeSessionName(String newSessionName) {
		if (!session.getName().equals(newSessionName)) {
			session.log(SessionLog.FINEST, SessionLog.PROPERTIES, "session_name_change", new Object[] {
					getPersistenceUnitInfo().getPersistenceUnitName(), session.getName(), newSessionName });
	...
	/**
	 * This method can be used to ensure the session represented by emSetupImpl is
	 * removed from the SessionManager.
	 */
	 ...
	 * 
	 * Deployment takes a session that was partially created in the predeploy call
	 * and makes it whole.
	 * 
	 * This means doing any configuration that requires the real class definitions
	 * for the entities. In the predeploy phase we were in a stage where we were not
	 * let allowed to load the real classes.
	 * 
	 * Deploy could be called several times - but only the first call does the
	 * actual deploying - additional calls allow to update session properties (in
	 * case the session is not connected).
	 * 
	 * Note that there is no need to synchronize deploy method - it doesn't alter
	 * factoryCount and while deploy is executed no other method can alter the
	 * current state (predeploy call would just increment factoryCount; undeploy
	 * call would not drop factoryCount to 0). However precautions should be taken
	 * to handle concurrent calls to deploy, because those may alter the current
	 * state or connect the session.
	 * 
	 * @param realClassLoader      The class loader that was used to load the entity
	 *                             classes. This loader will be maintained for the
	 *                             lifespan of the loaded classes.
	 * @param additionalProperties added to persistence unit properties for
	 *                             updateServerSession overriding existing
	 *                             properties. In JSE case it allows to alter
	 *                             properties in main (as opposed to preMain where
	 *                             preDeploy is called).
	 * @return An EntityManagerFactory to be used by the Container to obtain
	 *         EntityManagers
	 */
	public AbstractSession deploy(ClassLoader realClassLoader, Map additionalProperties) {
		if (this.state != STATE_PREDEPLOYED && this.state != STATE_DEPLOYED && this.state != STATE_HALF_DEPLOYED) {
			if (mustBeCompositeMember()) {
				throw new PersistenceException(EntityManagerSetupException
						.compositeMemberCannotBeUsedStandalone(this.persistenceUnitInfo.getPersistenceUnitName()));
			}
			throw new PersistenceException(EntityManagerSetupException.cannotDeployWithoutPredeploy(
					this.persistenceUnitInfo.getPersistenceUnitName(), this.state, this.persistenceException));
		}
		// state is PREDEPLOYED or DEPLOYED
		this.session.log(SessionLog.FINEST, SessionLog.JPA, "deploy_begin",
				new Object[] { getPersistenceUnitInfo().getPersistenceUnitName(), this.session.getName(), this.state,
						this.factoryCount });
		...
		} else if ((this.processor != null) && (this.processor.getProject() != null)
				&& (this.processor.getProject().hasVirtualClasses()) && (this.state == STATE_PREDEPLOYED)
				&& (!(classLoaderToUse instanceof DynamicClassLoader))) {
			classLoaderToUse = new DynamicClassLoader(classLoaderToUse);
		}

		// indicates whether session has failed to connect, determines whether
		// HALF_DEPLOYED state should be kept in case of exception.
		...
		try {
			...
			if (this.state == STATE_PREDEPLOYED) {
				...
				if (this.state == STATE_PREDEPLOYED) {
					if (this.shouldBuildProject && !this.isSessionLoadedFromSessionsXML) {
						if (isComposite()) {
							...
							if (this.processor.getMetadataSource() != null) {
								Map metadataProperties = this.processor.getMetadataSource().getPropertyOverrides(
										deployProperties, classLoaderToUse, this.session.getSessionLog());
							...
							// listeners and queries require the real classes and are therefore built during
							// deploy using the realClassLoader
							...
							if (this.projectCacheAccessor != null) {
								// cache the project:
								this.projectCacheAccessor.storeProject(this.session.getProject(), deployProperties,
										this.session.getSessionLog());
							}

							// The project is initially created using class names rather than classes. This
							// call will make the conversion.
							// If the session was loaded from sessions.xml this will also convert the
							// descriptor classes to the correct class loader.
						...
						if (!this.shouldBuildProject) {
							// process anything that might not have been serialized/cached in the project
							// correctly:
							if (!isCompositeMember()) {
								addBeanValidationListeners(deployProperties, classLoaderToUse);
							}
					...
					if (this.state == STATE_DEPLOY_FAILED) {
						// while this thread waited in STATE_PREDEPLOYED another thread attempted to
						// deploy and failed.
			...
			if (!isCompositeMember()) {
				if (this.session.isDatabaseSession() && !((DatabaseSessionImpl) session).isLoggedIn()) {
					...
					if (!((DatabaseSessionImpl) this.session).isLoggedIn()) {
						if (this.state == STATE_DEPLOY_FAILED) {
							// while this thread waited in STATE_HALF_DEPLOYED another thread attempted to
							// connect the session and failed.
							// Rethrow the cache PersistenceException, which caused STATE_DEPLOYED_FAILED.
							throw persistenceException;
						}
						...
						if (isValidationOnly(deployProperties, false)) {
							/**
							 * for 324213 we could add a session.loginAndDetectDatasource() call before
							 * calling initializeDescriptors when validation-only is True to avoid a native
							 * sequence exception on a generic DatabasePlatform by auto-detecting the
							 * correct DB platform. However, this would introduce a DB login when validation
							 * is on - in opposition to the functionality of the property (to only validate)
							 */
							...
							try {
								...
								PropertiesUtils.set(platform, PersistenceUnitProperties.TARGET_DATABASE_PROPERTIES,
										(String) deployProperties
												.get(PersistenceUnitProperties.TARGET_DATABASE_PROPERTIES));
										...
										this.session.getExternalTransactionController()
												.setExceptionHandler(new ExceptionHandler() {
													...
													public Object handleException(RuntimeException exception) {
														if (exception instanceof cz.burios.uniql.persistence.exceptions.OptimisticLockException) {
								...
								if (this.state == STATE_HALF_DEPLOYED) {
									if (this.session.isConnected()) {
										...
										// Cannot recover from that - the user has to fix the persistence unit and
										// redeploy it.
										try {
											getDatabaseSession().logout();
				...
				try {
					...
					this.session.log(SessionLog.FINEST, SessionLog.METAMODEL, "metamodel_init_failed",
							new Object[] { e.getMessage() });
				}
			}
			// Clear the weaver's reference to meta-data information, as it is held by the
			// class loader and will never gc.
			if (this.weaver != null) {
				this.weaver.clear();
				this.weaver = null;
			}
			...
			if (this.state == STATE_DEPLOY_FAILED) {
				if (exception == persistenceException) {
					persistenceEx = new PersistenceException(EntityManagerSetupException.cannotDeployWithoutPredeploy(
							this.persistenceUnitInfo.getPersistenceUnitName(), this.state, this.persistenceException));
				} else {
			...
			this.session.log(SessionLog.FINEST, SessionLog.JPA, "deploy_end",
					new Object[] { getPersistenceUnitInfo().getPersistenceUnitName(), this.session.getName(),
							this.state, this.factoryCount });
		}
	}

	/**
	 * INTERNAL: This method is used to resolve Descriptor Customizers that might
	 * have been stored in the project for JPA project caching.
	 * 
	 ...
	 */
	private void processDescriptorsFromCachedProject(ClassLoader realClassLoader)
			throws ClassNotFoundException, PrivilegedActionException, IllegalAccessException, InstantiationException {
		for (ClassDescriptor descriptor : session.getProject().getDescriptors().values()) {
			...
			if (descriptor.getDescriptorCustomizerClassName() != null) {
				...
				DescriptorCustomizer customizer = (DescriptorCustomizer) this.buildObjectForClass(listenerClass,
	...
	/**
	 * INTERNAL: This method is used to resolve Descriptor Events processed earlier
	 * into EventHolders that now need to be used to create the
	 * DescriptorEventListeners and added to the DescriptorEventManager
	 *
	 */
	...
	protected PersistenceException createDeployFailedPersistenceException(Throwable ex) {
		PersistenceException perEx = new PersistenceException(
				EntityManagerSetupException.deployFailed(persistenceUnitInfo.getPersistenceUnitName(), ex));
	...
	protected void addSessionToGlobalSessionManager() {
		...
		if (oldSession != null) {
			throw new PersistenceException(
					EntityManagerSetupException.attemptedRedeployWithoutClose(session.getName()));
		}
		sm.addSession(session);
	}

	/**
	 * Add the StructConverters that were specified by annotation on the
	 * DatabasePlatform This method must be called after the DatabasePlatform has
	 * been detected
	 */
		...
		if (this.compositeMemberEmSetupImpls == null) {
			for (StructConverter structConverter : structConverters) {
				if (session.getPlatform().getTypeConverters().get(structConverter.getJavaType()) != null) {
					throw ValidationException
							.twoStructConvertersAddedForSameClass(structConverter.getJavaType().getName());
				}
			...
			for (EntityManagerSetupImpl compositeMemberEmSetupImpl : this.compositeMemberEmSetupImpls) {
				if (!compositeMemberEmSetupImpl.structConverters.isEmpty()) {
					String compositeMemberPuName = compositeMemberEmSetupImpl.getPersistenceUnitInfo()
							.getPersistenceUnitName();
					// debug output added to make it easier to navigate the log because the method
					// is called outside of composite member deploy
					compositeMemberEmSetupImpl.session.log(SessionLog.FINEST, SessionLog.PROPERTIES,
							"composite_member_begin_call",
							new Object[] { "addStructConverters", compositeMemberPuName, state });
					compositeMemberEmSetupImpl.addStructConverters();
					compositeMemberEmSetupImpl.session.log(SessionLog.FINEST, SessionLog.PROPERTIES,
							"composite_member_end_call",
							new Object[] { "addStructConverters", compositeMemberPuName, state });
				}
			}
		}
	...
	/**
	 * Assign a CMP3Policy to each descriptor, and sets the
	 * OptimisticLockingPolicy's LockOnChangeMode if applicable.
	 */
	protected void assignCMP3Policy() {
		...
		for (Iterator iterator = project.getDescriptors().values().iterator(); iterator.hasNext();) {
			// bug:4406101 changed class cast to base class, which is used in projects
			// generated from 904 xml
	...
	protected boolean updateServerPlatform(Map m, ClassLoader loader) {
		String serverPlatformClassName = PropertiesHandler
				.getPropertyValueLogDebug(PersistenceUnitProperties.TARGET_SERVER, m, session);
		...
		// originalServerPlatform is always non-null - Session's constructor sets
		// serverPlatform to NoServerPlatform
		...
		try {
			Constructor constructor = cls
					.getConstructor(new Class[] { cz.burios.uniql.persistence.sessions.DatabaseSession.class });
			...
			if (ExternalTransactionController.class.isAssignableFrom(cls)) {
				// the new serverPlatform is CustomServerPlatform, cls is its
				// ExternalTransactionController class
				...
				throw EntityManagerSetupException.failedToInstantiateServerPlatform(serverPlatformClassName,
						PersistenceUnitProperties.TARGET_SERVER, ex);
			}
		}
	...
	protected void updatePartitioning(Map m, ClassLoader loader) {
		// Partitioning
		String partitioning = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.PARTITIONING, m,
				this.session);
		...
		String callbackClassName = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.PARTITIONING_CALLBACK, m,
				this.session);
		if (callbackClassName != null) {
			Class cls = findClassForProperty(callbackClassName, PersistenceUnitProperties.PARTITIONING_CALLBACK,
					loader);
			...
			try {
				...
				throw EntityManagerSetupException.failedToInstantiateProperty(callbackClassName,
						PersistenceUnitProperties.PARTITIONING_CALLBACK, exception);
			}
	...
	protected void updateRemote(Map m, ClassLoader loader) {
		...
		String serverName = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.REMOTE_SERVER_NAME, m,
				this.session);
		if (serverName == null) {
			// Configure as client.
			if (protocol != null) {
				...
				if (protocol.equalsIgnoreCase(RemoteProtocol.RMI)) {
					String url = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.REMOTE_URL, m,
							this.session);
					if (url == null) {
					...
					try {
						connection = new RMIConnection(
								((RMIServerSessionManager) Naming.lookup(url)).createRemoteSessionController());
					} catch (Exception exception) {
						throw ValidationException.invalidValueForProperty(url, PersistenceUnitProperties.REMOTE_URL,
								exception);
					}
				} else {
					...
					try {
						...
						throw ValidationException.invalidValueForProperty(protocol,
								PersistenceUnitProperties.REMOTE_PROTOCOL, exception);
					}
				}
			...
			if (protocol.equalsIgnoreCase(RemoteProtocol.RMI)) {
				...
				try {
					...
					ValidationException.invalidValueForProperty(serverName,
							PersistenceUnitProperties.REMOTE_SERVER_NAME, exception);
				}
	...
	protected void updateDatabaseEventListener(Map m, ClassLoader loader) {
		String listenerClassName = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.DATABASE_EVENT_LISTENER,
				m, this.session);
		if (listenerClassName != null) {
			if (listenerClassName.equalsIgnoreCase("DCN") || listenerClassName.equalsIgnoreCase("QCN")) {
				listenerClassName = "cz.burios.uniql.persistence.platform.database.oracle.dcn.OracleChangeNotificationListener";
			}
			Class cls = findClassForProperty(listenerClassName, PersistenceUnitProperties.DATABASE_EVENT_LISTENER,
					loader);
			...
			try {
				...
				throw EntityManagerSetupException.failedToInstantiateProperty(listenerClassName,
						PersistenceUnitProperties.DATABASE_EVENT_LISTENER, exception);
			}
	 ...
	 * @param serverPlatformChanged the boolean that denotes a serverPlatform change
	 *                              in the session.
	 */
	protected void updateLoggers(Map persistenceProperties, boolean serverPlatformChanged, ClassLoader loader) {
		// Logger(SessionLog type) can be specified by the logger property or
		// ServerPlatform.getServerLog().
		// The logger property has a higher priority to ServerPlatform.getServerLog().
		String loggerClassName = PropertiesHandler.getPropertyValueLogDebug(PersistenceUnitProperties.LOGGING_LOGGER,
				persistenceProperties, session);

		// The sessionLog instance should be different from the singletonLog because
		// they have
		// different state.
		...
		if (loggerClassName != null) {
			...
			if (loggerClassName.equals(LoggerType.ServerLogger)) {
				...
				Class sessionLogClass = findClassForProperty(loggerClassName, PersistenceUnitProperties.LOGGING_LOGGER,
						loader);
				try {
					singletonLog = (SessionLog) sessionLogClass.newInstance();
					sessionLog = (SessionLog) sessionLogClass.newInstance();
				} catch (Exception ex) {
					throw EntityManagerSetupException.failedToInstantiateLogger(loggerClassName,
	...
	/**
	 * Check for the PROFILER persistence or system property and set the Session's
	 * profiler. This can also set the QueryMonitor.
	 */
	protected void updateProfiler(Map persistenceProperties, ClassLoader loader) {
		// This must use config property as the profiler is not in the PropertiesHandler
		// and requires
		// supporting generic profiler classes.
		String newProfilerClassName = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.PROFILER,
				persistenceProperties, session);
		...
		if (newProfilerClassName == null) {
			...
			try {
				Class newProfilerClass = findClassForProperty(newProfilerClassName, PersistenceUnitProperties.PROFILER,
						loader);

				SessionProfiler sessionProfiler = (SessionProfiler) buildObjectForClass(newProfilerClass,
						SessionProfiler.class);
	...
	protected static Class findClass(String className, ClassLoader loader)
		...
		if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()) {
			...
			return cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(className, true,
					loader);
		}
	}
	...
	/**
	 * Internal: Returns a list of StructConverter instances from a list of
	 * StructConverter names stored within the project.
	 * 
	 * @param realClassLoader
	 * @return
	 */
	...
	protected boolean hasSchemaDatabaseGeneration(Map m) {
		if (hasConfigProperty(SCHEMA_GENERATION_DATABASE_ACTION, m)) {
			return getConfigPropertyAsString(SCHEMA_GENERATION_DATABASE_ACTION, m) != null
					&& !getConfigPropertyAsString(SCHEMA_GENERATION_DATABASE_ACTION, m)
							.equals(SCHEMA_GENERATION_NONE_ACTION);
		}
	...
	protected boolean hasSchemaScriptsGeneration(Map m) {
		if (hasConfigProperty(SCHEMA_GENERATION_SCRIPTS_ACTION, m)) {
			return getConfigPropertyAsString(SCHEMA_GENERATION_SCRIPTS_ACTION, m) != null
					&& !getConfigPropertyAsString(SCHEMA_GENERATION_SCRIPTS_ACTION, m)
							.equals(SCHEMA_GENERATION_NONE_ACTION);
		}
	...
	/**
	 * We may be provided a connection via the properties to use. Check for one and
	 * build a database session around it. Otherwise return the pu database session.
	 */
	...
	/**
	 * This method will be used to validate the specified class and return it's
	 * instance.
	 */
	protected static Object buildObjectForClass(Class clazz, Class mustBeImplementedInterface)
			throws IllegalAccessException, PrivilegedActionException, InstantiationException {
	...
	protected void updateDescriptorCacheSettings(Map m, ClassLoader loader) {
		...
		if (defaultTypeName != null) {
			// Always use the EclipseLink class loader, otherwise can have
			// loader/redeployment issues.
			Class defaultType = findClassForProperty(defaultTypeName, PersistenceUnitProperties.CACHE_TYPE_DEFAULT,
		...
		try {
			...
			while (it.hasNext() && (!typeMap.isEmpty() || !sizeMap.isEmpty() || !sharedMap.isEmpty())) {
				...
				if (typeName != null) {
					Class type = findClassForProperty(typeName, PersistenceUnitProperties.CACHE_TYPE_ + name,
							getClass().getClassLoader());
			...
			this.session.handleException(ValidationException.invalidValueForProperty(value,
					PersistenceUnitProperties.CACHE_SIZE_, exception));
		}
	}

	/**
	 * Process all properties under "eclipselink.connection-pool.". This allows for
	 * named connection pools. It also processes "read", "write", "default" and
	 * "sequence" connection pools.
	 */
	protected void updateConnectionSettings(ServerSession serverSession, Map properties) {
		Map<String, Object> connectionsMap = PropertiesHandler
				.getPrefixValuesLogDebug(PersistenceUnitProperties.CONNECTION_POOL, properties, serverSession);
		...
		for (Map.Entry<String, Object> entry : connectionsMap.entrySet()) {
			...
			try {
				...
				if (poolName.equals("read")) {
					...
					if ((pool == null) || (pool == serverSession.getDefaultConnectionPool())) {
						if (this.session.getDatasourceLogin().shouldUseExternalConnectionPooling()) {
							pool = new ExternalConnectionPool(poolName, serverSession.getDatasourceLogin(),
									serverSession);
						} else {
				...
				} else if (poolName.equals("read")
						&& attribute.equals(PersistenceUnitProperties.CONNECTION_POOL_SHARED)) {
					boolean shared = Boolean.parseBoolean((String) entry.getValue());
					if (shared) {
						ReadConnectionPool readPool = new ReadConnectionPool(poolName,
								serverSession.getDatasourceLogin(), serverSession);
				...
				this.session.handleException(
						ValidationException.invalidValueForProperty(entry.getValue(), entry.getKey(), exception));
			}
		}
	}

	protected void updateConnectionPolicy(ServerSession serverSession, Map m) {
		String isLazyString = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.EXCLUSIVE_CONNECTION_IS_LAZY,
				m, session);
	...
	public static ConnectionPolicy.ExclusiveMode getConnectionPolicyExclusiveModeFromProperties(Map m,
			AbstractSession abstractSession, boolean useSystemAsDefault) {
		String exclusiveConnectionModeString = PropertiesHandler.getPropertyValueLogDebug(
				PersistenceUnitProperties.EXCLUSIVE_CONNECTION_MODE, m, abstractSession, useSystemAsDefault);
	...
	/**
	 * Perform any steps necessary prior to actual deployment. This includes any
	 * steps in the session creation that do not require the real loaded domain
	 * classes.
	 * 
	 * The first call to this method caches persistenceUnitInfo which is reused in
	 * the following calls.
	 * 
	 * Note that in JSE case factoryCount is NOT incremented on the very first call
	 * (by JavaSECMPInitializer.callPredeploy, typically in preMain). That provides
	 * 1 to 1 correspondence between factoryCount and the number of open factories.
	 * 
	 * In case factoryCount > 0 the method just increments factoryCount. factory ==
	 * 0 triggers creation of a new session.
	 * 
	 * This method and undeploy - the only methods altering factoryCount - should be
	 * synchronized.
	 *
	 * @return A transformer (which may be null) that should be plugged into the
	 *         proper classloader to allow classes to be transformed as they get
	 *         loaded.
	...
	public synchronized ClassTransformer predeploy(PersistenceUnitInfo info, Map extendedProperties) {
		...
		if (state == STATE_DEPLOY_FAILED || state == STATE_UNDEPLOYED) {
			throw new PersistenceException(EntityManagerSetupException
					.cannotPredeploy(persistenceUnitInfo.getPersistenceUnitName(), state, persistenceException));
		}
		// session != null
		if (state == STATE_PREDEPLOYED || state == STATE_DEPLOYED || state == STATE_HALF_DEPLOYED) {
			session.log(SessionLog.FINEST, SessionLog.JPA, "predeploy_begin", new Object[] {
					getPersistenceUnitInfo().getPersistenceUnitName(), session.getName(), state, factoryCount });
			factoryCount++;
			session.log(SessionLog.FINEST, SessionLog.JPA, "predeploy_end", new Object[] {
					getPersistenceUnitInfo().getPersistenceUnitName(), session.getName(), state, factoryCount });
			return null;
			// session == null
			...
			if (!isCompositeMember()) {
				if (mustBeCompositeMember(persistenceUnitInfo)) {
					if (this.staticWeaveInfo == null) {
						...
						throw new PersistenceException(EntityManagerSetupException
								.compositeMemberCannotBeUsedStandalone(persistenceUnitInfo.getPersistenceUnitName()));
					}
				}
			}
		}

		// state is INITIAL or PREDEPLOY_FAILED or
		// STATE_HALF_PREDEPLOYED_COMPOSITE_MEMBER, session == null
		try {
			...
			if (state != STATE_HALF_PREDEPLOYED_COMPOSITE_MEMBER) {
				...
				// Create session (it needs to be done before initializing ServerPlatform and
				// logging).
				// If a sessions-xml is used this will get replaced later, but is required for
				// logging.
				isComposite = isComposite(persistenceUnitInfo);
				if (isComposite) {
					if (isSessionLoadedFromSessionsXML) {
						throw EntityManagerSetupException
								.compositeIncompatibleWithSessionsXml(persistenceUnitInfo.getPersistenceUnitName());
					}
				...
				// Cannot start logging until session and log and initialized, so log start of
				// predeploy here.
				session.log(SessionLog.FINEST, SessionLog.JPA, "predeploy_begin", new Object[] {
						getPersistenceUnitInfo().getPersistenceUnitName(), session.getName(), state, factoryCount });
				...
				if (projectCacheAccessor != null) {
					...
					Project project = projectCacheAccessor.retrieveProject(predeployProperties, classLoaderToUse,
					...
					if (project != null) {
						try {
							...
							session = tempSession;
							// reusing the serverPlatform from the existing session would have been
							// preferred,
				...
				if (isSessionLoadedFromSessionsXML) {
					if (this.compositeEmSetupImpl == null && this.staticWeaveInfo == null) {
						JPAClassLoaderHolder privateClassLoaderHolder = session.getServerPlatform()
								.getNewTempClassLoader(persistenceUnitInfo);
					...
					if (isCompositeMember()) {
						...
						// need the session name specified in properties to read correct session from
						// sessions.xml
						tempSessionName = (String) predeployProperties.get(PersistenceUnitProperties.SESSION_NAME);
					}
					session.log(SessionLog.FINEST, SessionLog.PROPERTIES, "loading_session_xml", sessionsXMLStr,
							tempSessionName);
					if (tempSessionName == null) {
						throw EntityManagerSetupException.sessionNameNeedBeSpecified(
								persistenceUnitInfo.getPersistenceUnitName(), sessionsXMLStr);
					}
					XMLSessionConfigLoader xmlLoader = new XMLSessionConfigLoader(sessionsXMLStr);
					// Do not register the session with the SessionManager at this point, create
					// temporary session using a local SessionManager and private class loader.
					// This allows for the project to be accessed without loading any of the classes
					// to allow weaving.
					// Note that this method assigns sessionName to session.
					Session tempSession = new SessionManager().getSession(xmlLoader, tempSessionName, classLoaderToUse,
							false, false);
					// Load path of sessions-xml resource before throwing error so user knows which
					// sessions-xml file was found (may be multiple).
					session.log(SessionLog.FINEST, SessionLog.PROPERTIES, "sessions_xml_path_where_session_load_from",
							xmlLoader.getSessionName(), xmlLoader.getResourcePath());
					if (tempSession == null) {
						throw ValidationException.noSessionFound(sessionName, sessionsXMLStr);
					}
					// Currently the session must be either a ServerSession or a SessionBroker,
					// cannot be just a DatabaseSessionImpl.
					if (tempSession.isServerSession() || tempSession.isSessionBroker()) {
						...
						throw EntityManagerSetupException.sessionLoadedFromSessionsXMLMustBeServerSession(
								persistenceUnitInfo.getPersistenceUnitName(),
								(String) predeployProperties.get(PersistenceUnitProperties.SESSIONS_XML), tempSession);
					}
					if (this.staticWeaveInfo == null) {
				...
				if (this.staticWeaveInfo == null) {
					if (!isComposite) {
						...
						if (!isValidationOnly(predeployProperties, false) && persistenceUnitInfo != null
								&& transactionType == PersistenceUnitTransactionType.JTA) {
							if (predeployProperties.get(PersistenceUnitProperties.JTA_DATASOURCE) == null
									&& persistenceUnitInfo.getJtaDataSource() == null) {
								if (predeployProperties
										.get(PersistenceUnitProperties.SCHEMA_DATABASE_PRODUCT_NAME) == null
										|| predeployProperties
												.get(PersistenceUnitProperties.SCHEMA_DATABASE_MAJOR_VERSION) == null
										|| predeployProperties
												.get(PersistenceUnitProperties.SCHEMA_DATABASE_MINOR_VERSION) == null) {
									throw EntityManagerSetupException.jtaPersistenceUnitInfoMissingJtaDataSource(
											persistenceUnitInfo.getPersistenceUnitName());
								}
							}
						}
					...
					// this flag is used to disable work done as a result of the LAZY hint on
					// OneToOne and ManyToOne mappings
					...
					if (compositeEmSetupImpl == null) {
						throwExceptionOnFail = "true".equalsIgnoreCase(EntityManagerFactoryProvider
								.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.THROW_EXCEPTIONS,
				...
				weaveRest = false;
				if (enableWeaving) {
					weaveChangeTracking = "true".equalsIgnoreCase(EntityManagerFactoryProvider
							.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.WEAVING_CHANGE_TRACKING,
									predeployProperties, "true", session));
					weaveLazy = "true".equalsIgnoreCase(EntityManagerFactoryProvider.getConfigPropertyAsStringLogDebug(
							PersistenceUnitProperties.WEAVING_LAZY, predeployProperties, "true", session));
					weaveEager = "true".equalsIgnoreCase(EntityManagerFactoryProvider.getConfigPropertyAsStringLogDebug(
							PersistenceUnitProperties.WEAVING_EAGER, predeployProperties, "false", session));
					weaveFetchGroups = "true".equalsIgnoreCase(EntityManagerFactoryProvider
							.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.WEAVING_FETCHGROUPS,
									predeployProperties, "true", session));
					weaveInternal = "true"
							.equalsIgnoreCase(EntityManagerFactoryProvider.getConfigPropertyAsStringLogDebug(
									PersistenceUnitProperties.WEAVING_INTERNAL, predeployProperties, "true", session));
					weaveRest = "true".equalsIgnoreCase(EntityManagerFactoryProvider.getConfigPropertyAsStringLogDebug(
							PersistenceUnitProperties.WEAVING_REST, predeployProperties, "true", session));
				}
			...
			if (shouldBuildProject && !isSessionLoadedFromSessionsXML) {
				if (isComposite) {
					...
					if (mode == PersistenceUnitProcessor.Mode.ALL
							|| mode == PersistenceUnitProcessor.Mode.COMPOSITE_MEMBER_INITIAL) {
						boolean usesMultitenantSharedEmf = "true".equalsIgnoreCase(EntityManagerFactoryProvider
								.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.MULTITENANT_SHARED_EMF,
										predeployProperties, "true", session));
						boolean usesMultitenantSharedCache = "true".equalsIgnoreCase(EntityManagerFactoryProvider
								.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.MULTITENANT_SHARED_CACHE,
										predeployProperties, "false", session));

						// Create an instance of MetadataProcessor for specified persistence unit info
						processor = new MetadataProcessor(persistenceUnitInfo, session, classLoaderToUse, weaveLazy,
								weaveEager, weaveFetchGroups, usesMultitenantSharedEmf, usesMultitenantSharedCache,
								predeployProperties, compositeProcessor);
						...
						EntityManagerSetupImpl.updateCaseSensitivitySettings(predeployProperties,
								processor.getProject(), session);
					}
					...
					if (mode == PersistenceUnitProcessor.Mode.COMPOSITE_MEMBER_INITIAL) {
						...
						session.log(SessionLog.FINEST, SessionLog.JPA, "predeploy_end",
								new Object[] { getPersistenceUnitInfo().getPersistenceUnitName(), session.getName(),
										state + " " + mode, factoryCount });
						return null;
					...
					// mode == PersistenceUnitProcessor.Mode.ALL || mode ==
					// PersistenceUnitProcessor.Mode.COMPOSITE_MEMBER_FINAL
					...
					// The transformer is capable of altering domain classes to handle a LAZY hint
					// for OneToOne mappings. It will only
					// be returned if we we are mean to process these mappings
					if (enableWeaving) {
						// build a list of entities the persistence unit represented by this
						// EntityManagerSetupImpl will use
						Collection entities = PersistenceUnitProcessor.buildEntityList(processor, classLoaderToUse);
						this.weaver = TransformerFactory.createTransformerAndModifyProject(session, entities,
								classLoaderToUse, weaveLazy, weaveChangeTracking, weaveFetchGroups, weaveInternal,
								weaveRest);
						session.getProject()
								.setClassNamesForWeaving(new ArrayList(processor.getProject().getWeavableClassNames()));
					}
				...
				if (enableWeaving) {
					...
					if (shouldBuildProject) {
						// If deploying from a sessions-xml it is still desirable to allow the classes
						// to be weaved.
						// build a list of entities the persistence unit represented by this
						// EntityManagerSetupImpl will use
						for (Iterator iterator = session.getProject().getDescriptors().keySet().iterator(); iterator
								.hasNext();) {
					...
					this.weaver = TransformerFactory.createTransformerAndModifyProject(session, persistenceClasses,
							classLoaderToUse, weaveLazy, weaveChangeTracking, weaveFetchGroups, weaveInternal,
							weaveRest);
				}
			}
			...
			session.log(SessionLog.FINEST, SessionLog.JPA, "predeploy_end", new Object[] {
					getPersistenceUnitInfo().getPersistenceUnitName(), session.getName(), state, factoryCount });
			// gf3146: if static weaving is used, we should not return a transformer.
			// Transformer should still be created though as it modifies descriptors
			if (isWeavingStatic) {
				return null;
			} else {
				return this.weaver;
			...
			if (session != null) {
				...
				if (logWriter != null) {
					String message = LoggingLocalization.buildMessage("predeploy_end", new Object[] {
							getPersistenceUnitInfo().getPersistenceUnitName(), "N/A", state, factoryCount });
					try {
	...
	protected PersistenceException createPredeployFailedPersistenceException(Throwable ex) {
		PersistenceException perEx = new PersistenceException(
				EntityManagerSetupException.predeployFailed(persistenceUnitInfo.getPersistenceUnitName(), ex));
		if (persistenceException == null) {
			persistenceException = perEx;
		}
		return perEx;
	...
	/**
	 * Return the name of the session this SetupImpl is building. The session name
	 * is only known at deploy time and if this method is called prior to that, this
	...
	protected boolean isValidationOnly(Map m, boolean shouldMergeMap) {
		...
		String validationOnlyString = getConfigPropertyAsStringLogDebug(
				PersistenceUnitProperties.VALIDATION_ONLY_PROPERTY, m, session);
	...
	/**
	 * Return if the session should be deployed and connected during the creation of
	 * the EntityManagerFactory, or if it should be deferred until
	 * createEntityManager(). The default is to defer, but is only validating, or
	 * can be configured to deploy upfront to avoid hanging the application at
	 * runtime.
	 */
	public boolean shouldGetSessionOnCreateFactory(Map m) {
		...
		String deployString = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.DEPLOY_ON_STARTUP, m,
				this.session);
	...
	protected void updateCacheCoordination(Map m, ClassLoader loader) {
		String protocol = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.COORDINATION_PROTOCOL, m,
				this.session);
		String value = "";
		String property = "";
		try {
			if (protocol != null) {
				...
				if (protocol.equalsIgnoreCase(CacheCoordinationProtocol.JGROUPS)) {
					...
					value = "cz.burios.uniql.persistence.sessions.coordination.jgroups.JGroupsTransportManager";
					// Avoid compile and runtime dependency.
					Class transportClass = findClassForProperty(value, PersistenceUnitProperties.COORDINATION_PROTOCOL,
							loader);
					TransportManager transport = (TransportManager) transportClass.newInstance();
					rcm.setTransportManager(transport);
					String config = getConfigPropertyAsStringLogDebug(
							PersistenceUnitProperties.COORDINATION_JGROUPS_CONFIG, m, this.session);
					if (config != null) {
						transport.setConfig(config);
					}
				} else if (protocol.equalsIgnoreCase(CacheCoordinationProtocol.JMS)
						|| protocol.equalsIgnoreCase(CacheCoordinationProtocol.JMSPublishing)) {
					...
					String host = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.COORDINATION_JMS_HOST, m,
							this.session);
					if (host != null) {
						transport.setTopicHostUrl(host);
					}
					String topic = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.COORDINATION_JMS_TOPIC,
							m, this.session);
					if (topic != null) {
						transport.setTopicName(topic);
					}
					String factory = getConfigPropertyAsStringLogDebug(
							PersistenceUnitProperties.COORDINATION_JMS_FACTORY, m, this.session);
					if (factory != null) {
						transport.setTopicConnectionFactoryName(factory);
					}

					String reuse_publisher = getConfigPropertyAsStringLogDebug(
							PersistenceUnitProperties.COORDINATION_JMS_REUSE_PUBLISHER, m, this.session);
					if (reuse_publisher != null) {
						transport.setShouldReuseJMSTopicPublisher(reuse_publisher.equalsIgnoreCase("true"));
					}

				} else if (protocol.equalsIgnoreCase(CacheCoordinationProtocol.RMI)
						|| protocol.equalsIgnoreCase(CacheCoordinationProtocol.RMIIIOP)) {
					...
					// Default protocol.
					String delay = getConfigPropertyAsStringLogDebug(
							PersistenceUnitProperties.COORDINATION_RMI_ANNOUNCEMENT_DELAY, m, this.session);
					...
					String multicast = getConfigPropertyAsStringLogDebug(
							PersistenceUnitProperties.COORDINATION_RMI_MULTICAST_GROUP, m, this.session);
					if (multicast != null) {
						rcm.getDiscoveryManager().setMulticastGroupAddress(multicast);
					}
					String port = getConfigPropertyAsStringLogDebug(
							PersistenceUnitProperties.COORDINATION_RMI_MULTICAST_GROUP_PORT, m, this.session);
					...
					String timeToLive = getConfigPropertyAsStringLogDebug(
							PersistenceUnitProperties.COORDINATION_RMI_PACKET_TIME_TO_LIVE, m, this.session);
					...
					String url = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.COORDINATION_RMI_URL, m,
							this.session);
					if (url != null) {
						rcm.setUrl(url);
					}
					...
					property = PersistenceUnitProperties.COORDINATION_PROTOCOL;
					value = protocol;
					Class transportClass = findClassForProperty(protocol,
							PersistenceUnitProperties.COORDINATION_PROTOCOL, loader);
					rcm.setTransportManager((TransportManager) transportClass.newInstance());
				}
				String serializer = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.COORDINATION_SERIALIZER,
						m, this.session);
				if (serializer != null) {
					property = PersistenceUnitProperties.COORDINATION_SERIALIZER;
					value = serializer;
					Class transportClass = findClassForProperty(serializer,
							PersistenceUnitProperties.COORDINATION_SERIALIZER, loader);
					rcm.setSerializer((Serializer) transportClass.newInstance());
				}

				String naming = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.COORDINATION_NAMING_SERVICE,
						m, this.session);
				if (naming != null) {
				...
				String user = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.COORDINATION_JNDI_USER, m,
						this.session);
				if (user != null) {
					rcm.getTransportManager().setUserName(user);
				}
				String password = getConfigPropertyAsStringLogDebug(
						PersistenceUnitProperties.COORDINATION_JNDI_PASSWORD, m, this.session);
				if (password != null) {
					rcm.getTransportManager().setPassword(password);
				}
				String context = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.COORDINATION_JNDI_CONTEXT,
						m, this.session);
				if (context != null) {
					rcm.getTransportManager().setInitialContextFactoryName(context);
				}
				String removeOnError = getConfigPropertyAsStringLogDebug(
						PersistenceUnitProperties.COORDINATION_REMOVE_CONNECTION, m, this.session);
				if (removeOnError != null) {
					rcm.getTransportManager().setShouldRemoveConnectionOnError(removeOnError.equalsIgnoreCase("true"));
				}
				String asynch = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.COORDINATION_ASYNCH, m,
						this.session);
				if (asynch != null) {
					rcm.setShouldPropagateAsynchronously(asynch.equalsIgnoreCase("true"));
				}
				String threadPoolSize = getConfigPropertyAsStringLogDebug(
						PersistenceUnitProperties.COORDINATION_THREAD_POOL_SIZE, m, this.session);
				...
				String channel = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.COORDINATION_CHANNEL, m,
						this.session);
				if (channel != null) {
	...
	protected void updateSerializer(Map m, ClassLoader loader) {
		...
		if (serializer != null) {
			if (serializer.length() > 0) {
				try {
					Class transportClass = findClassForProperty(serializer, PersistenceUnitProperties.SERIALIZER,
							loader);
					this.session.setSerializer((Serializer) transportClass.newInstance());
				} catch (Exception exception) {
					this.session.handleException(ValidationException.invalidValueForProperty(serializer,
							PersistenceUnitProperties.SERIALIZER, exception));
				}
			} else {
	...
	protected void updateShouldOptimizeResultSetAccess(Map m) {
		String resultSetAccessOptimization = PropertiesHandler.getPropertyValueLogDebug(
				PersistenceUnitProperties.JDBC_RESULT_SET_ACCESS_OPTIMIZATION, m, this.session);
	...
	protected void updateTenancy(Map m, ClassLoader loader) {
		String tenantStrategy = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.MULTITENANT_STRATEGY, m,
				this.session);
		if (tenantStrategy != null) {
			if ("external".equalsIgnoreCase(tenantStrategy)) {
				...
				String prop = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.MULTITENANT_SHARED_EMF, m,
						session);
				if (prop != null) {
					policy.setShouldUseSharedEMF(Boolean.valueOf(prop));
				}
				prop = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.MULTITENANT_SHARED_CACHE, m,
						session);
				if (prop != null) {
				...
				Class cls = findClassForProperty(tenantStrategy, PersistenceUnitProperties.MULTITENANT_STRATEGY,
						loader);
				...
				try {
					...
					throw EntityManagerSetupException.failedToInstantiateProperty(tenantStrategy,
							PersistenceUnitProperties.MULTITENANT_STRATEGY, ex);
				}
				session.getProject().setMultitenantPolicy(policy);
			}
		}
	...
	protected void updateTolerateInvalidJPQL(Map m) {
		String config = PropertiesHandler.getPropertyValueLogDebug(PersistenceUnitProperties.JPQL_TOLERATE, m,
				this.session);
	...
	/**
	 * Override the default login creation method. If persistenceInfo is available,
	 * use the information from it to setup the login and possibly to set
	 * readConnectionPool.
	 */
	protected void updateLogins(Map m) {
		DatasourceLogin login = (DatasourceLogin) this.session.getDatasourceLogin();

		String eclipselinkPlatform = PropertiesHandler
				.getPropertyValueLogDebug(PersistenceUnitProperties.TARGET_DATABASE, m, this.session);
		...
		Object connectorValue = getConfigPropertyLogDebug(PersistenceUnitProperties.NOSQL_CONNECTION_SPEC, m,
				this.session);
		...
		if (connectorValue instanceof Connector) {
			...
			try {
				cls = findClassForProperty((String) connectorValue, connectorProperty,
						this.persistenceUnitInfo.getClassLoader());
			...
			try {
				...
				throw EntityManagerSetupException.failedToInstantiateProperty((String) connectorValue,
						connectorProperty, exception);
			}
			if (connector != null) {
		...
		Object factoryValue = getConfigPropertyLogDebug(PersistenceUnitProperties.NOSQL_CONNECTION_FACTORY, m,
				this.session);
		...
		Map propertiesMap = PropertiesHandler.getPrefixValuesLogDebug(PersistenceUnitProperties.NOSQL_PROPERTY, m,
				session);
		if (propertiesMap.isEmpty()) {
			propertiesMap = PropertiesHandler.getPrefixValuesLogDebug(PersistenceUnitProperties.JDBC_PROPERTY, m,
					session);
		}
		...
		// Note: This call does not checked the stored persistenceUnitInfo or extended
		// properties because
		// the map passed into this method should represent the full set of properties
		...
		String transTypeString = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.TRANSACTION_TYPE, m,
				this.session);
		if (transTypeString != null && transTypeString.length() > 0) {
			transactionType = PersistenceUnitTransactionType.valueOf(transTypeString);
		}
		// find the jta datasource
		javax.sql.DataSource jtaDatasource = getDatasourceFromProperties(m, PersistenceUnitProperties.JTA_DATASOURCE,
				this.persistenceUnitInfo.getJtaDataSource());

		// find the non jta datasource
		javax.sql.DataSource nonjtaDatasource = getDatasourceFromProperties(m,
				PersistenceUnitProperties.NON_JTA_DATASOURCE, this.persistenceUnitInfo.getNonJtaDataSource());

		if (isValidationOnly(m, false) && transactionType == PersistenceUnitTransactionType.JTA
				&& jtaDatasource == null) {
		...
		if (login.shouldUseExternalTransactionController()) {
			// JtaDataSource is guaranteed to be non null - otherwise exception would've
			// been thrown earlier
		...
		// mainDatasource is guaranteed to be non null - TODO: No it is not, if they did
		// not set one it is null, should raise error, not null-pointer.
		if (!(login.getConnector() instanceof JNDIConnector)) {
			...
			String useInternalConnectionPool = getConfigPropertyAsStringLogDebug(
					PersistenceUnitProperties.CONNECTION_POOL_INTERNALLY_POOL_DATASOURCE, m, this.session);
	...
	/**
	 * This is used to return either the defaultDatasource or, if one exists, a
	 * datasource defined under the property from the Map m. This method will build
	 * a DataSourceImpl object to hold the url if the property in Map m defines a
	 * string instead of a datasource.
	 */
	protected javax.sql.DataSource getDatasourceFromProperties(Map m, String property,
		...
		if (datasource instanceof String) {
			if (((String) datasource).length() > 0) {
				...
				// allow an empty string data source property passed to createEMF to cancel data
				// source specified in persistence.xml
				return null;
			}
		}
		if (!(datasource instanceof javax.sql.DataSource)) {
			// A warning should be enough. Though an error might be better, the properties
			// passed in could contain anything
			session.log(SessionLog.WARNING, SessionLog.PROPERTIES, "invalid_datasource_property_value", property,
					datasource);
			return defaultDataSource;
		}
	...
	/**
	 * In cases where there is no data source, we will use properties to configure
	 * the login for our session. This method gets those properties and sets them on
	 * the login.
	 */
	protected void updateLoginDefaultConnector(DatasourceLogin login, Map m) {
		// Login info might be already set with sessions.xml and could be overridden by
		// session customizer after this
		// If login has default connector then JDBC properties update(override) the
		// login info
	...
	/**
	 * Configure the internal connection pooling parameters. By default if nothing
	 * is configured a default shared (exclusive) read/write pool is used with 32
	 * min/max connections and 1 initial.
	 */
	...
	protected void updatePools(ServerSession serverSession, Map m) {
		...
		try {
			...
			if (!serverSession.getDefaultConnectionPool().getLogin().shouldUseExternalConnectionPooling()) {
				// CONNECTION and WRITE_CONNECTION properties both configure the default pool
				// (mean the same thing, but WRITE normally used with READ).
			...
			if (!serverSession.getReadConnectionPool().getLogin().shouldUseExternalConnectionPooling()) {
				String shared = getConfigPropertyAsStringLogDebug(
						PersistenceUnitProperties.JDBC_READ_CONNECTIONS_SHARED, m, serverSession);
				...
				ConnectionPool pool = null;
				if (isShared) {
					pool = new ReadConnectionPool("read", serverSession.getReadConnectionPool().getLogin(),
							serverSession);
				} else {
					pool = new ConnectionPool("read", serverSession.getReadConnectionPool().getLogin(), serverSession);
				}
				String min = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.JDBC_READ_CONNECTIONS_MIN, m,
						serverSession);
				if (min != null) {
					value = min;
				...
				String max = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.JDBC_READ_CONNECTIONS_MAX, m,
						serverSession);
				if (max != null) {
					value = max;
				...
				String initial = getConfigPropertyAsStringLogDebug(
						PersistenceUnitProperties.JDBC_READ_CONNECTIONS_INITIAL, m, serverSession);
				if (initial != null) {
					value = initial;
				...
				// Only set the read pool if they configured it, otherwise use default shared
				// read/write.
				if (isShared || (min != null) || (max != null) || (initial != null)) {
					serverSession.setReadConnectionPool(pool);
				}
				String wait = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.JDBC_CONNECTIONS_WAIT, m,
						serverSession);
				if (wait != null) {
					value = wait;
			...
			String sequence = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.JDBC_SEQUENCE_CONNECTION_POOL,
					m, serverSession);
			if (sequence != null) {
				serverSession.getSequencingControl().setShouldUseSeparateConnection(Boolean.parseBoolean(sequence));
			}
			String sequenceDataSource = getConfigPropertyAsStringLogDebug(
					PersistenceUnitProperties.JDBC_SEQUENCE_CONNECTION_POOL_DATASOURCE, m, serverSession);
			...
			// Sizes and shared option are irrelevant for external connection pool
			if (!serverSession.getReadConnectionPool().getLogin().shouldUseExternalConnectionPooling()) {
				value = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.JDBC_SEQUENCE_CONNECTION_POOL_MIN,
						m, serverSession);
				if (value != null) {
				...
				value = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.JDBC_SEQUENCE_CONNECTION_POOL_MAX,
						m, serverSession);
				if (value != null) {
				...
				value = getConfigPropertyAsStringLogDebug(
						PersistenceUnitProperties.JDBC_SEQUENCE_CONNECTION_POOL_INITIAL, m, serverSession);
				if (value != null) {
	 ...
	 * However there are several session attributes that defaulted in EJB3 to the
	 * values different from EclipseLink defaults. This function applies defaults
	 * for such properties and registers the session. All other session-related
	 * properties are applied in updateServerSession. Note that updateSession may be
	 * called several times on the same session (before login), but initSession is
	 * called just once - before the first call to updateSession.
	 */
	...
	protected void updateSession(Map m, ClassLoader loader) {
		...
		if (serverPlatformChanged && session.getSessionLog().shouldLog(SessionLog.FINE)) {
			session.getSessionLog().log(SessionLog.FINE, SessionLog.SERVER, "configured_server_platform",
					session.getServerPlatform().getClass().getName()); // NOI18N
		}
		...
		if (session.isBroker()) {
			...
			((DatasourceLogin) session.getDatasourceLogin())
					.setUsesExternalTransactionController(transactionType == PersistenceUnitTransactionType.JTA);
		} else {
			String shouldBindString = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.JDBC_BIND_PARAMETERS,
					m, session);
			...
			String shouldForceBindString = getConfigPropertyAsStringLogDebug(
					PersistenceUnitProperties.JDBC_FORCE_BIND_PARAMETERS, m, session);
		...
		if (session.isBroker()) {
			if (this.compositeMemberEmSetupImpls != null) {
				// composite
				Map compositeMemberMapOfProperties = (Map) getConfigProperty(
						PersistenceUnitProperties.COMPOSITE_UNIT_PROPERTIES, m);
				for (EntityManagerSetupImpl compositeMemberEmSetupImpl : this.compositeMemberEmSetupImpls) {
					// the properties guaranteed to be non-null after
					// updateCompositeMemberProperties call
					String compositeMemberPuName = compositeMemberEmSetupImpl.getPersistenceUnitInfo()
							.getPersistenceUnitName();
					...
					compositeMemberEmSetupImpl.session.log(SessionLog.FINEST, SessionLog.PROPERTIES,
							"composite_member_begin_call",
							new Object[] { "updateSession", compositeMemberPuName, state });
	...
	/**
	 * This sets the isInContainerMode flag. "true" indicates container case,
	 * "false" - SE.
	 */
	...
	protected void processSessionCustomizer(Map m, ClassLoader loader) {
		String sessionCustomizerClassName = getConfigPropertyAsStringLogDebug(
				PersistenceUnitProperties.SESSION_CUSTOMIZER, m, session);
		if (sessionCustomizerClassName == null) {
			return;
		}
		Class sessionCustomizerClass = findClassForProperty(sessionCustomizerClassName,
				PersistenceUnitProperties.SESSION_CUSTOMIZER, loader);
		...
		try {
			...
			throw EntityManagerSetupException.failedWhileProcessingProperty(
					PersistenceUnitProperties.SESSION_CUSTOMIZER, sessionCustomizerClassName, ex);
		}
	}

	protected void initOrUpdateLogging(Map m, SessionLog log) {
		String logLevelString = PropertiesHandler.getPropertyValueLogDebug(PersistenceUnitProperties.LOGGING_LEVEL, m,
				session);
		if (logLevelString != null) {
			log.setLevel(AbstractSessionLog.translateStringToLoggingLevel(logLevelString));
		}
		// category-specific logging level
		Map categoryLogLevelMap = PropertiesHandler
				.getPrefixValuesLogDebug(PersistenceUnitProperties.CATEGORY_LOGGING_LEVEL_, m, session);
		...
		String connectionString = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.LOGGING_CONNECTION, m,
				session);
		if (connectionString != null) {
		...
		String shouldDisplayData = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.LOGGING_PARAMETERS, m,
				session);
	...
	protected void processDescriptorCustomizers(Map m, ClassLoader loader) {
		Map customizerMap = PropertiesHandler.getPrefixValuesLogDebug(PersistenceUnitProperties.DESCRIPTOR_CUSTOMIZER_,
				m, session);
		...
		while (it.hasNext()) {
			...
			if (descriptor == null) {
				try {
					...
					throw EntityManagerSetupException.failedWhileProcessingProperty(
							PersistenceUnitProperties.DESCRIPTOR_CUSTOMIZER_ + name, customizerClassName, ex);
				}
			}
			if (descriptor != null) {
				Class customizerClass = findClassForProperty(customizerClassName,
						PersistenceUnitProperties.DESCRIPTOR_CUSTOMIZER_ + name, loader);
				try {
				...
				throw EntityManagerSetupException.failedWhileProcessingProperty(
						PersistenceUnitProperties.DESCRIPTOR_CUSTOMIZER_ + name, customizerClassName, null);
			}
		}
	}
	...
	/**
	 * Return if MetadataSource refresh commands should be sent when refresh is
	 * called Checks the PersistenceUnitProperties.METADATA_SOURCE_RCM_COMMAND
	 * property and defaults to true.
	 */
	public boolean shouldSendMetadataRefreshCommand(Map m) {
		String sendCommand = getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.METADATA_SOURCE_RCM_COMMAND, m,
				this.session);
		if (sendCommand != null) {
	 ...
	 * factoryCount to 0 disconnects the session and removes it from the session
	 * manager. This method and predeploy - the only methods altering factoryCount -
	 * should be synchronized. After undeploy call that turns factoryCount to 0:
	 * session==null; PREDEPLOYED, DEPLOYED and DEPLOYED_FAILED states change to
	 * UNDEPLOYED state.
	 */
	public synchronized void undeploy() {
		...
		session.log(SessionLog.FINEST, SessionLog.JPA, "undeploy_begin", new Object[] {
				getPersistenceUnitInfo().getPersistenceUnitName(), session.getName(), state, factoryCount });
		try {
			factoryCount--;
			if (factoryCount > 0) {
			...
			session.log(SessionLog.FINEST, SessionLog.JPA, "undeploy_end", new Object[] {
					getPersistenceUnitInfo().getPersistenceUnitName(), session.getName(), state, factoryCount });
	...
	/**
	 * INTERNAL: By default we require a connection to the database. However, when
	...
	/**
	 * Allow customized session event listener to be added into session. The method
	 * needs to be called in deploy stage.
	 */
	protected void setSessionEventListener(Map m, ClassLoader loader) {
		// Set event listener if it has been specified.
		String sessionEventListenerClassName = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.SESSION_EVENT_LISTENER_CLASS, m, session);
		if (sessionEventListenerClassName != null) {
			Class sessionEventListenerClass = findClassForProperty(sessionEventListenerClassName,
					PersistenceUnitProperties.SESSION_EVENT_LISTENER_CLASS, loader);
			try {
				SessionEventListener sessionEventListener = (SessionEventListener) buildObjectForClass(
						sessionEventListenerClass, SessionEventListener.class);
				if (sessionEventListener != null) {
					session.getEventManager().addListener(sessionEventListener);
				} else {
					session.handleException(
							ValidationException.invalidSessionEventListenerClass(sessionEventListenerClassName));
				}
			} catch (IllegalAccessException e) {
				session.handleException(ValidationException
						.cannotInstantiateSessionEventListenerClass(sessionEventListenerClassName, e));
			} catch (PrivilegedActionException e) {
				session.handleException(ValidationException
						.cannotInstantiateSessionEventListenerClass(sessionEventListenerClassName, e));
			} catch (InstantiationException e) {
	...
	/**
	 * Allow customized exception handler to be added into session. The method needs
	 * to be called in deploy and pre-deploy stage.
	 */
	protected void setExceptionHandler(Map m, ClassLoader loader) {
		// Set exception handler if it was specified.
		String exceptionHandlerClassName = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.EXCEPTION_HANDLER_CLASS, m, session);
		if (exceptionHandlerClassName != null) {
			Class exceptionHandlerClass = findClassForProperty(exceptionHandlerClassName,
					PersistenceUnitProperties.EXCEPTION_HANDLER_CLASS, loader);
			try {
				ExceptionHandler exceptionHandler = (ExceptionHandler) buildObjectForClass(exceptionHandlerClass,
						ExceptionHandler.class);
				if (exceptionHandler != null) {
					session.setExceptionHandler(exceptionHandler);
				} else {
					session.handleException(
							ValidationException.invalidExceptionHandlerClass(exceptionHandlerClassName));
				}
			} catch (IllegalAccessException e) {
				session.handleException(
						ValidationException.cannotInstantiateExceptionHandlerClass(exceptionHandlerClassName, e));
			} catch (PrivilegedActionException e) {
				session.handleException(
						ValidationException.cannotInstantiateExceptionHandlerClass(exceptionHandlerClassName, e));
			} catch (InstantiationException e) {
	...
	protected void updateBatchWritingSetting(Map persistenceProperties, ClassLoader loader) {
		String batchWritingSettingString = PropertiesHandler
				.getPropertyValueLogDebug(PersistenceUnitProperties.BATCH_WRITING, persistenceProperties, this.session);
		if (batchWritingSettingString != null) {
			...
			if (batchWritingSettingString == BatchWriting.JDBC) {
				...
				Class cls = findClassForProperty(batchWritingSettingString, PersistenceUnitProperties.BATCH_WRITING,
						loader);
				...
				try {
					...
					if (batchWritingSettingString.indexOf('.') == -1) {
						throw new IllegalArgumentException(ExceptionLocalization.buildMessage(
								"ejb30-illegal-property-value",
								new Object[] { PersistenceUnitProperties.BATCH_WRITING, batchWritingSettingString }));
					} else {
						throw EntityManagerSetupException.failedToInstantiateProperty(batchWritingSettingString,
		...
		// Set batch size.
		String sizeString = EntityManagerFactoryProvider.getConfigPropertyAsStringLogDebug(
				PersistenceUnitProperties.BATCH_WRITING_SIZE, persistenceProperties, this.session);
		if (sizeString != null) {
			try {
				this.session.getPlatform().setMaxBatchWritingSize(Integer.parseInt(sizeString));
			} catch (NumberFormatException invalid) {
				session.handleException(ValidationException.invalidValueForProperty(sizeString,
						PersistenceUnitProperties.BATCH_WRITING_SIZE, invalid));
			}
		}
	}
	...
	protected void updateMetadataRepository(Map m, ClassLoader loader) {
		Object metadataSource = EntityManagerFactoryProvider
				.getConfigPropertyLogDebug(PersistenceUnitProperties.METADATA_SOURCE, m, session);
		if (metadataSource != null && metadataSource instanceof MetadataSource) {
			...
			if (metadataSource != null) {
				...
				if (repository.equalsIgnoreCase("XML")) {
					...
					Class transportClass = findClassForProperty(repository, PersistenceUnitProperties.METADATA_SOURCE,
							loader);
					try {
						processor.setMetadataSource((MetadataSource) transportClass.newInstance());
					} catch (Exception invalid) {
						session.handleException(EntityManagerSetupException.failedToInstantiateProperty(repository,
								PersistenceUnitProperties.METADATA_SOURCE, invalid));
					}
				}
			}
		}
	...
	protected void updateTunerPreDeploy(Map m, ClassLoader loader) {
		/*
		 * String tuning =
		 * (String)EntityManagerFactoryProvider.getConfigPropertyLogDebug(
		 * PersistenceUnitProperties.TUNING, m, this.session); if (tuning != null) {
		 * SessionTuner tuner = null; if (tuning.equalsIgnoreCase("Safe")) { tuner = new
		 * SafeModeTuner(); } else if (tuning.equalsIgnoreCase("Standard")) { tuner =
		 * new StandardTuner(); } else { if (tuning.equalsIgnoreCase("ExaLogic")) {
		 * tuning = "oracle.toplink.exalogic.tuning.ExaLogicTuner"; } Class tunerClass =
		 * findClassForProperty(tuning, PersistenceUnitProperties.TUNING, loader); try {
		 * tuner = (SessionTuner)tunerClass.newInstance(); } catch (Exception invalid) {
		 * this.session.handleException(EntityManagerSetupException.
		 * failedToInstantiateProperty(tuning, PersistenceUnitProperties.TUNING,
		 * invalid)); } } getDatabaseSession().setTuner(tuner); tuner.tunePreDeploy(m);
		 * }
		 */
	}
	...
	protected void updateFreeMemory(Map m) {
		String freeMemory = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.FREE_METADATA, m, session);
		if (freeMemory != null) {
			if (freeMemory.equalsIgnoreCase("true")) {
				...
				session.handleException(ValidationException.invalidBooleanValueForProperty(freeMemory,
						PersistenceUnitProperties.FREE_METADATA));
			}
		}
	}

	/**
	 * Enable or disable the capability of Native SQL function. The method needs to
	 * be called in deploy stage.
	 */
	protected void updateNativeSQLSetting(Map m) {
		// Set Native SQL flag if it was specified.
		String nativeSQLString = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.NATIVE_SQL, m, session);
	...
	protected void updateSequencing(Map m) {
		String useTable = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.SEQUENCING_SEQUENCE_DEFAULT, m, session);
		if (useTable != null) {
			if (useTable.equalsIgnoreCase("true")) {
				...
				this.session.handleException(ValidationException.invalidBooleanValueForProperty(useTable,
						PersistenceUnitProperties.SEQUENCING_SEQUENCE_DEFAULT));
			}
		}
	}
	...
	protected void updateProjectCache(Map m, ClassLoader loader) {
		Object accessor = EntityManagerFactoryProvider
				.getConfigPropertyLogDebug(PersistenceUnitProperties.PROJECT_CACHE, m, session);
		if (accessor != null) {
			if (accessor instanceof ProjectCache) {
				...
				if (accessorType.equalsIgnoreCase("java-serialization")) {
					...
					Class transportClass = findClassForProperty(accessorType, PersistenceUnitProperties.PROJECT_CACHE,
							loader);
					try {
						projectCacheAccessor = (ProjectCache) transportClass.newInstance();
					} catch (Exception invalid) {
						session.handleException(EntityManagerSetupException.failedToInstantiateProperty(accessorType,
								PersistenceUnitProperties.METADATA_SOURCE, invalid));
					}
				}
			}
	...
	protected void updateJPQLParser(Map m) {
		...
		String parser = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.JPQL_PARSER, m, this.session);
		if (parser != null) {
			if (parser.equalsIgnoreCase(ParserType.Hermes)) {
				parser = "cz.burios.uniql.persistence.internal.jpa.jpql.HermesParser";
			} else if (parser.equalsIgnoreCase(ParserType.ANTLR)) {
				parser = "cz.burios.uniql.persistence.queries.ANTLRQueryBuilder";
			}
			this.session.setProperty(PersistenceUnitProperties.JPQL_PARSER, parser);
		}
		// Set JPQL parser validation mode if it was specified.
		String validation = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.JPQL_VALIDATION, m, this.session);
		if (validation != null) {
	...
	protected void updateAllowNativeSQLQueriesSetting(Map m) {
		...
		String allowNativeSQLQueriesString = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.ALLOW_NATIVE_SQL_QUERIES, m, session);
		...
		if (allowNativeSQLQueriesString != null) {
			if (allowNativeSQLQueriesString.equalsIgnoreCase("true")) {
				...
				session.handleException(ValidationException
						.invalidBooleanValueForSettingAllowNativeSQLQueries(allowNativeSQLQueriesString));
			}
		}
	}
	...
	protected void updateSQLCastSetting(Map m) {
		// Set Native SQL flag if it was specified.
		String sqlCastString = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.SQL_CAST, m, session);
		if (sqlCastString != null) {
			if (sqlCastString.equalsIgnoreCase("true")) {
				...
				session.handleException(ValidationException.invalidBooleanValueForProperty(sqlCastString,
						PersistenceUnitProperties.SQL_CAST));
			}
		}
	}

	/**
	 * Enable or disable forcing field names to uppercase. The method needs to be
	 * called in deploy stage.
	 */
	protected void updateUppercaseSetting(Map m) {
		// Set Native SQL flag if it was specified.
		String uppercaseString = EntityManagerFactoryProvider.getConfigPropertyAsStringLogDebug(
				PersistenceUnitProperties.NATIVE_QUERY_UPPERCASE_COLUMNS, m, session);
		if (uppercaseString != null) {
			if (uppercaseString.equalsIgnoreCase("true")) {
				...
				this.session.handleException(ValidationException.invalidBooleanValueForProperty(uppercaseString,
						PersistenceUnitProperties.NATIVE_QUERY_UPPERCASE_COLUMNS));
			}
		}
	}
	 ...
	 * Implementation of case insensitive column handling relies on setting both
	 * sides to uppercase (the column names from annotations/xml as well as what is
	 * returned from the JDBC/statement) The method needs to be called in deploy
	 * stage.
	 */
	public static void updateCaseSensitivitySettings(Map m, MetadataProject project, AbstractSession session) {
		// Set Native SQL flag if it was specified.
		String insensitiveString = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.UPPERCASE_COLUMN_NAMES, m, session);
		if (insensitiveString == null || insensitiveString.equalsIgnoreCase("true")) {
			...
			session.handleException(ValidationException.invalidBooleanValueForProperty(insensitiveString,
					PersistenceUnitProperties.UPPERCASE_COLUMN_NAMES));
		}
	}
	...
	protected void updatePessimisticLockTimeout(Map persistenceProperties) {
		String pessimisticLockTimeout = EntityManagerFactoryProvider.getConfigPropertyAsStringLogDebug(
				PersistenceUnitProperties.PESSIMISTIC_LOCK_TIMEOUT, persistenceProperties, session);

		if (pessimisticLockTimeout != null) {
			try {
				session.setPessimisticLockTimeoutDefault(Integer.parseInt(pessimisticLockTimeout));
			} catch (NumberFormatException invalid) {
				session.handleException(ValidationException.invalidValueForProperty(pessimisticLockTimeout,
						PersistenceUnitProperties.PESSIMISTIC_LOCK_TIMEOUT, invalid));
			}
		}
	}

	/**
	 * Enable or disable statements cached, update statements cache size. The method
	 * needs to be called in deploy stage.
	 */
	protected void updateCacheStatementSettings(Map m) {
		// Cache statements if flag was specified.
		String statmentsNeedBeCached = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.CACHE_STATEMENTS, m, session);
			...
			if (statmentsNeedBeCached.equalsIgnoreCase("true")) {
				if (session.isServerSession() && ((ServerSession) session).getConnectionPools().isEmpty()) {
					session.log(SessionLog.WARNING, SessionLog.PROPERTIES,
							"persistence_unit_ignores_statments_cache_setting", new Object[] { null });
				} else {
				...
				session.handleException(
						ValidationException.invalidBooleanValueForEnableStatmentsCached(statmentsNeedBeCached));
			}
		}

		// Set statement cache size if specified.
		String cacheStatementsSize = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.CACHE_STATEMENTS_SIZE, m, session);
		if (cacheStatementsSize != null) {
			try {
				session.getProject().getLogin().setStatementCacheSize(Integer.parseInt(cacheStatementsSize));
			} catch (NumberFormatException e) {
				session.handleException(
						ValidationException.invalidCacheStatementsSize(cacheStatementsSize, e.getMessage()));
			}
		}
	}
	...
	protected void updateAllowZeroIdSetting(Map m) {
		String allowZero = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.ALLOW_ZERO_ID, m, this.session);
		if (allowZero != null) {
			if (allowZero.equalsIgnoreCase("true")) {
				...
				session.handleException(ValidationException.invalidBooleanValueForProperty(allowZero,
						PersistenceUnitProperties.ALLOW_ZERO_ID));
			}
		}
	}
	...
	protected void updateIdValidation(Map m) {
		String idValidationString = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.ID_VALIDATION, m, session);
	...
	/**
	 * sets the TABLE_CREATION_SUFFIX property on the session's project to be
	 * applied to all table creation statements (DDL)
	 */
	protected void updateTableCreationSettings(Map m) {
		String tableCreationSuffix = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.TABLE_CREATION_SUFFIX, m, session);
	...
	protected void updateIndexForeignKeys(Map m) {
		String indexForeignKeys = EntityManagerFactoryProvider.getConfigPropertyAsStringLogDebug(
				PersistenceUnitProperties.DDL_GENERATION_INDEX_FOREIGN_KEYS, m, this.session);
		if (indexForeignKeys != null && (indexForeignKeys.length() > 0)) {
			if (indexForeignKeys.equalsIgnoreCase("true")) {
				...
				this.session.handleException(ValidationException.invalidBooleanValueForProperty(indexForeignKeys,
						PersistenceUnitProperties.DDL_GENERATION_INDEX_FOREIGN_KEYS));
			}
		}
	}

	/**
	 * Enable or disable default temporal mutable setting. The method needs to be
	 * called in deploy stage.
	 */
	protected void updateTemporalMutableSetting(Map m) {
		// Cache statements if flag was specified.
		String temporalMutable = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.TEMPORAL_MUTABLE, m, session);
		if (temporalMutable != null) {
			if (temporalMutable.equalsIgnoreCase("true")) {
				...
				session.handleException(ValidationException.invalidBooleanValueForProperty(temporalMutable,
	...
	/**
	 * Copy named queries defined in EclipseLink descriptor into the session if it
	 * was indicated to do so.
	 */
	protected void setDescriptorNamedQueries(Map m) {
		// Copy named queries to session if the flag has been specified.
		String addNamedQueriesString = EntityManagerFactoryProvider
				.getConfigPropertyAsStringLogDebug(PersistenceUnitProperties.INCLUDE_DESCRIPTOR_QUERIES, m, session);
		if (addNamedQueriesString != null) {
			if (addNamedQueriesString.equalsIgnoreCase("true")) {
				...
				if (!addNamedQueriesString.equalsIgnoreCase("false")) {
					session.handleException(
							ValidationException.invalidBooleanValueForAddingNamedQueries(addNamedQueriesString));
				}
			}
		}
	}
	...
	private void updateQueryTimeout(Map persistenceProperties) {
		String timeout = EntityManagerFactoryProvider.getConfigPropertyAsStringLogDebug(
				PersistenceUnitProperties.QUERY_TIMEOUT, persistenceProperties, session);
		try {
			if (timeout != null) {
				session.setQueryTimeoutDefault(Integer.parseInt(timeout));
			}
		} catch (NumberFormatException exception) {
			this.session.handleException(ValidationException.invalidValueForProperty(timeout,
					PersistenceUnitProperties.QUERY_TIMEOUT, exception));
		}
	}

	// Bug #456067: Added persistence unit support for timeout units
	private void updateQueryTimeoutUnit(Map persistenceProperties) {
		String timeoutUnit = EntityManagerFactoryProvider.getConfigPropertyAsStringLogDebug(
				PersistenceUnitProperties.QUERY_TIMEOUT_UNIT, persistenceProperties, session);
		try {
			if (timeoutUnit != null) {
			...
			this.session.handleException(ValidationException.invalidValueForProperty(timeoutUnit,
					PersistenceUnitProperties.QUERY_TIMEOUT_UNIT, exception));
		}
	}

	private void updateLockingTimestampDefault(Map persistenceProperties) {
		String local = EntityManagerFactoryProvider.getConfigPropertyAsStringLogDebug(
				PersistenceUnitProperties.USE_LOCAL_TIMESTAMP, persistenceProperties, session);
		try {
			if (local != null) {
				for (ClassDescriptor descriptor : session.getProject().getDescriptors().values()) {
			...
			this.session.handleException(ValidationException.invalidValueForProperty(local,
					PersistenceUnitProperties.USE_LOCAL_TIMESTAMP, exception));
		}
	}
	...
	private void addBeanValidationListeners(Map puProperties, ClassLoader appClassLoader) {
		...
		if (validationMode == ValidationMode.AUTO || validationMode == ValidationMode.CALLBACK) {
			// BeanValidationInitializationHelper contains static reference to
			// javax.validation.* classes. We need to support
			// environment where these classes are not available.
			// To guard against some vms that eagerly resolve, reflectively load class to
			// prevent any static reference to it
			String helperClassName = "cz.burios.uniql.persistence.internal.jpa.deployment.BeanValidationInitializationHelper$BeanValidationInitializationHelperImpl";
			Class helperClass;
			try {
				if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()) {
					helperClass = AccessController
							.doPrivileged(new PrivilegedClassForName(helperClassName, true, appClassLoader));
				} else {
					helperClass = PrivilegedAccessHelper.getClassForName(helperClassName, true, appClassLoader);
				}
				BeanValidationInitializationHelper beanValidationInitializationHelper = (BeanValidationInitializationHelper) helperClass
						.newInstance();
				...
				} // else validationMode == ValidationMode.AUTO. Log a message, Ignore the
					// exception
				this.session.log(SessionLog.FINEST, SessionLog.JPA, "validation_factory_not_initialized",
						new Object[] { e.getMessage() });
			}
		}
	}
	...
	/**
	 * Validation mode from information in persistence.xml and properties specified
	 * at EMF creation
	 * 
	 * @param persitenceUnitInfo PersitenceUnitInfo instance for this persistence
	 *                           unit
	 * @param puProperties       merged properties for this persistence unit
	...
	private static ValidationMode getValidationMode(PersistenceUnitInfo persitenceUnitInfo, Map puProperties) {
		...
		if (validationModeAtEMFCreation != null) {
			// User will receive IllegalArgumentException if an invalid mode has been
			// specified
		...
		// Using reflection to call getValidationMode to prevent blowing up while we are
		// running in JPA 1.0 environment
		// (This would be all JavaEE5 appservers) where PersistenceUnitInfo does not
		// implement method getValidationMode().
		try {
			Method method = null;
			if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()) {
				method = AccessController.doPrivileged(
						new PrivilegedGetDeclaredMethod(PersistenceUnitInfo.class, "getValidationMode", null));
				validationMode = (ValidationMode) AccessController
						.doPrivileged(new PrivilegedMethodInvoker(method, persitenceUnitInfo));
			} else {
			...
			// We are running in JavaEE5 environment. Catch and swallow any exceptions and
			// return null.
		}
	...
	/**
	 * INTERNAL: Return an instance of Metamodel interface for access to the
	 * metamodel of the persistence unit. This method will complete any
	 * initialization done in the predeploy phase of deployment.
	 * 
	...
	protected void initializeCanonicalMetamodel(Metamodel model) {
		// 338837: verify that the collection is not empty - this would mean entities
		// did not make it into the search path
		...
		for (ManagedType manType : model.getManagedTypes()) {
			...
			try {
				Class clazz = (Class) this.getSession().getDatasourcePlatform().convertObject(className,
						ClassConstants.CLASS);
				classInitialized = true;
				this.getSession().log(SessionLog.FINER, SessionLog.METAMODEL, "metamodel_canonical_model_class_found",
						className);
				String fieldName = "";
				for (Object attribute : manType.getDeclaredAttributes()) {
					try {
						...
						if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()) {
							AccessController.doPrivileged(new PrivilegedGetDeclaredField(clazz, fieldName, false))
									.set(clazz, attribute);
						} else {
			...
			if (!classInitialized) {
				getSession().log(SessionLog.FINER, SessionLog.METAMODEL, "metamodel_canonical_model_class_not_found",
						className);
			}
		}
	}
	 ...
	 * possible case that we want to regenerate it. This function is outside of the
	...
	public static boolean mustBeCompositeMember(PersistenceUnitInfo puInfo) {
		String mustBeCompositeMemberStr = PropertiesHandler
				.getPropertyValue(PersistenceUnitProperties.COMPOSITE_UNIT_MEMBER, puInfo.getProperties(), false);
	...
	public static boolean isComposite(PersistenceUnitInfo puInfo) {
		String isCompositeString = PropertiesHandler.getPropertyValue(PersistenceUnitProperties.COMPOSITE_UNIT,
				puInfo.getProperties(), false);
	...
	protected void predeployCompositeMembers(Map predeployProperties, ClassLoader tempClassLoader) {
		...
		// all these puInfos are not composite because composites are recursively "taken
		// apart", too.
		Set<SEPersistenceUnitInfo> compositeMemberPuInfos = getCompositeMemberPuInfoSet(persistenceUnitInfo,
				predeployProperties);
		// makes sure each member has a non-null property, overrides where required
		// properties with composite's predeploy properties.
		updateCompositeMembersProperties(compositeMemberPuInfos, predeployProperties);
		// Don't log these properties - may contain passwords. The properties will be
		// logged by contained persistence units.
		Map compositeMemberMapOfProperties = (Map) getConfigProperty(
				PersistenceUnitProperties.COMPOSITE_UNIT_PROPERTIES, predeployProperties);
		...
		// all composite members should complete a stage before any of them can move to
		// the next one.
		...
		// after the second loop containedEmSetupImpls are still in HalfPredeployed
		// state,
		...
		for (EntityManagerSetupImpl containedEmSetupImpl : this.compositeMemberEmSetupImpls) {
			...
			// if both composite and composite member weavings enabled copy class details
			// from member's weaver to composite's one.
	...
	protected void deployCompositeMembers(Map deployProperties, ClassLoader realClassLoader) {
		...
		// logged by contained persistence units.
		Map compositeMemberMapOfProperties = (Map) getConfigProperty(
				PersistenceUnitProperties.COMPOSITE_UNIT_PROPERTIES, deployProperties);
		for (EntityManagerSetupImpl compositeMemberEmSetupImpl : this.compositeMemberEmSetupImpls) {
			// the properties guaranteed to be non-null after
			// updateCompositeMemberProperties call
			Map compositeMemberProperties = (Map) compositeMemberMapOfProperties
					.get(compositeMemberEmSetupImpl.getPersistenceUnitInfo().getPersistenceUnitName());
	...
	/**
	 * INTERNAL: Cause the first phase of metamodel initialization. This phase
	 * involves detecting the classes involved and build metamodel instances for
	 * them.
	 */
	...
	/**
	 * INTERNAL: First phase of canonical metamodel initialization. For each class
	 * the metamodel is aware of, check for a canonical metamodel class and
	 * initialize each attribute in it with a proxy that can cause the rest of the
	 * metamodel population. Attributes are found reflectively rather than through
	 * the metamodel to avoid having to further initialize the metamodel.
	 * 
	 * @param factory
	 */
	public void preInitializeCanonicalMetamodel(EntityManagerFactoryImpl factory) {
		...
		for (ManagedType manType : metaModel.getManagedTypes()) {
			boolean classInitialized = false;
			String className = MetadataHelper.getQualifiedCanonicalName(((ManagedTypeImpl) manType).getJavaTypeName(),
					getSession());
			try {
				Class clazz = (Class) this.getSession().getDatasourcePlatform().convertObject(className,
						ClassConstants.CLASS);
				...
				for (Field attribute : fields) {
					if (Attribute.class.isAssignableFrom(attribute.getType())) {
						...
						if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()) {
							assignedAttribute = AccessController
									.doPrivileged(new PrivilegedGetValueFromField(attribute, null));
						} else {
	...
	/*
	 * Overide composite member properties' map with a new one, which has (possibly
	 * empty but non-null) properties for each composite member, for required
	 * properties overrides values with those from composite properties.
	 */
	 ...
	 * Overide composite member properties' map with a new one, which has (possibly
	 * empty but non-null) properties for each composite member, for required
	 * properties overrides values with those from composite properties. Parameter
	 * compositePuInfo indicates whether compositeMemberPreoperties should be merged
	 * (overriding) with its puInfo properties (false for predeploy, true for
	 * deploy).
	 */
	protected void updateCompositeMembersProperties(Set<SEPersistenceUnitInfo> compositePuInfos,
			Map compositeProperties) {
		// Don't log these properties - may contain passwords. The properties will be
		// logged by contained persistence units.
		Map compositeMemberMapOfProperties = (Map) getConfigProperty(
				PersistenceUnitProperties.COMPOSITE_UNIT_PROPERTIES, compositeProperties);
	...
	/*
	 * For required properties overrides values with those from composite
	 * properties.
	 */
	protected static void overrideMemberProperties(Map memberProperties, Map compositeProperties) {
		...
		Boolean isValidationOnly = (Boolean) compositeProperties
				.get(PersistenceUnitProperties.VALIDATION_ONLY_PROPERTY);
	...
	/*
	 * If a member is composite then add its members instead. All members' puNames
	 * must be unique. Return a Map of composite member SEPersistenceUnitInfo keyed
	 * by persistence unit name.
	 */
	protected static Map<String, SEPersistenceUnitInfo> getCompositeMemberPuInfoMap(PersistenceUnitInfo puInfo,
			Map predeployProperties) {
		Set<SEPersistenceUnitInfo> memeberPuInfoSet = PersistenceUnitProcessor
				.getPersistenceUnits(puInfo.getClassLoader(), predeployProperties, puInfo.getJarFileUrls());
		...
		for (SEPersistenceUnitInfo memberPuInfo : memeberPuInfoSet) {
			...
			if (isComposite(memberPuInfo)) {
				Map<String, SEPersistenceUnitInfo> containedMemberPuInfoMap = getCompositeMemberPuInfoMap(memberPuInfo,
						memberPuInfo.getProperties());
				...
				while (it.hasNext()) {
					...
					if (anotherMemeberPuInfo == null) {
						...
						throwPersistenceUnitNameAlreadyInUseException(containedMemberPuName, containedMemberPuInfo,
								anotherMemeberPuInfo);
					}
				}
			} else {
	...
	/*
	 * If a member is composite then add its members instead. All members' puNames
	 * must be unique. Return a Set of composite member SEPersistenceUnitInfo.
	 */
	protected static Set<SEPersistenceUnitInfo> getCompositeMemberPuInfoSet(PersistenceUnitInfo puInfo,
			Map predeployProperties) {
		return new HashSet(getCompositeMemberPuInfoMap(puInfo, predeployProperties).values());
	}

	public static void throwPersistenceUnitNameAlreadyInUseException(String puName, PersistenceUnitInfo newPuInfo,
	...
	/**
	 * Create a new version of this EntityManagerSetupImpl and cache it. Prepare
	 * "this" EntityManagerSetupImpl for garbage collection.
	 * 
	 * This call will mean any users of this EntityManagerSetupImpl will get the new
	 * version the next time they look it up (for instance and EntityManager
	 * creation time)
	 * 
	 * @param properties
	 * @return
	...
	public EntityManagerSetupImpl refreshMetadata(Map properties) {
		...
		// newSetupImpl has been already predeployed, predeploy will just increment
		// factoryCount.
		...
		synchronized (EntityManagerFactoryProvider.emSetupImpls) {
			...
			// stop this EntityManagerSetupImpl's session from processing refresh commands.
			// The new session should listen instead.
	...
	/**
	 * This method is just a wrapper on refreshMetadata so that core does not need a
	 * dependency on JPA due to the EntityManagerSetupImpl return value. This method
	 * satisfies the MetedataRefreshListener implementation and is called by
	 * incoming RCM refresh commands
	 * 
	 * @see refreshMetadata
	 */
	...
	public void writeDDL(Map props, DatabaseSessionImpl session, ClassLoader classLoader) {
		if (this.compositeMemberEmSetupImpls == null) {
			// Generate the DDL if we find either EclipseLink or JPA DDL generation
			// properties.
			// Note, we do one or the other, that is, we do not mix the properties by
			// default
			...
			if (hasConfigProperty(DDL_GENERATION, props)) {
				...
				if (hasConfigProperty(SCHEMA_GENERATION_DATABASE_ACTION, props)) {
					String databaseGenerationAction = getConfigPropertyAsString(SCHEMA_GENERATION_DATABASE_ACTION,
							props).toLowerCase();
					...
					if (!databaseGenerationAction.equals(SCHEMA_GENERATION_NONE_ACTION)) {
						if (databaseGenerationAction.equals(SCHEMA_GENERATION_CREATE_ACTION)) {
							writeDDL(SCHEMA_GENERATION_CREATE_SOURCE, SCHEMA_GENERATION_CREATE_SCRIPT_SOURCE,
									TableCreationType.CREATE, props, session, classLoader);
						} else if (databaseGenerationAction.equals(PersistenceUnitProperties.CREATE_OR_EXTEND)) {
							writeDDL(SCHEMA_GENERATION_CREATE_SOURCE, SCHEMA_GENERATION_CREATE_SCRIPT_SOURCE,
									TableCreationType.EXTEND, props, session, classLoader);
						} else if (databaseGenerationAction.equals(SCHEMA_GENERATION_DROP_ACTION)) {
							writeDDL(SCHEMA_GENERATION_DROP_SOURCE, SCHEMA_GENERATION_DROP_SCRIPT_SOURCE,
									TableCreationType.DROP, props, session, classLoader);
							...
							String validOptions = SCHEMA_GENERATION_CREATE_ACTION + ", " + SCHEMA_GENERATION_DROP_ACTION
									+ ", " + SCHEMA_GENERATION_DROP_AND_CREATE_ACTION + ", "
									+ PersistenceUnitProperties.CREATE_OR_EXTEND;
							session.log(SessionLog.WARNING, SessionLog.PROPERTIES,
									"ddl_generation_unknown_property_value",
									new Object[] { SCHEMA_GENERATION_DATABASE_ACTION, databaseGenerationAction,
											persistenceUnitInfo.getPersistenceUnitName(), validOptions });
						}
					}
				}
				...
				if (hasConfigProperty(SCHEMA_GENERATION_SCRIPTS_ACTION, props)) {
					String scriptsGenerationAction = getConfigPropertyAsString(SCHEMA_GENERATION_SCRIPTS_ACTION, props)
							.toLowerCase();
					...
					if (!scriptsGenerationAction.equals(SCHEMA_GENERATION_NONE_ACTION)) {
						if (scriptsGenerationAction.equals(SCHEMA_GENERATION_CREATE_ACTION)) {
							...
							session.log(SessionLog.WARNING, SessionLog.PROPERTIES,
									"ddl_generation_unknown_property_value",
									new Object[] { SCHEMA_GENERATION_SCRIPTS_ACTION, scriptsGenerationAction,
											persistenceUnitInfo.getPersistenceUnitName(), validOptions });
						}
					}
				}
				...
				writeSourceScriptToDatabase(getConfigProperty(SCHEMA_GENERATION_SQL_LOAD_SCRIPT_SOURCE, props), session,
						classLoader);
			}
		} else {
			// composite
			Map compositeMemberMapOfProperties = (Map) getConfigProperty(
					PersistenceUnitProperties.COMPOSITE_UNIT_PROPERTIES, props);
			for (EntityManagerSetupImpl compositeMemberEmSetupImpl : this.compositeMemberEmSetupImpls) {
				// the properties guaranteed to be non-null after
				// updateCompositeMemberProperties call
				Map compositeMemberProperties = (Map) compositeMemberMapOfProperties
	...
	/**
	 * INTERNAL: Generate the DDL from the persistence unit metadata. This DDL
	 * generation utilizes the EclipseLink DDL properties.
	 */
	protected void writeDDL(String ddlGeneration, Map props, DatabaseSessionImpl session, ClassLoader classLoader) {
		...
		if (ddlGeneration.equals(PersistenceUnitProperties.CREATE_ONLY)) {
			...
			String validOptions = PersistenceUnitProperties.NONE + ", " + PersistenceUnitProperties.CREATE_ONLY + ", "
					+ PersistenceUnitProperties.DROP_ONLY + ", " + PersistenceUnitProperties.DROP_AND_CREATE + ", "
					+ PersistenceUnitProperties.CREATE_OR_EXTEND;
			session.log(SessionLog.WARNING, SessionLog.PROPERTIES, "ddl_generation_unknown_property_value",
					new Object[] { PersistenceUnitProperties.DDL_GENERATION, ddlGeneration,
							persistenceUnitInfo.getPersistenceUnitName(), validOptions });
		}

		if (ddlType != TableCreationType.NONE) {
			String ddlGenerationMode = getConfigPropertyAsString(PersistenceUnitProperties.DDL_GENERATION_MODE, props,
			...
			if (!ddlGenerationMode.equals(NONE)) {
				if (isCompositeMember()) {
					// debug output added to make it easier to navigate the log because the method
					// is called outside of composite member deploy
					session.log(SessionLog.FINEST, SessionLog.PROPERTIES, "composite_member_begin_call",
							new Object[] { "generateDDL", persistenceUnitInfo.getPersistenceUnitName(), state });
				}

				SchemaManager mgr = new SchemaManager(session);

				if (ddlGenerationMode.equals(PersistenceUnitProperties.DDL_DATABASE_GENERATION)
						|| ddlGenerationMode.equals(PersistenceUnitProperties.DDL_BOTH_GENERATION)) {
					writeDDLToDatabase(mgr, ddlType);
				}

				if (ddlGenerationMode.equals(PersistenceUnitProperties.DDL_SQL_SCRIPT_GENERATION)
						|| ddlGenerationMode.equals(PersistenceUnitProperties.DDL_BOTH_GENERATION)) {
					String appLocation = getConfigPropertyAsString(PersistenceUnitProperties.APP_LOCATION, props,
							PersistenceUnitProperties.DEFAULT_APP_LOCATION);

					// These could be a string (file name urls) or actual writers.
					Object createDDLJdbc = getConfigProperty(PersistenceUnitProperties.CREATE_JDBC_DDL_FILE, props,
							PersistenceUnitProperties.DEFAULT_CREATE_JDBC_FILE_NAME);
					Object dropDDLJdbc = getConfigProperty(PersistenceUnitProperties.DROP_JDBC_DDL_FILE, props,
				...
				if ((!ddlGenerationMode.equals(PersistenceUnitProperties.DDL_DATABASE_GENERATION))
						&& (!ddlGenerationMode.equals(PersistenceUnitProperties.DDL_SQL_SCRIPT_GENERATION))
						&& (!ddlGenerationMode.equals(PersistenceUnitProperties.DDL_BOTH_GENERATION))) {
					...
					session.log(SessionLog.WARNING, SessionLog.PROPERTIES, "ddl_generation_unknown_property_value",
							new Object[] { PersistenceUnitProperties.DDL_GENERATION_MODE, ddlGenerationMode,
									persistenceUnitInfo.getPersistenceUnitName(), validOptions });
				}
				...
				if (isCompositeMember()) {
					// debug output added to make it easier to navigate the log because the method
					// is called outside of composite member deploy
					session.log(SessionLog.FINEST, SessionLog.PROPERTIES, "composite_member_end_call",
							new Object[] { "generateDDL", persistenceUnitInfo.getPersistenceUnitName(), state });
				}
			}
		}
	 ...
	 */
	protected void writeDDL(String generationSourceProperty, String scriptGenerationSourceProperty,
			TableCreationType tableCreationType, Map props, DatabaseSessionImpl session, ClassLoader loader) {
		...
		if (generationSource == null) {
			...
			String validOptions = SCHEMA_GENERATION_METADATA_SOURCE + ", " + SCHEMA_GENERATION_SCRIPT_SOURCE + ", "
					+ SCHEMA_GENERATION_METADATA_THEN_SCRIPT_SOURCE + ", "
					+ SCHEMA_GENERATION_SCRIPT_THEN_METADATA_SOURCE;
			session.log(SessionLog.WARNING, SessionLog.PROPERTIES, "ddl_generation_unknown_property_value",
					new Object[] { generationSourceProperty, generationSource,
							persistenceUnitInfo.getPersistenceUnitName(), validOptions });
		}
	}

	/**
	 * INTERNAL: Generate and write DDL from the persistence unit metadata to the
	 * database.
	 */
	 ...
	 */
	protected void writeDDLToFiles(SchemaManager mgr, String appLocation, Object createDDLJdbc, Object dropDDLJdbc,
			TableCreationType ddlType, Map props) {
		...
		if (ddlType.equals(TableCreationType.CREATE) || ddlType.equals(TableCreationType.DROP_AND_CREATE)
				|| ddlType.equals(TableCreationType.EXTEND)) {
			if (createDDLJdbc == null) {
				// Using EclipseLink properties, the create script has a default.
				// Using JPA properties, the user must specify the target else an exception must
				// be thrown.
				throw new IllegalArgumentException(
						ExceptionLocalization.buildMessage("jpa21-ddl-create-script-target-not-specified"));
		...
		if (ddlType.equals(TableCreationType.DROP) || ddlType.equals(TableCreationType.DROP_AND_CREATE)) {
			if (dropDDLJdbc == null) {
				...
				// be thrown.
				throw new IllegalArgumentException(
						ExceptionLocalization.buildMessage("jpa21-ddl-drop-script-target-not-specified"));
				...
				throw new PersistenceException(ExceptionLocalization.buildMessage(
						"jpa21-ddl-invalid-target-script-type", new Object[] { dropDDLJdbc, dropDDLJdbc.getClass() }));
			}
		}

		String propString = getConfigPropertyAsString(
				PersistenceUnitProperties.SCHEMA_GENERATION_SCRIPT_TERMINATE_STATEMENTS, props);
	 ...
	 * database.
	 */
	protected void writeMetadataDDLToDatabase(TableCreationType tableCreationType, Map props,
			DatabaseSessionImpl session, ClassLoader classLoader) {
		SchemaManager mgr = new SchemaManager(session);
	...
	/**
	 * INTERNAL: Generate and write DDL from the persistence unit metadata to
	 * scripts.
	 */
	protected void writeMetadataDDLToScript(TableCreationType tableCreationType, Map props, DatabaseSessionImpl session,
		...
		writeDDLToFiles(mgr, getConfigPropertyAsString(PersistenceUnitProperties.APP_LOCATION, props),
				getConfigProperty(SCHEMA_GENERATION_SCRIPTS_CREATE_TARGET, props),
				getConfigProperty(SCHEMA_GENERATION_SCRIPTS_DROP_TARGET, props), tableCreationType, props);
	}

	/**
	 * This method will read SQL from a reader or URL and send it through to the
	 * database. This could open up the database to SQL injection if not careful.
	 */
		...
		if (source != null) {
			...
			try {
				if (source instanceof Reader) {
					...
					// Try to load the resource first, if not assume it as a well formed URL. If
					...
					if (sourceURL == null) {
						try {
							...
							throw new PersistenceException(ExceptionLocalization
									.buildMessage("jpa21-ddl-source-script-not-found", new Object[] { source }), e);
						}
					}

					URLConnection connection = sourceURL.openConnection();
					// Set to false to prevent locking of jar files on Windows. EclipseLink issue
					// 249664
					connection.setUseCaches(false);
					reader = new InputStreamReader(connection.getInputStream(), "UTF-8");
				} else {
					throw new PersistenceException(ExceptionLocalization.buildMessage(
							"jpa21-ddl-invalid-source-script-type", new Object[] { source, source.getClass() }));
				}
				...
				throw new PersistenceException(ExceptionLocalization
						.buildMessage("jpa21-ddl-source-script-io-exception", new Object[] { source }), e);
			} finally {
				if (reader != null) {
					try {
						reader.close();
