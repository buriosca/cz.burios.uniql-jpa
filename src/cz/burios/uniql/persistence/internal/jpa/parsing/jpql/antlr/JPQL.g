...
options {
    ...
    superClass = 'cz.burios.uniql.persistence.internal.jpa.parsing.jpql.JPQLParser';
}
...
@header {
    package cz.burios.uniql.persistence.internal.jpa.parsing.jpql.antlr;

    import java.util.List;
    import java.util.ArrayList;

    import static cz.burios.uniql.persistence.internal.jpa.parsing.NodeFactory.*;
    import cz.burios.uniql.persistence.internal.jpa.parsing.jpql.InvalidIdentifierException;
...
@lexer::header {
    ...
    import cz.burios.uniql.persistence.internal.jpa.parsing.jpql.InvalidIdentifierStartException;
}
