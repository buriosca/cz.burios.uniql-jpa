...
public class RootImpl<X> extends FromImpl<X, X> implements Root<X> {
    ...
    public <T> RootImpl(ManagedType managedType, Metamodel metamodel, Class<X> javaClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, Bindable modelArtifact) {
        super((Path) null, managedType, metamodel, javaClass, expressionNode, modelArtifact);
    }

    public <T> RootImpl(ManagedType managedType, Metamodel metamodel, Class<X> javaClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, Bindable modelArtifact, FromImpl correlatedParent) {
