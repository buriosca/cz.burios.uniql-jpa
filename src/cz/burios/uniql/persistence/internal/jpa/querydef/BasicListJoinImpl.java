...
public class BasicListJoinImpl<Z, E> extends ListJoinImpl<Z, E> {
    ...
    public <T> BasicListJoinImpl(Path<Z> parentPath, Metamodel metamodel, Class<E> javaClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, Bindable<T> modelArtifact){
        this(parentPath, metamodel, javaClass, expressionNode, modelArtifact,JoinType.INNER);
    }

    public <C, T> BasicListJoinImpl(Path<Z> parentPath, Metamodel metamodel, Class<E> javaClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, Bindable<T> modelArtifact, JoinType joinType){
