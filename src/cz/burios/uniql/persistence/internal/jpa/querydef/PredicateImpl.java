...
public class PredicateImpl extends CompoundExpressionImpl implements Predicate {
    ...
    public <T> PredicateImpl (Metamodel metamodel, cz.burios.uniql.persistence.expressions.Expression expressionNode, List<Expression<?>> parentExpressions, BooleanOperator operator){
