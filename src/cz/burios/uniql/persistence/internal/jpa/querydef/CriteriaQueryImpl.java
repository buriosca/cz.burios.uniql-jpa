        ...
        if (this.queryResult == ResultType.UNKNOWN) {
            ...
            if (selection == null) {
                if (this.roots != null && !this.roots.isEmpty()) {
                    ...
                    List<cz.burios.uniql.persistence.expressions.Expression> list = ((FromImpl) this.roots.iterator().next()).findJoinFetches();
                    for (cz.burios.uniql.persistence.expressions.Expression fetch : list) {
    ...
    public DatabaseQuery translate() {
        ...
        if (this.orderBy != null && !this.orderBy.isEmpty()) {
            for (Order order : this.orderBy) {
                ...
                cz.burios.uniql.persistence.expressions.Expression orderExp = ((ExpressionImpl) orderImpl.getExpression()).getCurrentNode();
