...
public class BasicMapJoinImpl<Z, K, E> extends MapJoinImpl<Z, K, E> {
    public <T> BasicMapJoinImpl(Path<Z> parentPath, Metamodel metamodel, Class<E> javaClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, Bindable<T> modelArtifact){
        this(parentPath, metamodel, javaClass, expressionNode, modelArtifact,JoinType.INNER);
    }

    public <T> BasicMapJoinImpl(Path<Z> parentPath, Metamodel metamodel, Class<E> javaClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, Bindable<T> modelArtifact, JoinType joinType){
