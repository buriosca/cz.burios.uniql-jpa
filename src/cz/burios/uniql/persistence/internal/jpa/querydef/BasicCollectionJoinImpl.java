...
public class BasicCollectionJoinImpl<Z, E> extends CollectionJoinImpl<Z, E> {
    ...
    public <T> BasicCollectionJoinImpl(Path<Z> parentPath, Metamodel metamodel, Class<E> javaClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, Bindable<T> modelArtifact){
        this(parentPath, metamodel, javaClass, expressionNode, modelArtifact,JoinType.INNER);
    }

    public <C, T> BasicCollectionJoinImpl(Path<Z> parentPath, Metamodel metamodel, Class<E> javaClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, Bindable<T> modelArtifact, JoinType joinType){
