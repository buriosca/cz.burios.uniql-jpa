...
public class FromImpl<Z, X>  extends PathImpl<X> implements javax.persistence.criteria.From<Z, X> {
    ...
    public <T> FromImpl(Path<Z> parentPath, ManagedType managedType, Metamodel metamodel, Class<X> javaClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, Bindable<T> modelArtifact) {
    ...
    public <T> FromImpl(Path<Z> parentPath, ManagedType managedType, Metamodel metamodel, Class<X> javaClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, Bindable<T> modelArtifact, FromImpl correlatedParent) {
    ...
    public <Y> Fetch<X, Y> fetch(PluralAttribute<? super X, ?, Y> assoc, JoinType jt) {
        cz.burios.uniql.persistence.expressions.Expression node;
        Fetch fetch;
        if (jt.equals(JoinType.LEFT)) {
    ...
    public List<cz.burios.uniql.persistence.expressions.Expression> findJoinFetches(){
        List<cz.burios.uniql.persistence.expressions.Expression> fetches = new ArrayList<cz.burios.uniql.persistence.expressions.Expression>();
        Stack stack = new Stack();
        stack.push(this);
        while(!stack.isEmpty()){
