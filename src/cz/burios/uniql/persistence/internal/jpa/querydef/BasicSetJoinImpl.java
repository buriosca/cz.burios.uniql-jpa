...
public class BasicSetJoinImpl<Z, E> extends SetJoinImpl<Z, E> {
    ...
    public <T> BasicSetJoinImpl(Path<Z> parentPath, Metamodel metamodel, Class<E> javaClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, Bindable<T> modelArtifact){
        this(parentPath, metamodel, javaClass, expressionNode, modelArtifact,JoinType.INNER);
    }

    public <C, T> BasicSetJoinImpl(Path<Z> parentPath, Metamodel metamodel, Class<E> javaClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, Bindable<T> modelArtifact, JoinType joinType){
