...
public class PathImpl<X> extends ExpressionImpl<X> implements Path<X>, Cloneable{
    ...
    public PathImpl(Path<?> parent, Metamodel metamodel, Class<X> javaClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, Bindable modelArtifact) {
