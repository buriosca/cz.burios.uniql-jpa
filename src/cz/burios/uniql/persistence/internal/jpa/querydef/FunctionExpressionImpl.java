...
public class FunctionExpressionImpl<X> extends ExpressionImpl<X>{
    ...
    protected <T> FunctionExpressionImpl (Metamodel metamodel, Class<X> resultClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, List<Expression<?>> compoundExpressions){
    ...
    public <T> FunctionExpressionImpl (Metamodel metamodel, Class<X> resultClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, List<Expression<?>> compoundExpressions, String operator){
