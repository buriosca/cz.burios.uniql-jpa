...
import cz.burios.uniql.persistence.internal.expressions.ArgumentListFunctionExpression;
...
import cz.burios.uniql.persistence.internal.expressions.SubSelectExpression;
import cz.burios.uniql.persistence.internal.helper.BasicTypeHelperImpl;
...
import cz.burios.uniql.persistence.internal.jpa.metamodel.TypeImpl;
import cz.burios.uniql.persistence.internal.jpa.querydef.AbstractQueryImpl.ResultType;
import cz.burios.uniql.persistence.internal.localization.ExceptionLocalization;
import cz.burios.uniql.persistence.jpa.JpaCriteriaBuilder;
...
public class CriteriaBuilderImpl implements JpaCriteriaBuilder, Serializable {
    ...
    public Predicate and(Expression<Boolean> x, Expression<Boolean> y){
        ...
        cz.burios.uniql.persistence.expressions.Expression currentNode = xp.getCurrentNode().and(yp.getCurrentNode());
    ...
    public Predicate or(Expression<Boolean> x, Expression<Boolean> y){
        ...
        cz.burios.uniql.persistence.expressions.Expression parentNode = xp.getCurrentNode().or(yp.getCurrentNode());
    ...
    public Predicate not(Expression<Boolean> restriction){
        ...
        cz.burios.uniql.persistence.expressions.Expression parentNode = null;
    ...
    public <E, C extends Collection<E>> Predicate isNotMember(Expression<E> elem, Expression<C> collection){
        ...
        cz.burios.uniql.persistence.expressions.ExpressionBuilder elemBuilder = new cz.burios.uniql.persistence.expressions.ExpressionBuilder();
        cz.burios.uniql.persistence.expressions.Expression collectionExp =((InternalSelection)collection).getCurrentNode();
        cz.burios.uniql.persistence.expressions.Expression elemExp =((InternalSelection)elem).getCurrentNode();
    ...
    public Expression<String> concat(Expression<String> x, Expression<String> y){
        ...
        list.add(x);
        list.add(y);
        cz.burios.uniql.persistence.expressions.Expression xNode = ((InternalSelection)x).getCurrentNode();
        cz.burios.uniql.persistence.expressions.Expression yNode = ((InternalSelection)y).getCurrentNode();

        if (xNode.isParameterExpression() && yNode.isParameterExpression()) {
            //some database require the type when concatting two parameters.
            ((cz.burios.uniql.persistence.internal.expressions.ParameterExpression)xNode).setType(ClassConstants.STRING);
    }
    ...
    public <T> Expression<T> function(String name, Class<T> type, Expression<?>... args){
        ...
        List<cz.burios.uniql.persistence.expressions.Expression> params = new ArrayList<cz.burios.uniql.persistence.expressions.Expression>();
     ...
     */
    public <T> Expression<T> fromExpression(cz.burios.uniql.persistence.expressions.Expression expression, Class<T> type) {
     ...
     * This allows for an extended functionality supported in EclipseLink Expressions to be used in Criteria.
     */
    public Expression fromExpression(cz.burios.uniql.persistence.expressions.Expression expression) {
     ...
     */
    public cz.burios.uniql.persistence.expressions.Expression toExpression(Expression expression) {
    ...
    public static class CoalesceImpl<X> extends FunctionExpressionImpl<X> implements Coalesce<X>{
        ...
        protected <T> CoalesceImpl (Metamodel metamodel, Class<X> resultClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, List<Expression<?>> compoundExpressions){
            super(metamodel, resultClass, expressionNode, compoundExpressions);
        }

        protected <T> CoalesceImpl (Metamodel metamodel, Class<X> resultClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, List<Expression<?>> compoundExpressions, String operator){
         ...
         public Coalesce<X> value(X value){
             cz.burios.uniql.persistence.expressions.Expression exp = cz.burios.uniql.persistence.expressions.Expression.from(value, new ExpressionBuilder());
         ...
         public Coalesce<X> value(Expression<? extends X> value){
             cz.burios.uniql.persistence.expressions.Expression exp = ((InternalSelection)value).getCurrentNode();
             exp = cz.burios.uniql.persistence.expressions.Expression.from(exp, currentNode);
             ((FunctionExpression)currentNode).addChild(exp);
             return this;
         }
    }
    ...
    public static class CaseImpl<R> extends FunctionExpressionImpl<R> implements Case<R>{
        ...
        protected <T> CaseImpl (Metamodel metamodel, Class<R> resultClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, List<Expression<?>> compoundExpressions){
            super(metamodel, resultClass, expressionNode, compoundExpressions);
        }

        protected <T> CaseImpl (Metamodel metamodel, Class<R> resultClass, cz.burios.uniql.persistence.expressions.Expression expressionNode, List<Expression<?>> compoundExpressions, String operator){
            super(metamodel, resultClass, expressionNode, compoundExpressions, operator);
        }
        ...
        public Case<R> when(Expression<Boolean> condition, R result){
            cz.burios.uniql.persistence.expressions.Expression conditionExp = ((InternalSelection)condition).getCurrentNode();
            conditionExp = cz.burios.uniql.persistence.expressions.Expression.from(conditionExp, currentNode);
            ((FunctionExpression)currentNode).addChild(conditionExp);
            cz.burios.uniql.persistence.expressions.Expression resultExp = cz.burios.uniql.persistence.expressions.Expression.from(result, new ExpressionBuilder());
        ...
        public Case<R> when(Expression<Boolean> condition, Expression<? extends R> result){
            ...
            conditionExp = cz.burios.uniql.persistence.expressions.Expression.from(conditionExp, currentNode);
            ((FunctionExpression)currentNode).addChild(conditionExp);
            cz.burios.uniql.persistence.expressions.Expression resultExp = ((InternalSelection)result).getCurrentNode();
            resultExp = cz.burios.uniql.persistence.expressions.Expression.from(resultExp, currentNode);
            ((FunctionExpression)currentNode).addChild(resultExp);
            return this;
        }
    ...
    public static class SimpleCaseImpl<C,R> extends FunctionExpressionImpl<R> implements SimpleCase<C, R>{
        ...
        public SimpleCase<C, R> when(C condition, R result){
            cz.burios.uniql.persistence.expressions.Expression conditionExp = cz.burios.uniql.persistence.expressions.Expression.from(condition, new ExpressionBuilder());
            ((FunctionExpression)currentNode).addChild(conditionExp);
            cz.burios.uniql.persistence.expressions.Expression resultExp = cz.burios.uniql.persistence.expressions.Expression.from(result, new ExpressionBuilder());
            ((FunctionExpression)currentNode).addChild(resultExp);
            return this;
