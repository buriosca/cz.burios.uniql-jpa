...
public class RestAdapterClassWriter implements EclipseLinkClassWriter, Opcodes {
    ...
    public static final String REFERENCE_ADAPTER_SHORT_SIGNATURE = "cz/burios/uniql/persistence/jpa/rs/util/xmladapters/ReferenceAdapter";
    ...
    public byte[] writeClass(DynamicClassLoader loader, String className)
        ...
        mv = cw.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/String;Lcz/burios/uniql/persistence/jpa/rs/PersistenceContext;)V", null, null);
        mv.visitCode();
        mv.visitVarInsn(ALOAD, 0);
        mv.visitVarInsn(ALOAD, 1);
        mv.visitVarInsn(ALOAD, 2);
        mv.visitMethodInsn(INVOKESPECIAL, REFERENCE_ADAPTER_SHORT_SIGNATURE, "<init>", "(Ljava/lang/String;Lcz/burios/uniql/persistence/jpa/rs/PersistenceContext;)V", false);        
        mv.visitInsn(RETURN);
        mv.visitMaxs(3, 3);
        mv.visitEnd();
