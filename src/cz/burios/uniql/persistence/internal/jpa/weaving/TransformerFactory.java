 ...
 * weaving. It is called by {@link cz.burios.uniql.persistence.internal.jpa.EntityManagerSetupImpl#predeploy}
 * <p>
 * <i>Note:</i> The Session's Project is is scanned to ensure that weaving is
 * supported and is <b>modified</b> to suit (set the {@link cz.burios.uniql.persistence.descriptors.changetracking.ObjectChangePolicy}
 * for the Descriptor).
 */
...
//                        classDetails.setShouldWeaveFetchGroups(false);
    ...
    protected void log(int level, String msg, Object[] params) {
        ((cz.burios.uniql.persistence.internal.sessions.AbstractSession)session).log(level,
