...
import cz.burios.uniql.persistence.dynamic.EclipseLinkClassWriter;
...
public class CollectionProxyClassWriter implements EclipseLinkClassWriter, Opcodes {
    ...
    private static final String INTERFACE = "cz/burios/uniql/persistence/jpa/rs/util/CollectionProxy";
    ...
    public byte[] writeClass(DynamicClassLoader loader, String className) {
        ...
        // private List<LinkV2> links;
        final FieldVisitor fv = cw.visitField(ACC_PRIVATE, "links", "Ljava/util/List;", "Ljava/util/List<Lcz/burios/uniql/persistence/internal/jpa/rs/metadata/model/LinkV2;>;", null);
        fv.visitEnd();
        ...
        // }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "getLinks", "()Ljava/util/List;", "()Ljava/util/List<Lcz/burios/uniql/persistence/internal/jpa/rs/metadata/model/LinkV2;>;", null);
            mv.visitCode();
            Label l0 = new Label();
            mv.visitLabel(l0);
        ...
        // }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setLinks", "(Ljava/util/List;)V", "(Ljava/util/List<Lcz/burios/uniql/persistence/internal/jpa/rs/metadata/model/LinkV2;>;)V", null);
            mv.visitCode();
            Label l0 = new Label();
            mv.visitLabel(l0);
            ...
            mv.visitLocalVariable("links", "Ljava/util/List;", "Ljava/util/List<Lcz/burios/uniql/persistence/internal/jpa/rs/metadata/model/LinkV2;>;", l0, l2, 1);
            mv.visitMaxs(2, 2);
            mv.visitEnd();
        }
