...
final class ReportItemBuilder extends EclipseLinkAnonymousExpressionVisitor {
	...
	public void visit(IdentificationVariable expression) {
		...
		List<cz.burios.uniql.persistence.expressions.Expression> joinFetchExpressions = null;
			...
			for (Join joinFetch : joinFetches) {
				...
				if (variableName.equals(joinFetchVariableName)) {
					if (joinFetchExpressions == null) {
						joinFetchExpressions = new ArrayList<cz.burios.uniql.persistence.expressions.Expression>();
					}
	...
	/**
	 * This visitor takes care of creating the {@link cz.burios.uniql.persistence.expressions.Expression
