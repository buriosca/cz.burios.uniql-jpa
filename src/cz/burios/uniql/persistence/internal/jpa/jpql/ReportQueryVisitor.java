...
final class ReportQueryVisitor extends ReadAllQueryVisitor {
	...
	/**
	 * This array is used to store the type of the select {@link cz.burios.uniql.persistence.jpa.jpql
	 * parser.Expression JPQL Expression} that is converted into an {@link cz.burios.uniql.persistence.expressions.Expression EclipseLink Expression}.
	 */
	Class<?> type;
	...
	/**
	 * This visitor is responsible to add the {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression
