...
final class TypeResolver implements EclipseLinkExpressionVisitor {
	...
	QueryKey resolveQueryKey(cz.burios.uniql.persistence.jpa.jpql.parser.Expression expression) {
	...
	/**
	 * Visits the given {@link ArithmeticExpression} and creates the appropriate {@link cz.burios.uniql.persistence.expressions.Expression Expression}.
	 *
	...
	/**
	 * Visits the given {@link Expression} and creates the appropriate {@link cz.burios.uniql.persistence.expressions.Expression Expression} that will check the type for each of its children. If the
