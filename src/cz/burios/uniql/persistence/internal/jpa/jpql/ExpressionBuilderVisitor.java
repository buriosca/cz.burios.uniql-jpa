...
import cz.burios.uniql.persistence.internal.expressions.DateConstantExpression;
...
import cz.burios.uniql.persistence.jpa.jpql.parser.*;
...
/**
 * This {@link ExpressionVisitor} visits an {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression
 * JPQL Expression} and creates the corresponding {@link cz.burios.uniql.persistence.expressions.
...
final class ExpressionBuilderVisitor implements EclipseLinkExpressionVisitor {
	...
	private void appendJoinVariables(cz.burios.uniql.persistence.jpa.jpql.parser.Expression expression,
	...
	/**
	 * Creates a new EclipseLink {@link Expression} by visiting the given JPQL {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression Expression}.
	 *
	 * @param expression The {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression Expression} to
	 * convert into an EclipseLink {@link Expression}
	 * @param type The type of the expression
	 * @return The EclipseLink {@link Expression} of the JPQL fragment
	 */
	Expression buildExpression(cz.burios.uniql.persistence.jpa.jpql.parser.Expression expression,
	                           Class<?>[] type) {
	...
	private List<cz.burios.uniql.persistence.jpa.jpql.parser.Expression> children(cz.burios.uniql.persistence.jpa.jpql.parser.Expression expression) {
		ChildrenExpressionVisitor visitor = childrenExpressionVisitor();
		try {
			expression.accept(visitor);
			return new LinkedList<cz.burios.uniql.persistence.jpa.jpql.parser.Expression>(visitor.expressions);
		}
		finally {
	...
	public void visit(CastExpression expression) {
		...
		cz.burios.uniql.persistence.jpa.jpql.parser.Expression databaseType = expression.getDatabaseType();
	...
	public void visit(CoalesceExpression expression) {
		...
		for (cz.burios.uniql.persistence.jpa.jpql.parser.Expression child : expression.getExpression().children()) {
			child.accept(this);
	...
	public void visit(ConcatExpression expression) {
		...
		List<cz.burios.uniql.persistence.jpa.jpql.parser.Expression> expressions = children(expression.getExpression());
		Expression newExpression = null;

		for (cz.burios.uniql.persistence.jpa.jpql.parser.Expression child : expressions) {
			child.accept(this);
	...
	public void visit(FunctionExpression expression) {
		...
		// COLUMN
		if (identifier == cz.burios.uniql.persistence.jpa.jpql.parser.Expression.COLUMN) {
			...
			if (expressions.isEmpty()) {
				...
				// OPERATOR
				if (identifier == cz.burios.uniql.persistence.jpa.jpql.parser.Expression.SQL) {
			...
			// One or more arguments
				...
				// OPERATOR
				else if (identifier == cz.burios.uniql.persistence.jpa.jpql.parser.Expression.OPERATOR) {
	...
	private static class ChildrenExpressionVisitor extends AnonymousExpressionVisitor {
		...
		/**
		 * The list of {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression Expression} that are
		 * the children of an expression.
		 */
		List<cz.burios.uniql.persistence.jpa.jpql.parser.Expression> expressions;
		...
		ChildrenExpressionVisitor() {
			super();
			expressions = new ArrayList<cz.burios.uniql.persistence.jpa.jpql.parser.Expression>();
		}
		...
		@Override
		public void visit(CollectionExpression expression) {
			for (cz.burios.uniql.persistence.jpa.jpql.parser.Expression child : expression.children()) {
		 ...
		 */
		@Override
		protected void visit(cz.burios.uniql.persistence.jpa.jpql.parser.Expression expression) {
	...
	private class InExpressionExpressionBuilder extends EclipseLinkAnonymousExpressionVisitor {
		 ...
		 */
		@Override
		public void visit(cz.burios.uniql.persistence.jpa.jpql.parser.Expression expression) {
			expression.accept(ExpressionBuilderVisitor.this);
		}
	...
	private class InExpressionBuilder extends EclipseLinkAnonymousExpressionVisitor {
		...
		public void visit(InputParameter expression) {
			...
			if (singleInputParameter) {
				...
				visit((cz.burios.uniql.persistence.jpa.jpql.parser.Expression) expression);
			}
		}
