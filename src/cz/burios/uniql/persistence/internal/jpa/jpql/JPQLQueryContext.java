...
import cz.burios.uniql.persistence.jpa.jpql.EclipseLinkLiteralVisitor;
...
final class JPQLQueryContext {
	 ...
	 */
	private cz.burios.uniql.persistence.jpa.jpql.parser.Expression currentQuery;
	...
	/**
	 * The builder that can convert a {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression JPQL
	 ...
	 * {@link cz.burios.uniql.persistence.jpa.query.parser.Expression JPQL Expression}.
	 */
	...
	/**
	 * This resolver is used to calculate the type of any {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression JPQL Expression}.
	 */
	...
	/**
	 * An empty array used when the type of an {@link cz.burios.uniql.persistence.jpa.jpql.parser.
	...
	private JPQLQueryContext(JPQLQueryContext parent,
	                         cz.burios.uniql.persistence.jpa.jpql.parser.Expression currentQuery,
	                         ReportQuery query) {
	...
	/**
	 * Converts the given {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression JPQL Expression}
	 * into an {@link Expression}.
	 *
	 * @param expression The {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression JPQL Expression}
	 ...
	 */
	cz.burios.uniql.persistence.jpa.jpql.parser.Expression getCurrentQuery() {
	 ...
	 */
	Class<?> getType(cz.burios.uniql.persistence.jpa.jpql.parser.Expression expression) {
	 ...
	 */
	String literal(cz.burios.uniql.persistence.jpa.jpql.parser.Expression expression, LiteralType type) {
	 ...
	 */
	void newSubQueryContext(cz.burios.uniql.persistence.jpa.jpql.parser.Expression currentQuery,
	                        ReportQuery query) {
	...
	/**
	 * Resolves the given {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression Expression} and
	 ...
	 *
	 * @param expression The {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression Expression}
	 */
	ClassDescriptor resolveDescriptor(cz.burios.uniql.persistence.jpa.jpql.parser.Expression expression) {
	 ...
	 */
	DatabaseMapping resolveMapping(cz.burios.uniql.persistence.jpa.jpql.parser.Expression expression) {
	 ...
	 */
	Object resolveMappingObject(cz.burios.uniql.persistence.jpa.jpql.parser.Expression expression) {
