 ...
 ******************************************************************************/  
package cz.burios.uniql.persistence.internal.jpa.metadata.accessors.classes;

import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.EL_ACCESS_VIRTUAL;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ACCESS_FIELD;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ACCESS_PROPERTY;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ASSOCIATION_OVERRIDE;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ASSOCIATION_OVERRIDES;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ATTRIBUTE_OVERRIDE;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ATTRIBUTE_OVERRIDES;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_BASIC;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ELEMENT_COLLECTION;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_EMBEDDED;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_EMBEDDED_ID;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ID;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_MANY_TO_MANY;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_MANY_TO_ONE;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_MAPPED_SUPERCLASS;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ONE_TO_MANY;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ONE_TO_ONE;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_TRANSIENT;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_VERSION;
...
import cz.burios.uniql.persistence.annotations.Array;
import cz.burios.uniql.persistence.annotations.BasicCollection;
import cz.burios.uniql.persistence.annotations.BasicMap;
import cz.burios.uniql.persistence.annotations.ChangeTracking;
import cz.burios.uniql.persistence.annotations.CloneCopyPolicy;
import cz.burios.uniql.persistence.annotations.CopyPolicy;
import cz.burios.uniql.persistence.annotations.Customizer;
import cz.burios.uniql.persistence.annotations.ExcludeDefaultMappings;
import cz.burios.uniql.persistence.annotations.InstantiationCopyPolicy;
import cz.burios.uniql.persistence.annotations.Properties;
import cz.burios.uniql.persistence.annotations.Property;
import cz.burios.uniql.persistence.annotations.Struct;
import cz.burios.uniql.persistence.annotations.Structure;
import cz.burios.uniql.persistence.annotations.Transformation;
import cz.burios.uniql.persistence.annotations.VariableOneToOne;
...
import cz.burios.uniql.persistence.internal.jpa.metadata.accessors.mappings.DerivedIdClassAccessor;
...
import cz.burios.uniql.persistence.internal.jpa.metadata.accessors.mappings.EmbeddedIdAccessor;
...
import cz.burios.uniql.persistence.internal.jpa.metadata.accessors.mappings.MappedKeyMapAccessor;
...
import cz.burios.uniql.persistence.internal.jpa.metadata.accessors.objects.MetadataField;
import cz.burios.uniql.persistence.internal.jpa.metadata.accessors.objects.MetadataMethod;
import cz.burios.uniql.persistence.internal.jpa.metadata.changetracking.ChangeTrackingMetadata;
...
import cz.burios.uniql.persistence.internal.jpa.metadata.copypolicy.CloneCopyPolicyMetadata;
import cz.burios.uniql.persistence.internal.jpa.metadata.copypolicy.CopyPolicyMetadata;
import cz.burios.uniql.persistence.internal.jpa.metadata.copypolicy.CustomCopyPolicyMetadata;
import cz.burios.uniql.persistence.internal.jpa.metadata.copypolicy.InstantiationCopyPolicyMetadata;
import cz.burios.uniql.persistence.internal.jpa.metadata.nosql.NoSqlMetadata;
...
import cz.burios.uniql.persistence.platform.database.oracle.annotations.OracleArray;
import cz.burios.uniql.persistence.platform.database.oracle.annotations.OracleArrays;
import cz.burios.uniql.persistence.platform.database.oracle.annotations.OracleObject;
import cz.burios.uniql.persistence.platform.database.oracle.annotations.OracleObjects;
import cz.burios.uniql.persistence.platform.database.oracle.annotations.PLSQLRecord;
import cz.burios.uniql.persistence.platform.database.oracle.annotations.PLSQLRecords;
import cz.burios.uniql.persistence.platform.database.oracle.annotations.PLSQLTable;
import cz.burios.uniql.persistence.platform.database.oracle.annotations.PLSQLTables;
...
public abstract class ClassAccessor extends MetadataAccessor {
    ...
    protected void processNoSql() {
        MetadataAnnotation noSql = getAnnotation("cz.burios.uniql.persistence.nosql.annotations.NoSql");
