...
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_COLLECTION_TABLE;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_COLUMN;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_MAP_KEY;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_MAP_KEY_CLASS;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_MAP_KEY_COLUMN;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_MAP_KEY_ENUMERATED;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_MAP_KEY_JOIN_COLUMN;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_MAP_KEY_JOIN_COLUMNS;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_MAP_KEY_TEMPORAL;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ORDER_BY;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ORDER_COLUMN;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

import cz.burios.uniql.persistence.annotations.CompositeMember;
import cz.burios.uniql.persistence.annotations.DeleteAll;
import cz.burios.uniql.persistence.annotations.MapKeyConvert;
