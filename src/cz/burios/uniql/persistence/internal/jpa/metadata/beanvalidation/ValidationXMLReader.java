 ...
 ******************************************************************************/
package cz.burios.uniql.persistence.internal.jpa.metadata.beanvalidation;
...
import cz.burios.uniql.persistence.exceptions.BeanValidationException;
import cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper;
import cz.burios.uniql.persistence.internal.security.PrivilegedGetContextClassLoader;
 ...
 * {@link cz.burios.uniql.persistence.internal.jpa.metadata.beanvalidation.BeanValidationHelper#CONSTRAINTS_ON_CLASSES}
...
public class ValidationXMLReader implements Callable<Map<Class<?>, Boolean>> {
    ...
    private void parseConstraintFiles() {
        ...
        // cz.burios.uniql.persistence.jaxb.BeanValidationHelper#constraintsOnClasses with value Boolean#TRUE.
