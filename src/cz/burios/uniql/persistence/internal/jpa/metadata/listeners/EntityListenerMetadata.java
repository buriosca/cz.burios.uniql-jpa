 ...
 ******************************************************************************/  
package cz.burios.uniql.persistence.internal.jpa.metadata.listeners;

import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_POST_LOAD;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_POST_PERSIST;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_POST_REMOVE;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_POST_UPDATE;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_PRE_PERSIST;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_PRE_REMOVE;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_PRE_UPDATE;
...
import cz.burios.uniql.persistence.internal.security.PrivilegedGetDeclaredMethods;
import cz.burios.uniql.persistence.internal.security.PrivilegedGetMethods;
