...
import static cz.burios.uniql.persistence.internal.libraries.asm.Opcodes.POP;
import static cz.burios.uniql.persistence.internal.libraries.asm.Opcodes.RETURN;

import cz.burios.uniql.persistence.dynamic.DynamicClassWriter;
...
public class MetadataDynamicClassWriter extends DynamicClassWriter {
    ...
    private static final String LDYNAMIC_ENTITY = "Lcz/burios/uniql/persistence/dynamic/DynamicEntity;";
    ...
    private static final String DYNAMIC_EXCEPTION = "cz/burios/uniql/persistence/exceptions/DynamicException";
