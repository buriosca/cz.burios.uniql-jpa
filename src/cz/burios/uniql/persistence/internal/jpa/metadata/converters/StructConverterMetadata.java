...
import cz.burios.uniql.persistence.config.StructConverterType;
...
public class StructConverterMetadata extends AbstractConverterMetadata {
    ...
    public String getConverterClassName(){
        if (getConverter().equals(StructConverterType.JGeometry)) {
            return "cz.burios.uniql.persistence.platform.database.oracle.converters.JGeometryConverter";
        }
