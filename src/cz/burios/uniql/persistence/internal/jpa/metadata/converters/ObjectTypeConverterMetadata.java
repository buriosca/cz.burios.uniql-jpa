...
public class ObjectTypeConverterMetadata extends TypeConverterMetadata {
    ...
    public void process(DatabaseMapping mapping, MappingAccessor accessor, MetadataClass referenceClass, boolean isForMapKey) {
        cz.burios.uniql.persistence.mappings.converters.ObjectTypeConverter converter;
        ...
        if (objectType.isEnum()) {
            ...
            converter = new cz.burios.uniql.persistence.mappings.converters.ObjectTypeConverter(mapping);
        }
