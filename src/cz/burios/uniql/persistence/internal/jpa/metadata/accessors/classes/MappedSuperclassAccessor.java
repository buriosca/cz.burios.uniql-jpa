...
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_CACHEABLE;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ENTITY_LISTENERS;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_EXCLUDE_DEFAULT_LISTENERS;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_EXCLUDE_SUPERCLASS_LISTENERS;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ID_CLASS;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_NAMED_NATIVE_QUERIES;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_NAMED_NATIVE_QUERY;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_NAMED_QUERIES;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_NAMED_QUERY;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_NAMED_STORED_PROCEDURE_QUERIES;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_NAMED_STORED_PROCEDURE_QUERY;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_SEQUENCE_GENERATOR;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_SQL_RESULT_SET_MAPPING;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_SQL_RESULT_SET_MAPPINGS;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_TABLE_GENERATOR;
...
import cz.burios.uniql.persistence.annotations.AdditionalCriteria;
import cz.burios.uniql.persistence.annotations.Cache;
import cz.burios.uniql.persistence.annotations.CacheIndex;
import cz.burios.uniql.persistence.annotations.CacheIndexes;
import cz.burios.uniql.persistence.annotations.CacheInterceptor;
import cz.burios.uniql.persistence.annotations.ExistenceChecking;
import cz.burios.uniql.persistence.annotations.FetchGroup;
import cz.burios.uniql.persistence.annotations.FetchGroups;
import cz.burios.uniql.persistence.annotations.Multitenant;
import cz.burios.uniql.persistence.annotations.NamedStoredFunctionQueries;
import cz.burios.uniql.persistence.annotations.NamedStoredFunctionQuery;
import cz.burios.uniql.persistence.annotations.OptimisticLocking;
import cz.burios.uniql.persistence.annotations.PrimaryKey;
import cz.burios.uniql.persistence.annotations.QueryRedirectors;
import cz.burios.uniql.persistence.annotations.ReadOnly;
import cz.burios.uniql.persistence.annotations.SerializedObject;
import cz.burios.uniql.persistence.annotations.UuidGenerator;
...
import cz.burios.uniql.persistence.internal.jpa.metadata.cache.CacheInterceptorMetadata;
import cz.burios.uniql.persistence.internal.jpa.metadata.cache.CacheMetadata;
...
import cz.burios.uniql.persistence.internal.jpa.metadata.multitenant.MultitenantMetadata;
...
import cz.burios.uniql.persistence.internal.jpa.metadata.queries.QueryRedirectorsMetadata;
...
import cz.burios.uniql.persistence.internal.jpa.metadata.sop.SerializedObjectPolicyMetadata;
import cz.burios.uniql.persistence.internal.jpa.metadata.xml.XMLEntityMappings;
import cz.burios.uniql.persistence.platform.database.oracle.annotations.NamedPLSQLStoredFunctionQueries;
import cz.burios.uniql.persistence.platform.database.oracle.annotations.NamedPLSQLStoredFunctionQuery;
import cz.burios.uniql.persistence.platform.database.oracle.annotations.NamedPLSQLStoredProcedureQueries;
import cz.burios.uniql.persistence.platform.database.oracle.annotations.NamedPLSQLStoredProcedureQuery;
...
public class MappedSuperclassAccessor extends ClassAccessor {
    ...
    protected void processNamedStoredProcedureQueries() {
        ...
        MetadataAnnotation namedStoredProcedureQueries = getAnnotation(cz.burios.uniql.persistence.annotations.NamedStoredProcedureQueries.class);
        ...
        MetadataAnnotation namedStoredProcedureQuery = getAnnotation(cz.burios.uniql.persistence.annotations.NamedStoredProcedureQuery.class);
