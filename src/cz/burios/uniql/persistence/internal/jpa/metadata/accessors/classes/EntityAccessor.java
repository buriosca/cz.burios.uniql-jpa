...
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_DISCRIMINATOR_COLUMN;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_DISCRIMINATOR_VALUE;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ENTITY;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ENTITY_GRAPH;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_ENTITY_GRAPHS;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_INHERITANCE;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_PRIMARY_KEY_JOIN_COLUMN;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_PRIMARY_KEY_JOIN_COLUMNS;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_SECONDARY_TABLE;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_SECONDARY_TABLES;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_TABLE;
...
import cz.burios.uniql.persistence.annotations.CascadeOnDelete;
import cz.burios.uniql.persistence.annotations.ClassExtractor;
import cz.burios.uniql.persistence.annotations.Index;
import cz.burios.uniql.persistence.annotations.Indexes;
import cz.burios.uniql.persistence.annotations.VirtualAccessMethods;
...
import cz.burios.uniql.persistence.internal.jpa.metadata.listeners.EntityClassListenerMetadata;
