 ...
 ******************************************************************************/  
package cz.burios.uniql.persistence.internal.jpa.metadata.inheritance;

import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_INHERITANCE_JOINED;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_INHERITANCE_SINGLE_TABLE;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_INHERITANCE_TABLE_PER_CLASS;

import cz.burios.uniql.persistence.descriptors.InheritancePolicy;
import cz.burios.uniql.persistence.descriptors.TablePerClassPolicy;
