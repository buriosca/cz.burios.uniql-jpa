 ...
 ******************************************************************************/
package cz.burios.uniql.persistence.internal.jpa.metadata.accessors;
...
import cz.burios.uniql.persistence.annotations.Converter;
import cz.burios.uniql.persistence.annotations.Converters;
import cz.burios.uniql.persistence.annotations.HashPartitioning;
import cz.burios.uniql.persistence.annotations.ObjectTypeConverter;
import cz.burios.uniql.persistence.annotations.ObjectTypeConverters;
import cz.burios.uniql.persistence.annotations.Partitioned;
import cz.burios.uniql.persistence.annotations.Partitioning;
import cz.burios.uniql.persistence.annotations.PinnedPartitioning;
import cz.burios.uniql.persistence.annotations.RangePartitioning;
import cz.burios.uniql.persistence.annotations.ReplicationPartitioning;
import cz.burios.uniql.persistence.annotations.RoundRobinPartitioning;
import cz.burios.uniql.persistence.annotations.SerializedConverter;
import cz.burios.uniql.persistence.annotations.SerializedConverters;
import cz.burios.uniql.persistence.annotations.StructConverter;
import cz.burios.uniql.persistence.annotations.StructConverters;
import cz.burios.uniql.persistence.annotations.TypeConverter;
import cz.burios.uniql.persistence.annotations.TypeConverters;
import cz.burios.uniql.persistence.annotations.UnionPartitioning;
import cz.burios.uniql.persistence.annotations.ValuePartitioning;
import cz.burios.uniql.persistence.descriptors.SingleTableMultitenantPolicy;
...
public abstract class MetadataAccessor extends ORMetadata {
    ...
    protected Integer getValue(Integer value, Integer defaultValue) {
        return cz.burios.uniql.persistence.internal.jpa.metadata.MetadataHelper.getValue(value, defaultValue);
    }
