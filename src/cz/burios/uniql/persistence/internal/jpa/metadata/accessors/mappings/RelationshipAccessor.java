...
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_JOIN_COLUMN;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_JOIN_COLUMNS;
import static cz.burios.uniql.persistence.internal.jpa.metadata.MetadataConstants.JPA_JOIN_TABLE;
...
import cz.burios.uniql.persistence.annotations.JoinFetch;
import cz.burios.uniql.persistence.annotations.Noncacheable;
import cz.burios.uniql.persistence.annotations.PrivateOwned;
...
public abstract class RelationshipAccessor extends MappingAccessor {
    ...
    protected RelationshipAccessor(MetadataAnnotation annotation, MetadataAccessibleObject accessibleObject, ClassAccessor classAccessor) {
        ...
        if (isAnnotationPresent("cz.burios.uniql.persistence.nosql.annotations.JoinFields")) {
            for (Object joinColumn : getAnnotation("cz.burios.uniql.persistence.nosql.annotations.JoinFields").getAttributeArray("value")) {
                m_joinColumns.add(new JoinColumnMetadata((MetadataAnnotation) joinColumn, this));
            }
        }
        
        // Process EIS/NoSQL join field.
        if (isAnnotationPresent("cz.burios.uniql.persistence.nosql.annotations.JoinField")) {
            m_joinColumns.add(new JoinColumnMetadata(getAnnotation("cz.burios.uniql.persistence.nosql.annotations.JoinField"), this));
        }
