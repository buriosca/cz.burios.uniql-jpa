...
public class MetadataConstants {
    ...
    public static final String ECLIPSELINK_PERSISTENCE_PACKAGE_PREFIX = "cz.burios.uniql.persistence";
    public static final String ECLIPSELINK_OXM_PACKAGE_PREFIX = "cz.burios.uniql.persistence.oxm";
