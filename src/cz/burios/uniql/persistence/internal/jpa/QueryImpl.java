...
import cz.burios.uniql.persistence.internal.jpa.querydef.ParameterExpressionImpl;
...
public class QueryImpl {
    ...
    protected Object convertTemporalType(Object value, TemporalType type) {
        ConversionManager conversionManager = ((cz.burios.uniql.persistence.internal.sessions.AbstractSession) getEntityManager().getActiveSession()).getDatasourcePlatform().getConversionManager();
