...
import cz.burios.uniql.persistence.internal.security.PrivilegedGetField;
import cz.burios.uniql.persistence.internal.security.PrivilegedGetMethod;
...
import cz.burios.uniql.persistence.internal.security.PrivilegedSetValueInField;
        ...
        if(getPKClassName() != null){
            try{
                ...
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    aPKClass = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(getPKClassName(), true, classLoader);
                }
                setPKClass(aPKClass);
         ...
         public Object getValue(Object object, AbstractSession session) {
            try {
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    return cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getValueFromField(field, object);
                }
            } catch (Exception ex) {
                throw DescriptorException.errorUsingPrimaryKey(object, policy.getDescriptor(), ex);
            }
