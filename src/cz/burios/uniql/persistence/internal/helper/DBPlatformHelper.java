...
public class DBPlatformHelper {
    private static final String DEFAULTPLATFORM  = "cz.burios.uniql.persistence.platform.database.DatabasePlatform"; // NOI18N

    private final static String PROPERTY_PATH = "cz/burios/uniql/persistence/internal/helper/"; // NOI18N
