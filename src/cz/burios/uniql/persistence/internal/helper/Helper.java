...
import cz.burios.uniql.persistence.internal.core.helper.CoreHelper;
...
public class Helper extends CoreHelper implements Serializable {
    ...
    public static Class getClassFromClasseName(String className, ClassLoader classLoader){
        ...
        try{
            if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                ...
                convertedClass = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(className, true, classLoader);
            }
    ...
    */
    ...
    public static Vector concatenateUniqueVectors(Vector first, Vector second) {
        ...
        concatenation = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance();
