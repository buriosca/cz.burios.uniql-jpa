...
import cz.burios.uniql.persistence.internal.sequencing.SequencingCallback;
import cz.burios.uniql.persistence.internal.sequencing.SequencingCallbackFactory;
...
public interface Accessor extends Cloneable {
     ...
     * Bug 2804663.
     *
     * @see cz.burios.uniql.persistence.internal.helper.LOBValueWriter#buildAndExecuteCallForLocator(DatabaseCall,Session,Accessor)
     */
