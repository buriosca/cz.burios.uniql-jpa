...
import cz.burios.uniql.persistence.internal.helper.DBPlatformHelper;
import cz.burios.uniql.persistence.internal.sequencing.Sequencing;
import cz.burios.uniql.persistence.internal.sequencing.SequencingFactory;
import cz.burios.uniql.persistence.internal.sequencing.SequencingHome;
...
import cz.burios.uniql.persistence.sequencing.SequencingControl;
...
/**
 * Implementation of cz.burios.uniql.persistence.sessions.DatabaseSession
 * The public interface should be used.
 * @see cz.burios.uniql.persistence.sessions.DatabaseSession
 *
 * <p>
 ...
 *    </ul>
 */
public class DatabaseSessionImpl extends AbstractSession implements cz.burios.uniql.persistence.sessions.DatabaseSession {
...
//    protected SessionTuner tuner;
     ...
     * to be given at login but for the other database information to be provided when the session is created.
     */
    public DatabaseSessionImpl(cz.burios.uniql.persistence.sessions.Project project) {
        super(project);
        this.setServerPlatform(new NoServerPlatform(this));
        this.shouldOptimizeResultSetAccess = ObjectLevelReadQuery.isResultSetAccessOptimizedQueryDefault;
    }
     ...
     * @see #addDescriptors(cz.burios.uniql.persistence.sessions.Project)
     */
    @Override
     ...
     */
    public void addDescriptors(cz.burios.uniql.persistence.sessions.Project project) {
        // Reset cached data, as may be invalid later on.
        this.lastDescriptorAccessed = null;
     ...
     * subclassing cz.burios.uniql.persistence.platform.server.ServerPlatformBase (or a subclass),
     * and overriding:
     *
     ...
     *
     * @see cz.burios.uniql.persistence.platform.server.ServerPlatformBase
     */
