 ...
 ******************************************************************************/  
package cz.burios.uniql.persistence.internal.sessions.remote;
...
public class RemoteUnitOfWork extends RepeatableWriteUnitOfWork {
    ...
    public void reinitializeForSession(AbstractSession session, RemoteSessionController parentSessionController) {
        ...
        if (session.isServerSession()) {
            session = ((cz.burios.uniql.persistence.sessions.server.ServerSession)session).acquireClientSession();
        }
        setIsOnClient(false);
