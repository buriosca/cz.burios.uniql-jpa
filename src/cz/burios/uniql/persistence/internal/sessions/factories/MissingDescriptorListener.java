...
import cz.burios.uniql.persistence.eis.EISObjectPersistenceXMLProject;
...
public class MissingDescriptorListener extends SessionEventAdapter {
    protected static String XML_TYPE_CLASS = "cz.burios.uniql.persistence.mappings.xdb.DirectToXMLTypeMapping";
    protected static String EIS_DESCRIPTOR_CLASS = "cz.burios.uniql.persistence.eis.EISDescriptor";
    protected static String XML_INTERACTION_CLASS = "cz.burios.uniql.persistence.eis.interactions.XMLInteraction";
    protected static String EIS_LOGIN_CLASS = "cz.burios.uniql.persistence.eis.EISLogin";
    protected static String XML_BINARY_MAPPING_CLASS = "cz.burios.uniql.persistence.oxm.mappings.XMLBinaryDataMapping";
    protected static String XML_BINARY_COLLECTION_MAPPING_CLASS = "cz.burios.uniql.persistence.oxm.mappings.XMLBinaryDataCollectionMapping";
