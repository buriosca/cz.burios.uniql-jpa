 ...
 ******************************************************************************/
package cz.burios.uniql.persistence.internal.sessions.factories.model.platform;

public class WebSphere_Liberty_Platform_Config extends ServerPlatformConfig {
    public WebSphere_Liberty_Platform_Config() {
        super("cz.burios.uniql.persistence.platform.server.was.WebSphere_Liberty_Platform");
    }
}
