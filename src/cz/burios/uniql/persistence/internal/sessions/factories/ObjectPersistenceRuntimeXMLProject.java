...
import static cz.burios.uniql.persistence.sessions.factories.XMLProjectReader.SCHEMA_DIR;
import static cz.burios.uniql.persistence.sessions.factories.XMLProjectReader.TOPLINK_10_SCHEMA;
...
import cz.burios.uniql.persistence.descriptors.AllFieldsLockingPolicy;
import cz.burios.uniql.persistence.descriptors.CMPPolicy;
import cz.burios.uniql.persistence.descriptors.ChangedFieldsLockingPolicy;
import cz.burios.uniql.persistence.descriptors.ClassDescriptor;
import cz.burios.uniql.persistence.descriptors.DescriptorEvent;
import cz.burios.uniql.persistence.descriptors.DescriptorEventAdapter;
import cz.burios.uniql.persistence.descriptors.DescriptorEventManager;
import cz.burios.uniql.persistence.descriptors.DescriptorQueryManager;
import cz.burios.uniql.persistence.descriptors.FetchGroupManager;
import cz.burios.uniql.persistence.descriptors.InheritancePolicy;
import cz.burios.uniql.persistence.descriptors.InterfacePolicy;
import cz.burios.uniql.persistence.descriptors.PessimisticLockingPolicy;
import cz.burios.uniql.persistence.descriptors.RelationalDescriptor;
import cz.burios.uniql.persistence.descriptors.ReturningPolicy;
import cz.burios.uniql.persistence.descriptors.SelectedFieldsLockingPolicy;
import cz.burios.uniql.persistence.descriptors.TimestampLockingPolicy;
import cz.burios.uniql.persistence.descriptors.VersionLockingPolicy;
import cz.burios.uniql.persistence.descriptors.changetracking.AttributeChangeTrackingPolicy;
import cz.burios.uniql.persistence.descriptors.changetracking.DeferredChangeDetectionPolicy;
import cz.burios.uniql.persistence.descriptors.changetracking.ObjectChangePolicy;
import cz.burios.uniql.persistence.descriptors.changetracking.ObjectChangeTrackingPolicy;
import cz.burios.uniql.persistence.descriptors.copying.AbstractCopyPolicy;
import cz.burios.uniql.persistence.descriptors.copying.CloneCopyPolicy;
import cz.burios.uniql.persistence.descriptors.copying.InstantiationCopyPolicy;
import cz.burios.uniql.persistence.descriptors.invalidation.CacheInvalidationPolicy;
import cz.burios.uniql.persistence.descriptors.invalidation.DailyCacheInvalidationPolicy;
import cz.burios.uniql.persistence.descriptors.invalidation.NoExpiryCacheInvalidationPolicy;
import cz.burios.uniql.persistence.descriptors.invalidation.TimeToLiveCacheInvalidationPolicy;
import cz.burios.uniql.persistence.eis.EISDescriptor;
import cz.burios.uniql.persistence.eis.EISLogin;
import cz.burios.uniql.persistence.eis.mappings.EISCompositeCollectionMapping;
import cz.burios.uniql.persistence.eis.mappings.EISCompositeDirectCollectionMapping;
import cz.burios.uniql.persistence.eis.mappings.EISCompositeObjectMapping;
import cz.burios.uniql.persistence.eis.mappings.EISDirectMapping;
import cz.burios.uniql.persistence.eis.mappings.EISOneToManyMapping;
import cz.burios.uniql.persistence.eis.mappings.EISOneToOneMapping;
import cz.burios.uniql.persistence.eis.mappings.EISTransformationMapping;
...
import cz.burios.uniql.persistence.expressions.ExpressionBuilder;
import cz.burios.uniql.persistence.expressions.ExpressionOperator;
import cz.burios.uniql.persistence.history.HistoryPolicy;
import cz.burios.uniql.persistence.internal.descriptors.FieldTransformation;
import cz.burios.uniql.persistence.internal.descriptors.FieldTranslation;
import cz.burios.uniql.persistence.internal.descriptors.InstantiationPolicy;
import cz.burios.uniql.persistence.internal.descriptors.MethodBasedFieldTransformation;
import cz.burios.uniql.persistence.internal.descriptors.OptimisticLockingPolicy;
import cz.burios.uniql.persistence.internal.descriptors.QueryArgument;
import cz.burios.uniql.persistence.internal.descriptors.QueryKeyReference;
import cz.burios.uniql.persistence.internal.descriptors.TransformerBasedFieldTransformation;
import cz.burios.uniql.persistence.internal.descriptors.TypeMapping;
import cz.burios.uniql.persistence.internal.expressions.ConstantExpression;
import cz.burios.uniql.persistence.internal.expressions.ExpressionOperatorConverter;
import cz.burios.uniql.persistence.internal.expressions.FieldExpression;
...
import cz.burios.uniql.persistence.internal.expressions.ParameterExpression;
import cz.burios.uniql.persistence.internal.expressions.QueryKeyExpression;
...
import cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector;
import cz.burios.uniql.persistence.internal.history.HistoricalDatabaseTable;
import cz.burios.uniql.persistence.internal.identitymaps.CacheIdentityMap;
import cz.burios.uniql.persistence.internal.identitymaps.FullIdentityMap;
import cz.burios.uniql.persistence.internal.identitymaps.HardCacheWeakIdentityMap;
import cz.burios.uniql.persistence.internal.identitymaps.NoIdentityMap;
import cz.burios.uniql.persistence.internal.identitymaps.SoftCacheWeakIdentityMap;
import cz.burios.uniql.persistence.internal.identitymaps.WeakIdentityMap;
import cz.burios.uniql.persistence.internal.indirection.BasicIndirectionPolicy;
import cz.burios.uniql.persistence.internal.indirection.ContainerIndirectionPolicy;
import cz.burios.uniql.persistence.internal.indirection.IndirectionPolicy;
import cz.burios.uniql.persistence.internal.indirection.NoIndirectionPolicy;
import cz.burios.uniql.persistence.internal.indirection.ProxyIndirectionPolicy;
import cz.burios.uniql.persistence.internal.indirection.TransparentIndirectionPolicy;
import cz.burios.uniql.persistence.internal.oxm.Namespace;
import cz.burios.uniql.persistence.internal.oxm.QNameInheritancePolicy;
import cz.burios.uniql.persistence.internal.oxm.XMLConversionPair;
import cz.burios.uniql.persistence.internal.queries.CollectionContainerPolicy;
import cz.burios.uniql.persistence.internal.queries.ContainerPolicy;
import cz.burios.uniql.persistence.internal.queries.InterfaceContainerPolicy;
import cz.burios.uniql.persistence.internal.queries.ListContainerPolicy;
import cz.burios.uniql.persistence.internal.queries.MapContainerPolicy;
import cz.burios.uniql.persistence.internal.queries.MappedKeyMapContainerPolicy;
import cz.burios.uniql.persistence.internal.queries.ReportItem;
...
import cz.burios.uniql.persistence.mappings.AggregateCollectionMapping;
import cz.burios.uniql.persistence.mappings.AggregateMapping;
import cz.burios.uniql.persistence.mappings.AggregateObjectMapping;
import cz.burios.uniql.persistence.mappings.Association;
...
import cz.burios.uniql.persistence.mappings.DirectCollectionMapping;
import cz.burios.uniql.persistence.mappings.DirectMapMapping;
import cz.burios.uniql.persistence.mappings.DirectToFieldMapping;
import cz.burios.uniql.persistence.mappings.ForeignReferenceMapping;
import cz.burios.uniql.persistence.mappings.ManyToManyMapping;
import cz.burios.uniql.persistence.mappings.ObjectReferenceMapping;
import cz.burios.uniql.persistence.mappings.OneToManyMapping;
import cz.burios.uniql.persistence.mappings.OneToOneMapping;
import cz.burios.uniql.persistence.mappings.PropertyAssociation;
import cz.burios.uniql.persistence.mappings.TransformationMapping;
import cz.burios.uniql.persistence.mappings.TypedAssociation;
import cz.burios.uniql.persistence.mappings.VariableOneToOneMapping;
import cz.burios.uniql.persistence.mappings.converters.ClassInstanceConverter;
import cz.burios.uniql.persistence.mappings.converters.Converter;
import cz.burios.uniql.persistence.mappings.converters.ObjectTypeConverter;
import cz.burios.uniql.persistence.mappings.converters.SerializedObjectConverter;
import cz.burios.uniql.persistence.mappings.converters.TypeConversionConverter;
import cz.burios.uniql.persistence.mappings.foundation.AbstractCompositeCollectionMapping;
import cz.burios.uniql.persistence.mappings.foundation.AbstractCompositeDirectCollectionMapping;
import cz.burios.uniql.persistence.mappings.foundation.AbstractCompositeObjectMapping;
import cz.burios.uniql.persistence.mappings.foundation.AbstractDirectMapping;
import cz.burios.uniql.persistence.mappings.foundation.AbstractTransformationMapping;
import cz.burios.uniql.persistence.mappings.querykeys.DirectQueryKey;
import cz.burios.uniql.persistence.mappings.querykeys.ForeignReferenceQueryKey;
import cz.burios.uniql.persistence.mappings.querykeys.OneToManyQueryKey;
import cz.burios.uniql.persistence.mappings.querykeys.OneToOneQueryKey;
import cz.burios.uniql.persistence.mappings.querykeys.QueryKey;
import cz.burios.uniql.persistence.mappings.structures.ArrayMapping;
import cz.burios.uniql.persistence.mappings.structures.NestedTableMapping;
import cz.burios.uniql.persistence.mappings.structures.ObjectArrayMapping;
import cz.burios.uniql.persistence.mappings.structures.ObjectRelationalDataTypeDescriptor;
import cz.burios.uniql.persistence.mappings.structures.ReferenceMapping;
import cz.burios.uniql.persistence.mappings.structures.StructureMapping;
import cz.burios.uniql.persistence.mappings.transformers.ConstantTransformer;
import cz.burios.uniql.persistence.oxm.NamespaceResolver;
import cz.burios.uniql.persistence.oxm.XMLConstants;
import cz.burios.uniql.persistence.oxm.XMLDescriptor;
import cz.burios.uniql.persistence.oxm.XMLField;
import cz.burios.uniql.persistence.oxm.XMLLogin;
import cz.burios.uniql.persistence.oxm.XMLUnionField;
import cz.burios.uniql.persistence.oxm.mappings.XMLAnyCollectionMapping;
import cz.burios.uniql.persistence.oxm.mappings.XMLAnyObjectMapping;
import cz.burios.uniql.persistence.oxm.mappings.XMLCompositeCollectionMapping;
import cz.burios.uniql.persistence.oxm.mappings.XMLCompositeDirectCollectionMapping;
import cz.burios.uniql.persistence.oxm.mappings.XMLCompositeObjectMapping;
import cz.burios.uniql.persistence.oxm.mappings.XMLDirectMapping;
import cz.burios.uniql.persistence.oxm.mappings.XMLTransformationMapping;
import cz.burios.uniql.persistence.oxm.schema.XMLSchemaClassPathReference;
import cz.burios.uniql.persistence.oxm.schema.XMLSchemaFileReference;
import cz.burios.uniql.persistence.oxm.schema.XMLSchemaReference;
import cz.burios.uniql.persistence.oxm.schema.XMLSchemaURLReference;
import cz.burios.uniql.persistence.queries.Call;
import cz.burios.uniql.persistence.queries.DataModifyQuery;
import cz.burios.uniql.persistence.queries.DataReadQuery;
import cz.burios.uniql.persistence.queries.DatabaseQuery;
import cz.burios.uniql.persistence.queries.DeleteAllQuery;
import cz.burios.uniql.persistence.queries.DeleteObjectQuery;
import cz.burios.uniql.persistence.queries.DirectReadQuery;
import cz.burios.uniql.persistence.queries.DoesExistQuery;
import cz.burios.uniql.persistence.queries.FetchGroup;
import cz.burios.uniql.persistence.queries.InMemoryQueryIndirectionPolicy;
import cz.burios.uniql.persistence.queries.InsertObjectQuery;
import cz.burios.uniql.persistence.queries.JPQLCall;
import cz.burios.uniql.persistence.queries.MethodBaseQueryRedirector;
...
import cz.burios.uniql.persistence.queries.ReadObjectQuery;
import cz.burios.uniql.persistence.queries.ReadQuery;
import cz.burios.uniql.persistence.queries.ReportQuery;
import cz.burios.uniql.persistence.queries.SQLCall;
import cz.burios.uniql.persistence.queries.UpdateObjectQuery;
import cz.burios.uniql.persistence.queries.ValueReadQuery;
import cz.burios.uniql.persistence.sequencing.DefaultSequence;
import cz.burios.uniql.persistence.sequencing.NativeSequence;
import cz.burios.uniql.persistence.sequencing.Sequence;
import cz.burios.uniql.persistence.sequencing.TableSequence;
import cz.burios.uniql.persistence.sequencing.UnaryTableSequence;
...
public class ObjectPersistenceRuntimeXMLProject extends NamespaceResolvableProject {
    ...
    protected void buildDescriptors() {
        ...
        try {
            Class typesafeenumClass = new PrivilegedClassForName("cz.burios.uniql.persistence.jaxb.JAXBTypesafeEnumConverter").run();
        ...
        try {
            Class.forName("cz.burios.uniql.persistence.eis.adapters.xmlfile.XMLFileSequence");
    ...
    public ClassDescriptor buildDatasourceLoginDescriptor() {
        ...
        platformMapping.setConverter(new Converter() {
            ...
            private String newPrefix = "cz.burios.uniql.persistence.";
            ...
            public void initialize(DatabaseMapping mapping, Session session) {
                ...
                this.platformList.put("cz.burios.uniql.persistence.internal.databaseaccess.AccessPlatform", "cz.burios.uniql.persistence.platform.database.AccessPlatform");
                this.platformList.put("cz.burios.uniql.persistence.internal.databaseaccess.AttunityPlatform", "cz.burios.uniql.persistence.platform.database.AttunityPlatform");
                this.platformList.put("cz.burios.uniql.persistence.internal.databaseaccess.CloudscapePlatform", "cz.burios.uniql.persistence.platform.database.CloudscapePlatform");
                this.platformList.put("cz.burios.uniql.persistence.internal.databaseaccess.DatabasePlatform", "cz.burios.uniql.persistence.platform.database.DatabasePlatform");
                this.platformList.put("cz.burios.uniql.persistence.internal.databaseaccess.DB2MainframePlatform", "cz.burios.uniql.persistence.platform.database.DB2MainframePlatform");
                this.platformList.put("cz.burios.uniql.persistence.internal.databaseaccess.DB2Platform", "cz.burios.uniql.persistence.platform.database.DB2Platform");
                this.platformList.put("cz.burios.uniql.persistence.internal.databaseaccess.DBasePlatform", "cz.burios.uniql.persistence.platform.database.DBasePlatform");
                this.platformList.put("cz.burios.uniql.persistence.internal.databaseaccess.HSQLPlatform", "cz.burios.uniql.persistence.platform.database.HSQLPlatform");
                this.platformList.put("cz.burios.uniql.persistence.internal.databaseaccess.InformixPlatform", "cz.burios.uniql.persistence.platform.database.InformixPlatform");
                this.platformList.put("cz.burios.uniql.persistence.internal.databaseaccess.OraclePlatform", "cz.burios.uniql.persistence.platform.database.OraclePlatform");
                this.platformList.put("cz.burios.uniql.persistence.internal.databaseaccess.PointBasePlatform", "cz.burios.uniql.persistence.platform.database.PointBasePlatform");
                this.platformList.put("cz.burios.uniql.persistence.internal.databaseaccess.SQLAnyWherePlatform", "cz.burios.uniql.persistence.platform.database.SQLAnywherePlatform");
                this.platformList.put("cz.burios.uniql.persistence.internal.databaseaccess.SQLServerPlatform", "cz.burios.uniql.persistence.platform.database.SQLServerPlatform");
                this.platformList.put("cz.burios.uniql.persistence.internal.databaseaccess.SybasePlatform", "cz.burios.uniql.persistence.platform.database.SybasePlatform");
                this.platformList.put("cz.burios.uniql.persistence.oraclespecific.Oracle8Platform", "cz.burios.uniql.persistence.platform.database.oracle.Oracle8Platform");
                this.platformList.put("cz.burios.uniql.persistence.oraclespecific.Oracle9Platform", "cz.burios.uniql.persistence.platform.database.oracle.Oracle9Platform");
                this.platformList.put("cz.burios.uniql.persistence.platform.database.SQLAnyWherePlatform", "cz.burios.uniql.persistence.platform.database.SQLAnywherePlatform");
    ...
    protected ClassDescriptor buildEventManagerDescriptor() {
        ...
        eventListenersMapping.useCollectionClass(cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.class);
    ...
    protected ClassDescriptor buildSequenceDescriptor() {
        ...
        try {
            descriptor.getInheritancePolicy().addClassIndicator(Class.forName("cz.burios.uniql.persistence.eis.adapters.xmlfile.XMLFileSequence"), getPrimaryNamespaceXPath() + "xmlfile-sequence");
        } catch (Exception missing) {
            // Ignore.
        }
        XMLDirectMapping nameMapping = new XMLDirectMapping();
    ...
    protected ClassDescriptor buildXMLFileSequenceDescriptor() {
        ...
        XMLDescriptor descriptor = new XMLDescriptor();
        try {
            descriptor.setJavaClass(Class.forName("cz.burios.uniql.persistence.eis.adapters.xmlfile.XMLFileSequence"));
        } catch (Exception missing) {
