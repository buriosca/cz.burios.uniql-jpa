 ...
 */
public abstract class ChangeRecord implements Serializable, cz.burios.uniql.persistence.sessions.changesets.ChangeRecord {
    ...
    public cz.burios.uniql.persistence.sessions.changesets.ObjectChangeSet getOwner() {
        return owner;
    }
