...
import cz.burios.uniql.persistence.descriptors.*;
...
import cz.burios.uniql.persistence.internal.descriptors.DescriptorIterator.CascadeCondition;
import cz.burios.uniql.persistence.internal.helper.*;
import cz.burios.uniql.persistence.internal.identitymaps.*;
import cz.burios.uniql.persistence.internal.indirection.DatabaseValueHolder;
import cz.burios.uniql.persistence.internal.indirection.UnitOfWorkQueryValueHolder;
import cz.burios.uniql.persistence.internal.indirection.UnitOfWorkTransformerValueHolder;
...
import cz.burios.uniql.persistence.sessions.coordination.MergeChangeSetCommand;

import java.io.*;

/**
 * Implementation of cz.burios.uniql.persistence.sessions.UnitOfWork
 * The public interface should be used.
 * @see cz.burios.uniql.persistence.sessions.UnitOfWork
 * <p>
 ...
 * 
 */
public class UnitOfWorkImpl extends AbstractSession implements cz.burios.uniql.persistence.sessions.UnitOfWork {
     ...
     */
    public cz.burios.uniql.persistence.sessions.Session acquireHistoricalSession(cz.burios.uniql.persistence.history.AsOfClause clause) throws ValidationException {
            ...
            if (this.shouldPerformDeletesFirst) {
                if (deletedObjects != null) {
                    ...
                    for (Iterator objects = getObjectsDeletedDuringCommit().keySet().iterator();
                             objects.hasNext();) {
                        cz.burios.uniql.persistence.internal.sessions.ObjectChangeSet objectChangeSet = (cz.burios.uniql.persistence.internal.sessions.ObjectChangeSet)this.unitOfWorkChangeSet.getObjectChangeSetForClone(objects.next());
     ...
     */
    public cz.burios.uniql.persistence.sessions.changesets.UnitOfWorkChangeSet getCurrentChanges() {
     ...
     */
    public cz.burios.uniql.persistence.sessions.changesets.UnitOfWorkChangeSet getUnitOfWorkChangeSet() {
    ...
    protected boolean hasModifications() {
        if (((this.unitOfWorkChangeSet != null) && (this.unitOfWorkChangeSet.hasChanges() || ((cz.burios.uniql.persistence.internal.sessions.UnitOfWorkChangeSet)getUnitOfWorkChangeSet()).hasForcedChanges()))
    ...
    public void performRemove(Object toBeDeleted, Map visitedObjects) {
        ...
        if (registeredObject == null) {
            ...
            if (descriptor.getEventManager().hasAnyEventListeners()) {
                cz.burios.uniql.persistence.descriptors.DescriptorEvent event = new cz.burios.uniql.persistence.descriptors.DescriptorEvent(toBeDeleted);
