...
public abstract class DeferrableChangeRecord extends ChangeRecord {
    ...
    public Object getOldValue() {
        if(this.originalCollection != null) {
            ...
            if(getOwner() != null) {
                Object obj = ((cz.burios.uniql.persistence.internal.sessions.ObjectChangeSet)getOwner()).getUnitOfWorkClone();
                AbstractSession session = ((cz.burios.uniql.persistence.internal.sessions.UnitOfWorkChangeSet)getOwner().getUOWChangeSet()).getSession();
