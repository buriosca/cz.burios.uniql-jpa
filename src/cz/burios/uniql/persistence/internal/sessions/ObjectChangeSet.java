 ...
 * <p>
 */
public class ObjectChangeSet implements Serializable, Comparable<ObjectChangeSet>, cz.burios.uniql.persistence.sessions.changesets.ObjectChangeSet {
    ...
    protected List<cz.burios.uniql.persistence.sessions.changesets.ChangeRecord> changes;
     ...
     */
    public cz.burios.uniql.persistence.sessions.changesets.ChangeRecord getChangesForAttributeNamed(String attributeName) {
    ...
    public List<String> getChangedAttributeNames() {
        ...
        for (cz.burios.uniql.persistence.sessions.changesets.ChangeRecord changeRecord : getChanges()) {
     ...
     */
    public List<cz.burios.uniql.persistence.sessions.changesets.ChangeRecord> getChanges() {
        if (this.changes == null) {
            this.changes = new ArrayList<cz.burios.uniql.persistence.sessions.changesets.ChangeRecord>();
        }
        return changes;
    }
     ...
     */
    public Class getClassType(cz.burios.uniql.persistence.sessions.Session session) {
        if (classType == null) {
     ...
     */
    public cz.burios.uniql.persistence.sessions.changesets.UnitOfWorkChangeSet getUOWChangeSet() {
    ...
    protected void updateUOWChangeSet() {
        ...
        if (getUOWChangeSet() != null) {
            ((cz.burios.uniql.persistence.internal.sessions.UnitOfWorkChangeSet)this.getUOWChangeSet()).setHasChanges(this.hasChanges());
        }
    }
