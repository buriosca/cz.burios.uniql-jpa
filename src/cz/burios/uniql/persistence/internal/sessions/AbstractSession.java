 ...
 ******************************************************************************/
package cz.burios.uniql.persistence.internal.sessions;
...
import cz.burios.uniql.persistence.config.ReferenceMode;
...
import cz.burios.uniql.persistence.descriptors.TablePerMultitenantPolicy;
...
import cz.burios.uniql.persistence.exceptions.ConcurrencyException;
...
import cz.burios.uniql.persistence.exceptions.IntegrityChecker;
import cz.burios.uniql.persistence.exceptions.IntegrityException;
import cz.burios.uniql.persistence.exceptions.OptimisticLockException;
...
import cz.burios.uniql.persistence.history.AsOfClause;
...
import cz.burios.uniql.persistence.internal.databaseaccess.Accessor;
import cz.burios.uniql.persistence.internal.databaseaccess.Platform;
import cz.burios.uniql.persistence.internal.descriptors.ObjectBuilder;
...
import cz.burios.uniql.persistence.internal.helper.QueryCounter;
import cz.burios.uniql.persistence.internal.helper.linkedlist.ExposedNodeLinkedList;
import cz.burios.uniql.persistence.internal.history.HistoricalSession;
import cz.burios.uniql.persistence.internal.identitymaps.CacheKey;
import cz.burios.uniql.persistence.internal.identitymaps.IdentityMapManager;
import cz.burios.uniql.persistence.internal.indirection.DatabaseValueHolder;
import cz.burios.uniql.persistence.internal.indirection.ProtectedValueHolder;
...
import cz.burios.uniql.persistence.internal.sequencing.Sequencing;
import cz.burios.uniql.persistence.internal.sessions.cdi.DisabledEntityListenerInjectionManager;
import cz.burios.uniql.persistence.internal.sessions.cdi.EntityListenerInjectionManager;
import cz.burios.uniql.persistence.logging.DefaultSessionLog;
import cz.burios.uniql.persistence.logging.SessionLog;
import cz.burios.uniql.persistence.logging.SessionLogEntry;
...
import cz.burios.uniql.persistence.queries.WriteObjectQuery;
import cz.burios.uniql.persistence.sessions.CopyGroup;
...
import cz.burios.uniql.persistence.sessions.ObjectCopyingPolicy;
import cz.burios.uniql.persistence.sessions.Project;
import cz.burios.uniql.persistence.sessions.SessionEventManager;
...
import cz.burios.uniql.persistence.sessions.coordination.CommandManager;
import cz.burios.uniql.persistence.sessions.coordination.CommandProcessor;
...
/**
 * Implementation of cz.burios.uniql.persistence.sessions.Session
 * The public interface should be used.
 * @see cz.burios.uniql.persistence.sessions.Session
 *
 * <p>
 ...
 */
public abstract class AbstractSession extends CoreAbstractSession<ClassDescriptor, Login, Platform, Project, SessionEventManager> implements cz.burios.uniql.persistence.sessions.Session, CommandProcessor, java.io.Serializable, java.lang.Cloneable {
     ...
     *  managed objects.
     *  @see cz.burios.uniql.persistence.config.ReferenceMode
     */
    ...
    * Optimization specified by the session is ignored if incompatible with other query settings. 
    ...
    public AbstractSession(Login login) {
        this(new cz.burios.uniql.persistence.sessions.Project(login));
    }
     ...
     * to be given at login but for the other database information to be provided when the session is created.
     */
    public AbstractSession(cz.burios.uniql.persistence.sessions.Project project) {
        this();
    ...
    protected JPAQueryBuilder buildDefaultQueryBuilder() {
        ...
        if (queryBuilderClassName == null) {
            queryBuilderClassName = "cz.burios.uniql.persistence.internal.jpa.jpql.HermesParser";
            //queryBuilderClassName = "cz.burios.uniql.persistence.queries.ANTLRQueryBuilder";
        }
     ...
     */
    public cz.burios.uniql.persistence.sessions.Session acquireHistoricalSession(AsOfClause clause) throws ValidationException {
   ...
   /**
    ...
    protected synchronized void addQuery(DatabaseQuery query, boolean nameMustBeUnique) {
        ...
        if (queriesByName == null) {
            ...
            queriesByName = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance();
    ...
    public EntityListenerInjectionManager createEntityListenerInjectionManager(Object beanManager){
        try{
            if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                ...
                Class elim = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(EntityListenerInjectionManager.DEFAULT_CDI_INJECTION_MANAGER, true, getLoader()); 
     ...
     */
    public cz.burios.uniql.persistence.sessions.Session getActiveSession() {
        cz.burios.uniql.persistence.sessions.Session activeSession = getActiveUnitOfWork();
     ...
     */
    public cz.burios.uniql.persistence.sessions.UnitOfWork getActiveUnitOfWork() {
        ...
        /* Steven Vo:  CR# 2517
          ...
          */
        if (isClientSession()) {
            return ((cz.burios.uniql.persistence.sessions.server.ClientSession)this).getParent().getActiveUnitOfWork();
        }
     ...
     * @see #acquireHistoricalSession(cz.burios.uniql.persistence.history.AsOfClause)
     */
     ...
     *
     * @see cz.burios.uniql.persistence.sessions.Project#setDefaultReadOnlyClasses(Vector)
     */
     ...
     *
     * @see cz.burios.uniql.persistence.transaction.JTATransactionController
     */
     ...
     */
    public cz.burios.uniql.persistence.sessions.IdentityMapAccessor getIdentityMapAccessor() {
     ...
     */
    public cz.burios.uniql.persistence.internal.sessions.IdentityMapAccessor getIdentityMapAccessorInstance() {
        return identityMapAccessor;
    }
     ...
     */
    public cz.burios.uniql.persistence.sessions.Project getProject() {
        return project;
    }
    ...
    public void initializeIdentityMapAccessor() {
        this.identityMapAccessor = new cz.burios.uniql.persistence.internal.sessions.IdentityMapAccessor(this, new IdentityMapManager(this));
    }
     ...
     */
    public void setProject(cz.burios.uniql.persistence.sessions.Project project) {
        this.project = project;
    }
