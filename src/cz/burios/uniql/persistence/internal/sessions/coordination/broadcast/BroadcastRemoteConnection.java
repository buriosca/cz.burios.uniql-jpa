 ...
 ******************************************************************************/  
package cz.burios.uniql.persistence.internal.sessions.coordination.broadcast;

import cz.burios.uniql.persistence.exceptions.CommunicationException;
...
import cz.burios.uniql.persistence.sessions.coordination.broadcast.BroadcastTransportManager;
    ...
    public Object executeCommand(Command command) throws CommunicationException {
        if (isActive()) {
            try {
                ...
                // cz.burios.uniql.persistence.internal.sessions.coordination.CommandPropagator.propagateCommand.
