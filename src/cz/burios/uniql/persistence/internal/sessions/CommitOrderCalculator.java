...
import cz.burios.uniql.persistence.internal.helper.DescriptorCompare;
...
public class CommitOrderCalculator {
    ...
    public Vector getOrderedClasses() {
        Vector orderedClasses = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(getOrderedDescriptors().size());
