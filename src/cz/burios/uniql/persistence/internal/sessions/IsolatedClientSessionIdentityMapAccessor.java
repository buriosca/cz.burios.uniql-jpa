 ...
 */
public class IsolatedClientSessionIdentityMapAccessor extends cz.burios.uniql.persistence.internal.sessions.IdentityMapAccessor {
    ...
    */
    ...
    protected Object getAndCloneCacheKeyFromParent(Object primaryKey, Object objectToClone, Class theClass, boolean shouldReturnInvalidatedObjects, ClassDescriptor descriptor) {
        ...
        if (cacheKey == null || cacheKey.isIsolated() || cacheKey.getOwningMap() == null){
            cz.burios.uniql.persistence.internal.sessions.IdentityMapAccessor parentIdentityMapAccessor = session.getParent().getIdentityMapAccessorInstance();
