 ...
 ******************************************************************************/  
package cz.burios.uniql.persistence.internal.queries;
...
import cz.burios.uniql.persistence.internal.databaseaccess.DatasourceCall;
...
import cz.burios.uniql.persistence.mappings.RelationTableMechanism;
...
public class ExpressionQueryMechanism extends StatementQueryMechanism {
    ...
    public void prepareUpdateObject() {
        ...
        if (useCache == true) { // EL Bug 319759
            if (hasMultipleCalls()) {
                ...
                updateCalls = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
                if (getCall() != null) {
    ...
    public void prepareUpdateAll() {
        ...
        while(it.hasNext()) {
            ...
            if(mapping != null && mapping.isOneToOneMapping()) {
                ...
                values = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(fieldsSize);
                baseExpressions = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(fieldsSize);
                ...
                fields = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
                fields.add(field);
                values = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
                values.add(valueObject);
                baseExpressions = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
        ...
        if (tables_databaseFieldsToValues.size() == 1) {
            ...
            Vector beforeTables = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance();
            Vector afterTables = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance();
            ...
            Vector orderedTables = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(tables_databaseFieldsToValues.size());
    ...
    protected void prepareUpdateAllUsingTempTables(HashMap tables_databaseFieldsToValues, HashMap<DatabaseTable, List<DatabaseField>> tablesToPrimaryKeyFields) {
        ...
        Vector createTableStatements = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(nTables);
        Vector selectStatements = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(nTables);
        Vector updateStatements = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(nTables);
        Vector cleanupStatements = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(nTables);
    ...
    protected Vector buildStatementsForDeleteAllForTempTables() {
        Vector statements = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance();
        ...
        Vector allFields = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance();
    ...
    protected Vector buildStatementsForUpdateAllForTempTables(DatabaseTable table, HashMap databaseFieldsToValues, List<DatabaseField> primaryKeyFields) {
        Vector statements = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(4);
