    ...
    public void convertClassNamesToClasses(ClassLoader classLoader){
        ...
        try {
            ...
            if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                ...
                elementClass = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(elementClassName, true, classLoader);
            }
        ...
        if (keyMethod != null) {
            ...
            try {
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    return cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getValueFromField(keyField, keyElement);
                }
            } catch (IllegalAccessException e) {
                throw QueryException.cannotAccessFieldOnObject(keyField, keyElement);
            }
