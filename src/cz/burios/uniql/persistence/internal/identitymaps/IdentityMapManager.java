 ...
 ******************************************************************************/
package cz.burios.uniql.persistence.internal.identitymaps;
...
import cz.burios.uniql.persistence.descriptors.CacheIndex;
...
import cz.burios.uniql.persistence.internal.helper.WriteLockManager;
...
public class IdentityMapManager implements Serializable, Cloneable {
    ...
    public void printIdentityMap(Class businessClass) {
        ...
        for (Enumeration enumtr = map.keys(); enumtr.hasMoreElements();) {
            cz.burios.uniql.persistence.internal.identitymaps.CacheKey cacheKey = (cz.burios.uniql.persistence.internal.identitymaps.CacheKey)enumtr.nextElement();
