 ...
 *
 * @see            cz.burios.uniql.persistence.internal.indirection.ProxyIndirectionHandler
...
public class ProxyIndirectionPolicy extends BasicIndirectionPolicy {
    ...
    public Object valueFromBatchQuery(ReadQuery batchQuery, AbstractRecord row, ObjectLevelReadQuery originalQuery, CacheKey parentCacheKey) {
        ...
        try {
            ...
            //cz.burios.uniql.persistence.internal.helper.Helper.toDo("*** Should probably throw some sort of TopLink exception here. ***");
            e.printStackTrace();
            return null;
        }
    ...
    public void fixObjectReferences(Object object, Map objectDescriptors, Map processedObjects, ObjectLevelReadQuery query, DistributedSession session) {
        //cz.burios.uniql.persistence.internal.helper.Helper.toDo("*** Something tells me this isn't going to work. *** [X]");
    }
    ...
    public Object validateAttributeOfInstantiatedObject(Object attributeValue) {
        if ((attributeValue != null) && (attributeValue.getClass().getInterfaces().length == 0) && attributeValue instanceof Proxy) {
            //cz.burios.uniql.persistence.internal.helper.Helper.toDo("*** Need a new DescriptorException here. ***");
