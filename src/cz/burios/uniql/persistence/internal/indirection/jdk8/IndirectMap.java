...
/**
 * Java SE 8 additions to {@link cz.burios.uniql.persistence.indirection.IndirectMap}.
 *
 * @author Lukas Jungmann
 */
public class IndirectMap<K, V> extends cz.burios.uniql.persistence.indirection.IndirectMap<K, V> {
