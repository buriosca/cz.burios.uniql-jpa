...
import cz.burios.uniql.persistence.descriptors.CachePolicy;
...
import cz.burios.uniql.persistence.internal.core.descriptors.CoreObjectBuilder;
...
import cz.burios.uniql.persistence.internal.queries.EntityFetchGroup;
import cz.burios.uniql.persistence.internal.queries.JoinedAttributeManager;
import cz.burios.uniql.persistence.internal.sessions.*;
import cz.burios.uniql.persistence.logging.SessionLog;
import cz.burios.uniql.persistence.mappings.*;
import cz.burios.uniql.persistence.mappings.DatabaseMapping.WriteType;
import cz.burios.uniql.persistence.mappings.foundation.*;
...
public class ObjectBuilder extends CoreObjectBuilder<AbstractRecord, AbstractSession, DatabaseField, DatabaseMapping> implements Cloneable, Serializable {
    ...
    protected void postBuildAttributesIntoObjectEvent(Object domainObject, AbstractRecord databaseRow, ObjectBuildingQuery query, boolean forRefresh) {
        ...
        if(descriptorEventManager.hasAnyEventListeners()) {
            ...
            cz.burios.uniql.persistence.descriptors.DescriptorEvent event = new DescriptorEvent(domainObject);
    ...
    public Object copyObject(Object original, CopyGroup copyGroup) {
        ...
        if (copyGroup.shouldCascadeTree()) {
            ...
            // PERF: Avoid events if no listeners.
            if (this.descriptor.getEventManager().hasAnyEventListeners()) {
                cz.burios.uniql.persistence.descriptors.DescriptorEvent event = new cz.burios.uniql.persistence.descriptors.DescriptorEvent(copy);
