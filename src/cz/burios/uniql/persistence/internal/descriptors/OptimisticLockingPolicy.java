...
public interface OptimisticLockingPolicy extends Cloneable, Serializable {
     ...
     * #see this method in VersionLockingPolicy
     */
    public Expression buildDeleteExpression(cz.burios.uniql.persistence.internal.helper.DatabaseTable table, Expression mainExpression, AbstractRecord row);
     ...
     * #see this method in VersionLockingPolicy
     */
    public Expression buildUpdateExpression(cz.burios.uniql.persistence.internal.helper.DatabaseTable table, Expression mainExpression, AbstractRecord translationRow, AbstractRecord modifyRow);
