 ...
 ******************************************************************************/
package cz.burios.uniql.persistence.internal.expressions;

import static cz.burios.uniql.persistence.queries.ReadAllQuery.Direction.CHILD_TO_PARENT;
...
import cz.burios.uniql.persistence.internal.helper.FunctionField;
...
import cz.burios.uniql.persistence.internal.history.DecoratedDatabaseTable;
...
public class SQLSelectStatement extends SQLStatement {
    ...
    public SQLSelectStatement() {
        this.fields = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(2);
