...
public class FunctionExpression extends BaseExpression {
    ...
    public FunctionExpression() {
        this.children = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(2);
    ...
    protected void postCopyIn(Map alreadyDone) {
        ...
        children = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance();
    ...
    public Expression rebuildOn(Expression newBase) {
        ...
        Vector newChildren = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(this.children.size());
    ...
    public Object valueFromObject(Object object, AbstractSession session, AbstractRecord translationRow, int valueHolderPolicy, boolean isObjectUnregistered) {
        ...
        Vector arguments = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(this.children.size());
        for (int index = 1; index < this.children.size(); index++) {
