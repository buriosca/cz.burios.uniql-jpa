...
public abstract class CompoundExpression extends Expression {
    ...
    public Expression twistedForBaseAndContext(Expression newBase, Expression context, Expression oldBase) {
        ...
        if (this.secondChild == null) {
            arguments = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(0);
        } else {
            arguments = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
