 ...
 */
public class SybasePlatform extends cz.burios.uniql.persistence.platform.database.DatabasePlatform {
    ...
    public ExpressionOperator modOperator() {
        ...
        result.printsAs(v);
        result.bePostfix();
        result.setNodeClass(cz.burios.uniql.persistence.internal.expressions.FunctionExpression.class);
        return result;
    }
