...
import cz.burios.uniql.persistence.platform.database.H2Platform;
import cz.burios.uniql.persistence.platform.database.InformixPlatform;
...
public class Informix11Platform extends InformixPlatform {
   ...
   * cz.burios.uniql.persistence.internal.databaseaccess.DatabasePlatform}
   * to mean:</p>
   *
  ...
  /**
   * Overrides {@link
   * cz.burios.uniql.persistence.internal.databaseaccess.DatabasePlatform#writeUpdateOriginalFromTempTableSql(Writer,
  ...
  /**
   * Overrides {@link
   * cz.burios.uniql.persistence.internal.databaseaccess.DatabasePlatform#getObjectFromResultSet(ResultSet,
