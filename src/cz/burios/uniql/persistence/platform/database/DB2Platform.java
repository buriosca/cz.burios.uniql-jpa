 ...
 */
public class DB2Platform extends cz.burios.uniql.persistence.platform.database.DatabasePlatform {
    ...
    public Vector getNativeTableInfo(String table, String creator, AbstractSession session) {
        ...
        return session.executeSelectingCall(new cz.burios.uniql.persistence.queries.SQLCall(query));
    }
