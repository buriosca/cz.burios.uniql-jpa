 ...
 ******************************************************************************/  
 ...
 /*
    ...
    For minimal implementation, compare with:
         C:\PL\JPA\EclipseLink\SVN\cz.burios.uniql.persistence\foundation\cz.burios.uniql.persistence.core\src\org\eclipse\persistence\platform\database\CloudscapePlatform.java
...
* 
**/
public class PervasivePlatform extends cz.burios.uniql.persistence.platform.database.DatabasePlatform {
    ...
    protected ExpressionOperator toNumberOperator() {
        ...
        Vector v = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(2);
    ...
    *      
    *  Taken from
    *  cz.burios.uniql.persistence\foundation\cz.burios.uniql.persistence.core\src\org\eclipse\persistence\platform\database\AccessPlatform.java
    */
    ...
    public ExpressionOperator singleArgumentSubstringOperator() {
        ...
        Vector v = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance();
     ...
     */
     ...
     /** 
     *      
     * Taken from cz.burios.uniql.persistence\foundation\cz.burios.uniql.persistence.core\src\org\eclipse\persistence\platform\database\AccessPlatform.java  
     */
    /* 
	public void printFieldTypeSize(Writer writer, FieldDefinition field, FieldTypeDefinition fieldType,
	...
	*/
     ...
     *      
     * Taken verbatim from cz.burios.uniql.persistence\foundation\cz.burios.uniql.persistence.core\src\org\eclipse\persistence\platform\database\SQLServerPlatform.java  
     *               
     */
     @Override
