 ...
 ******************************************************************************/
package cz.burios.uniql.persistence.platform.server.jboss;
...
import cz.burios.uniql.persistence.platform.server.JMXServerPlatformBase;
import cz.burios.uniql.persistence.services.jboss.MBeanJBossRuntimeServices;
import cz.burios.uniql.persistence.sessions.DatabaseSession;
import cz.burios.uniql.persistence.transaction.jboss.JBossTransactionController;
...
public class JBossPlatform extends JMXServerPlatformBase implements JMXEnabledPlatform {
     ...
     * @see cz.burios.uniql.persistence.platform.server.ServerPlatformBase#isJTAEnabled()
     * @see cz.burios.uniql.persistence.platform.server.ServerPlatformBase#disableJTA()
     * @see cz.burios.uniql.persistence.platform.server.ServerPlatformBase#initializeExternalTransactionController()
     */
     ...
     *     
     *  @see cz.burios.uniql.persistence.internal.helper.JPAClassLoaderHolder
     */
