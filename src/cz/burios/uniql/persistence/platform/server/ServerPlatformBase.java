...
/**
 * PUBLIC:
 * Implementation of cz.burios.uniql.persistence.platform.server.ServerPlatform
 * <p>
 ...
 *
 * @see cz.burios.uniql.persistence.platform.server.ServerPlatform
 */
public abstract class ServerPlatformBase implements ServerPlatform {
     ...
     */
    public void configureProfiler(cz.burios.uniql.persistence.sessions.Session session) {
        return;
    }
     ...
     *
       ...
       * we recommend subclassing cz.burios.uniql.persistence.platform.server.ServerPlatformBase (or a subclass),
       * and overriding:
       *
     ...
     *
     * @return cz.burios.uniql.persistence.logging.SessionLog
     */
    @Override
    public cz.burios.uniql.persistence.logging.SessionLog getServerLog() {
