 ...
 ******************************************************************************/
package cz.burios.uniql.persistence.platform.xml.jaxp;
...
import cz.burios.uniql.persistence.platform.xml.XMLNamespaceResolver;
...
public class JAXPPlatform implements XMLPlatform {
    ...
    @Override
    public boolean validate(Element elem, cz.burios.uniql.persistence.oxm.XMLDescriptor xmlDescriptor, ErrorHandler handler) throws XMLPlatformException {
        return true;
    }
      @Override
