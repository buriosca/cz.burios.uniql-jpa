...
public interface JpaCriteriaBuilder extends javax.persistence.criteria.CriteriaBuilder {
     ...
     */
    <T> Expression<T> fromExpression(cz.burios.uniql.persistence.expressions.Expression expression, Class<T> type);
     ...
     * This allows for an extended functionality supported in EclipseLink Expressions to be used in Criteria.
     */
    Expression fromExpression(cz.burios.uniql.persistence.expressions.Expression expression);
     ...
     */
    cz.burios.uniql.persistence.expressions.Expression toExpression(Expression expression);
