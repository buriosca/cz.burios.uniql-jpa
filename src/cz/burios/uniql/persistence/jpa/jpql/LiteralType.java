...
/**
 * Some {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression Expression} can have a "literal",
 * this enumeration is used to visit an {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression
 ...
 *
 * @see cz.burios.uniql.persistence.jpa.jpql.tools.JPQLQueryContext#literal(cz.burios.uniql.persistence.jpa.jpql.parser.Expression, LiteralType) JPQLQueryContext.literal(Expression, LiteralType)
 * @see LiteralVisitor
 *
 * @version 2.4
 * @since 2.3
