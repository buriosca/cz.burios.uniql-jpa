...
public abstract class Declaration implements JPQLQueryDeclaration {
     ...
     * cz.burios.uniql.persistence.jpa.jpql.parser.IdentificationVariableDeclaration} or
	 * a {@link cz.burios.uniql.persistence.jpa.jpql.parser.CollectionMemberDeclaration} when part
     * of a <b>FROM</b> clause, otherwise it's either the {@link
     * cz.burios.uniql.persistence.jpa.jpql.parser.DeleteClause} or the {@link
     * cz.burios.uniql.persistence.jpa.jpql.parser.UpdateClause}.
	 */
