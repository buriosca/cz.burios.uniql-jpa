...
public abstract class AbstractJPQLQueryBuilder implements IJPQLQueryBuilder {
	...
	/**
	 * Creates the builder that creates the {@link StateObject} for each {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression Expression}.
	 *
	 * @return The builder that will be visiting the {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression Expression}
	 */
	protected abstract BasicStateObjectBuilder buildStateObjectBuilder();

	/**
	 * Returns the builder that creates the {@link StateObject} for each {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression Expression}.
	 *
	 * @return The builder that will be visiting the {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression Expression}
	 */
