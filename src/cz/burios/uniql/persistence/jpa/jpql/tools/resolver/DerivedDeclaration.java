 ...
 *
 * @see cz.burios.uniql.persistence.jpa.jpql.parser.IdentificationVariableDeclaration IdentificationVariableDeclaration
 *
 * @version 2.5
 * @since 2.5
...
public class DerivedDeclaration extends AbstractRangeDeclaration {
	...
	/**
	 * If {@link cz.burios.uniql.persistence.jpa.jpql.parser.CollectionMemberDeclaration#isDerived()} is
