 ...
 * cz.burios.uniql.persistence.jpa.jpql.tools.model.query.StateObject StateObject} based on how it was parsed,
 * which means this formatter can only be used when the
 * {@link cz.burios.uniql.persistence.jpa.jpql.tools.model.query.StateObject StateObject} was created by parsing a JPQL
 * query because it needs to retrieve parsing information from the corresponding
 * {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression Expression}.
 * <p>
 ...
 * {@link cz.burios.uniql.persistence.jpa.jpql.tools.model.query.StateObject StateObject} should reflect the exact string
 * that was parsed. <code>true</code> will use every bit of information contained in the corresponding {@link
 * cz.burios.uniql.persistence.jpa.jpql.parser.Expression Expression} to perfectly match what was parsed;
...
public class DefaultActualJPQLQueryFormatter extends AbstractActualJPQLQueryFormatter {
     ...
     * cz.burios.uniql.persistence.jpa.jpql.tools.model.query.StateObject StateObject} should reflect the exact string that
	 * was parsed: <code>true</code> will use every bit of information contained in the corresponding
	 * {@link cz.burios.uniql.persistence.jpa.jpql.parser.Expression Expression} to perfectly match what
	 ...
	 * cz.burios.uniql.persistence.jpa.jpql.tools.model.query.StateObject StateObject} was modified after its
	 * creation
