...
public class SubExpressionStateObject extends AbstractSingleEncapsulatedExpressionStateObject {
	 ...
	 * @param queryBNFId  The unique identifier of the {@link cz.burios.uniql.persistence.jpa.jpql.parser
	...
	/**
	 * Sets the unique identifier of the {@link cz.burios.uniql.persistence.jpa.jpql.parser.JPQLQueryBNF
	 * JPQLQueryBNF} that is used to parse the encapsulated expression.
	 *
