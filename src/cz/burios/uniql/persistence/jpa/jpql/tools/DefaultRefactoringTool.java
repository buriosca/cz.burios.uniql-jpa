...
import cz.burios.uniql.persistence.jpa.jpql.tools.model.DefaultActualJPQLQueryFormatter;
...
public class DefaultRefactoringTool extends RefactoringTool {
     ...
     * cz.burios.uniql.persistence.jpa.jpql.tools.model.query.StateObject StateObject} representation of the JPQL query
	 ...
	 * @param managedTypeProvider The external form of a provider that gives access to the JPA metadata
	 * @param jpqlQueryBuilder The builder that creates the {@link
     * cz.burios.uniql.persistence.jpa.jpql.tools.model.query.StateObject} representation of the JPQL query
