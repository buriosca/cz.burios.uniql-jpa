...
import cz.burios.uniql.persistence.jpa.jpql.tools.resolver.EclipseLinkDeclarationResolver;
 ...
 *
 * <pre><code> {@link cz.burios.uniql.persistence.jpa.jpql.tools.spi.IQuery IQuery} externalQuery = ...;
 *
 ...
 * setting the {@link cz.burios.uniql.persistence.jpa.jpql.tools.spi.IQuery IQuery}:
 * <pre><code> {@link cz.burios.uniql.persistence.jpa.jpql.parser.JPQLExpression JPQLExpression} jpqlExpression = ...;
 *
 * JPQLQueryContext context = new JPQLQueryContext(DefaultJPQLGrammar.instance());
