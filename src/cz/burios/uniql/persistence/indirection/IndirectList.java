...
import cz.burios.uniql.persistence.internal.indirection.UnitOfWorkValueHolder;
 ...
 * @see cz.burios.uniql.persistence.indirection.IndirectMap
 * @author Big Country
...
// TODO: Rewrite to work directly with Vector#sort(Comparator) when source level will be at least 1.8
    ...
    public String toString() {
        ...
        if (this.isInstantiated()) {
            ...
            return "{" + cz.burios.uniql.persistence.internal.helper.Helper.getShortClassName(this.getClass()) + ": not instantiated}";
        }
    }
