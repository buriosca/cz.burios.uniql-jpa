...
public class DescriptorEventManager extends CoreDescriptorEventManager<DescriptorEvent> implements Cloneable, Serializable {
   ...
   protected static final int NumberOfEvents = 18;
    ...
    public DescriptorEventManager() {
        this.eventSelectors = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(NumberOfEvents);
        this.eventMethods = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(NumberOfEvents);
    ...
    /**
     * INTERNAL:
     * bug 251180 - Missing method cz.burios.uniql.persistence.descriptors.DescriptorEventManager#setAboutToDeleteSelector 
     */
    ...
    public Vector getEventListeners() {
        ...
        if (eventListeners == null) {
            eventListeners = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
        }
