 ...
 *
 * @see cz.burios.uniql.persistence.descriptors.InheritancePolicy#setClassExtractor
 */
public class MethodClassExtractor extends ClassExtractor {
     ...
     */
    public Class extractClassFromRow(Record row, cz.burios.uniql.persistence.sessions.Session session) {
        Class classForRow;
