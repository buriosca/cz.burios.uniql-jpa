...
public interface ObjectChangePolicy extends Serializable {
     ...
     */
    ObjectChangeSet createObjectChangeSetThroughComparison(Object clone, Object backUp, cz.burios.uniql.persistence.internal.sessions.UnitOfWorkChangeSet changeSet, boolean isNew, AbstractSession session, ClassDescriptor descriptor);
