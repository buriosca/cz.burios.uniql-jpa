...
import cz.burios.uniql.persistence.annotations.CacheKeyType;
...
import cz.burios.uniql.persistence.descriptors.changetracking.*;
import cz.burios.uniql.persistence.descriptors.copying.*;
import cz.burios.uniql.persistence.descriptors.invalidation.*;
...
import cz.burios.uniql.persistence.history.*;
import cz.burios.uniql.persistence.internal.databaseaccess.*;
import cz.burios.uniql.persistence.internal.descriptors.*;
import cz.burios.uniql.persistence.internal.dynamic.DynamicEntityImpl;
import cz.burios.uniql.persistence.internal.expressions.SQLSelectStatement;
import cz.burios.uniql.persistence.internal.expressions.SQLStatement;
import cz.burios.uniql.persistence.internal.helper.*;
...
import cz.burios.uniql.persistence.internal.weaving.PersistenceWeavedChangeTracking;
import cz.burios.uniql.persistence.mappings.*;
import cz.burios.uniql.persistence.mappings.foundation.AbstractColumnMapping;
import cz.burios.uniql.persistence.mappings.foundation.AbstractDirectMapping;
import cz.burios.uniql.persistence.mappings.querykeys.*;
import cz.burios.uniql.persistence.queries.AttributeGroup;
...
import cz.burios.uniql.persistence.queries.FetchGroupTracker;
...
import cz.burios.uniql.persistence.queries.QueryRedirector;
import cz.burios.uniql.persistence.queries.ReadObjectQuery;
import cz.burios.uniql.persistence.sequencing.Sequence;
import cz.burios.uniql.persistence.sessions.DatabaseRecord;
import cz.burios.uniql.persistence.sessions.Project;
import cz.burios.uniql.persistence.sessions.remote.*;
 ...
 * @see cz.burios.uniql.persistence.mappings.structures.ObjectRelationalDataTypeDescriptor
 * @see cz.burios.uniql.persistence.eis.EISDescriptor
 * @see cz.burios.uniql.persistence.oxm.XMLDescriptor
 */
public class ClassDescriptor extends CoreDescriptor<AttributeGroup, DescriptorEventManager, DatabaseField, InheritancePolicy, InstantiationPolicy, Vector, ObjectBuilder> implements Cloneable, Serializable {
     ...
     *
     * Also note that the {@link cz.burios.uniql.persistence.sessions.UnitOfWork} will not refresh its registered objects.<P>
     *
     ...
     * if you require fresh data, it is better to configure a query with {@link cz.burios.uniql.persistence.queries.ObjectLevelReadQuery#refreshIdentityMapResult}.
     ...
     * query in a {@link cz.burios.uniql.persistence.sessions.remote.RemoteSession}.<P>
     *
     * However, if a query hits the cache, data is not refreshed regardless of how this setting is configured. For example, by
     * default, when a query for a single object based on its primary key is executed, OracleAS TopLink will first look in the
     * cache for the object. If the object is in the cache, the cached object is returned and data is not refreshed. To avoid
     ...
     * Normally, if you require fresh data, it is better to configure a query with {@link cz.burios.uniql.persistence.queries.ObjectLevelReadQuery#refreshIdentityMapResult}.
     * To ensure that refreshes are only done when required, use this method in conjunction with {@link #onlyRefreshCacheIfNewerVersion}.
     *
        ...
        if (getJavaClassName() != null){
            ...
            try{
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    descriptorClass = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(getJavaClassName(), true, classLoader);
                }
        ...
        if (getAmendmentClassName() != null) {
            ...
            try{
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    amendmentClass = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(getAmendmentClassName(), true, classLoader);
                }            
            } catch (ClassNotFoundException exc){
        ...
        if (copyPolicy == null && getCopyPolicyClassName() != null){
            ...
            try{
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    copyPolicyClass = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(getCopyPolicyClassName(), true, classLoader);
                    newCopyPolicy = (CopyPolicy)cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.newInstanceFromClass(copyPolicyClass);
                }
            } catch (ClassNotFoundException exc) {
        ...
        if (this.serializedObjectPolicy != null && this.serializedObjectPolicy instanceof SerializedObjectPolicyWrapper) {
            ...
            try{
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    serializedObjectPolicyClass = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(serializedObjectPolicyClassName, true, classLoader);
                    newSerializedObjectPolicy = (SerializedObjectPolicy)cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.newInstanceFromClass(serializedObjectPolicyClass);
                }
            } catch (ClassNotFoundException exc) {
        ...
        if (this.defaultQueryRedirectorClassName != null){
            try{
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    redirectorClass = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(defaultQueryRedirectorClassName, true, classLoader);
                    setDefaultQueryRedirector((QueryRedirector) cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.newInstanceFromClass(redirectorClass));
                }
            } catch (ClassNotFoundException exc) {
        ...
        if (this.defaultReadObjectQueryRedirectorClassName != null){
            try{
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    redirectorClass = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(defaultReadObjectQueryRedirectorClassName, true, classLoader);
                    setDefaultReadObjectQueryRedirector((QueryRedirector) cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.newInstanceFromClass(redirectorClass));
                }
            } catch (ClassNotFoundException exc) {
        ...
        if (this.defaultReadAllQueryRedirectorClassName != null){
            try{
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    redirectorClass = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(defaultReadAllQueryRedirectorClassName, true, classLoader);
                    setDefaultReadAllQueryRedirector((QueryRedirector) cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.newInstanceFromClass(redirectorClass));
                }
            } catch (ClassNotFoundException exc) {
        ...
        if (this.defaultReportQueryRedirectorClassName != null){
            try{
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    redirectorClass = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(defaultReportQueryRedirectorClassName, true, classLoader);
                    setDefaultReportQueryRedirector((QueryRedirector) cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.newInstanceFromClass(redirectorClass));
                }
            } catch (ClassNotFoundException exc) {
        ...
        if (this.defaultInsertObjectQueryRedirectorClassName != null){
            try{
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    redirectorClass = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(defaultInsertObjectQueryRedirectorClassName, true, classLoader);
                    setDefaultInsertObjectQueryRedirector((QueryRedirector) cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.newInstanceFromClass(redirectorClass));
                }
            } catch (ClassNotFoundException exc) {
        ...
        if (this.defaultUpdateObjectQueryRedirectorClassName != null){
            try{
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    redirectorClass = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(defaultUpdateObjectQueryRedirectorClassName, true, classLoader);
                    setDefaultUpdateObjectQueryRedirector((QueryRedirector) cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.newInstanceFromClass(redirectorClass));
                }
            } catch (ClassNotFoundException exc) {
        ...
        if (this.defaultDeleteObjectQueryRedirectorClassName != null){
            try{
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    redirectorClass = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(defaultDeleteObjectQueryRedirectorClassName, true, classLoader);
                    setDefaultDeleteObjectQueryRedirector((QueryRedirector) cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.newInstanceFromClass(redirectorClass));
                }
            } catch (ClassNotFoundException exc) {
                ...
                if (valueTypeName != null) {
                    ...
                    try {
                        if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()) {
                            ...
                            valueType = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(valueTypeName, true, classLoader);
                        }
                    } catch (ClassNotFoundException exc){
     ...
     * database by any query in a {@link cz.burios.uniql.persistence.sessions.remote.RemoteSession}.
     *
     * @see #alwaysRefreshCacheOnRemote
     */
    ...
    public String getAlias() {
        ...
        if ((alias == null) && (getJavaClassName() != null)) {
            alias = cz.burios.uniql.persistence.internal.helper.Helper.getShortClassName(getJavaClassName());
        }
        return alias;
    }
     ...
     * @see cz.burios.uniql.persistence.sessions.interceptors.CacheInterceptor
     */
     ...
     * @see cz.burios.uniql.persistence.descriptors.invalidation.CacheInvalidationPolicy
     */
    ...
    public DescriptorEventManager getEventManager() {
        ...
        if (eventManager == null) {
            setEventManager(new cz.burios.uniql.persistence.descriptors.DescriptorEventManager());
        }
        return eventManager;
    }
    ...
    public InheritancePolicy getInheritancePolicy() {
        if (inheritancePolicy == null) {
            ...
            setInheritancePolicy(new cz.burios.uniql.persistence.descriptors.InheritancePolicy(this));
        }
    ...
    public DescriptorQueryManager getQueryManager() {
        ...
        if (queryManager == null) {
            setQueryManager(new cz.burios.uniql.persistence.descriptors.DescriptorQueryManager());
        }
        return queryManager;
    }
     ...
     * <LI>the query was configured by calling {@link cz.burios.uniql.persistence.queries.ObjectLevelReadQuery#refreshIdentityMapResult}, or</LI>
     * <LI>the query was a call to {@link cz.burios.uniql.persistence.sessions.Session#refreshObject}</LI>
     * </UL>
     * <P>
     *
     ...
     *
     * Also note that the {@link cz.burios.uniql.persistence.sessions.UnitOfWork} will not refresh its registered objects.
     *
    ...
    */
     ...
     * the database by any query in a {@link cz.burios.uniql.persistence.sessions.remote.RemoteSession}.
     *
     ...
     * not desired. Normally, if you require fresh data, it is better to configure a query with {@link cz.burios.uniql.persistence.queries.ObjectLevelReadQuery#refreshIdentityMapResult}.
     * To ensure that refreshes are only done when required, use this method in conjunction with {@link #onlyRefreshCacheIfNewerVersion}.<P>
     *
     ...
     * is received from the database by any query in a {@link cz.burios.uniql.persistence.sessions.remote.RemoteSession}.
     *
     * @see #alwaysRefreshCacheOnRemote
     * @see #dontAlwaysRefreshCacheOnRemote
     */
     ...
     * refresh the cache if data is received from the database by any query in a {@link cz.burios.uniql.persistence.sessions.remote.RemoteSession}.
     ...
     * its registration (CMP).  Without a WrapperPolicy {@link cz.burios.uniql.persistence.sessions.UnitOfWork#registerExistingObject registerExistingObject}
     * should be called on any object that you intend to change.
     * @return true by default.
     * @see #setShouldRegisterResultsInUnitOfWork
     * @see cz.burios.uniql.persistence.queries.ObjectLevelReadQuery#shouldRegisterResultsInUnitOfWork
     * @bug 2612601
     */
     ...
     *
     * @see cz.burios.uniql.persistence.queries.FetchGroupTracker
     */
     ...
     * 
     * @see cz.burios.uniql.persistence.queries.QueryRedirector
     */
