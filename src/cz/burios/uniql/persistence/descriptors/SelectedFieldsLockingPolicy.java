...
public class SelectedFieldsLockingPolicy extends FieldsLockingPolicy {
     ...
     */
    @Override
    protected List<DatabaseField> getFieldsToCompare(cz.burios.uniql.persistence.internal.helper.DatabaseTable table, AbstractRecord transRow, AbstractRecord modifyRow) {
    ...
    public void initialize(AbstractSession session) {
        ...
        for (int index = 0; index < size; index++) {
            ...
            if (fieldsForTable == null) {
                fieldsForTable = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance();
