...
import cz.burios.uniql.persistence.queries.ComplexQueryResult;
        ...
        for (Iterator iterator = getParentInterfaceNames().iterator(); iterator.hasNext(); ) {
            ...
            try {
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    interfaceClass = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(interfaceName, true, classLoader);
                }
