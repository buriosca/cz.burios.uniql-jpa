 ...
 ******************************************************************************/  
package cz.burios.uniql.persistence.history;
...
import cz.burios.uniql.persistence.internal.history.*;
...
public class HistoryPolicy implements Cloneable, Serializable {
    ...
    public final List<DatabaseTable> getHistoricalTables() {
        if (historicalTables == null) {
            historicalTables = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
        }
    ...
    public void addStartFieldName(String startFieldName) {
        ...
        if (startFields == null) {
            startFields = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance();
