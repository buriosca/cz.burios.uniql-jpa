 ...
 * @see cz.burios.uniql.persistence.expressions.Expression#asOf(AsOfClause)
 * @see cz.burios.uniql.persistence.queries.ObjectLevelReadQuery#setAsOfClause(AsOfClause)
 * @see cz.burios.uniql.persistence.sessions.Session#acquireHistoricalSession(AsOfClause)
 * @see HistoryPolicy
 */
