...
import cz.burios.uniql.persistence.sessions.changesets.UnitOfWorkChangeSet;
...
public interface UnitOfWork extends Session {
     ...
     */
    public cz.burios.uniql.persistence.internal.sessions.AbstractSession getParent();
