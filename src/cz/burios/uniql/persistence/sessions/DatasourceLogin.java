...
import cz.burios.uniql.persistence.Version;
 ...
 */
public abstract class DatasourceLogin implements cz.burios.uniql.persistence.sessions.Login, Serializable, Cloneable {
    ...
    public void setPlatformClassName(String platformClassName) throws ValidationException {
        ...
        if (platformClassName.equals("cz.burios.uniql.persistence.platform.database.oracle.OraclePlatform")) {
            platformClassName = "cz.burios.uniql.persistence.platform.database.OraclePlatform";
        }
