 ...
 ******************************************************************************/  
package cz.burios.uniql.persistence.sessions;
 ...
 * @see UnitOfWork
 * @see DatabaseSession
 * @see cz.burios.uniql.persistence.internal.sessions.AbstractSession
 * @see cz.burios.uniql.persistence.internal.sessions.DatabaseSessionImpl
 * @see cz.burios.uniql.persistence.sessions.server.ServerSession
 * @see cz.burios.uniql.persistence.sessions.server.ClientSession
 */
public interface Session extends CoreSession<ClassDescriptor, Login, Platform, Project, SessionEventManager> {
     ...
     */
    public Session acquireHistoricalSession(cz.burios.uniql.persistence.history.AsOfClause pastTime);
     ...
     * The return value should be used as the cz.burios.uniql.persistence.sessions.UnitOfWork interface
     * 
     * @see UnitOfWork
     */
     ...
     *
     * @see cz.burios.uniql.persistence.descriptors.DescriptorQueryManager#addQuery(String, DatabaseQuery)
     */
     ...
     */
    public cz.burios.uniql.persistence.history.AsOfClause getAsOfClause();
   ...
   /**
     ...
     *
     * @see cz.burios.uniql.persistence.platform.server.CustomServerPlatform
     */
     ...
     * @see cz.burios.uniql.persistence.logging.SessionLog
     */
