...
import cz.burios.uniql.persistence.tools.schemaframework.*;;
...
public class TableCreatorClassGenerator {
    ...
    protected ClassDefinition generateCreatorClass() {
        ...
        classDefinition.setSuperClass("cz.burios.uniql.persistence.tools.schemaframework.TableCreator");
        classDefinition.setPackageName(getPackageName());

        classDefinition.addImport("cz.burios.uniql.persistence.sessions.*");
        classDefinition.addImport("cz.burios.uniql.persistence.tools.schemaframework.*");

        classDefinition.setComment("This class was generated by the TopLink table creator generator." + Helper.cr() + "It stores the meta-data (tables) that define the database schema." + Helper.cr() + "@see cz.burios.uniql.persistence.sessions.factories.TableCreatorClassGenerator");
