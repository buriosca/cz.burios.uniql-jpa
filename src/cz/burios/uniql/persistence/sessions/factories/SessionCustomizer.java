 ...
 * @deprecated replaced by cz.burios.uniql.persistence.config.SessionCustomizer
 */
@Deprecated
public interface SessionCustomizer extends cz.burios.uniql.persistence.config.SessionCustomizer {
