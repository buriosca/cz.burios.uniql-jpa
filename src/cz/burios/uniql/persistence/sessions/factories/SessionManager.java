...
import cz.burios.uniql.persistence.internal.security.PrivilegedGetClassLoaderForClass;
...
public class SessionManager {
     ...
     */
    public cz.burios.uniql.persistence.internal.sessions.AbstractSession getSession(String sessionName) {
     ...
     * @return session with given session name
     */
    public cz.burios.uniql.persistence.internal.sessions.AbstractSession getSession(String sessionName, boolean shouldLoginSession) {
        XMLSessionConfigLoader loader = new XMLSessionConfigLoader();
        loader.setSessionName(sessionName);
     ...
     * @return session with given session name
     */
    public cz.burios.uniql.persistence.internal.sessions.AbstractSession getSession(String sessionName, boolean shouldLoginSession, boolean shouldRefreshSession) {
        XMLSessionConfigLoader loader = new XMLSessionConfigLoader();
        loader.setSessionName(sessionName);
        loader.setShouldLogin(shouldLoginSession);
     ...
     * @return session with given session name
     */
    public cz.burios.uniql.persistence.internal.sessions.AbstractSession getSession(String sessionName, Object objectBean) {
        XMLSessionConfigLoader loader = new XMLSessionConfigLoader();
        loader.setSessionName(sessionName);
     ...
     * @return session with given session name
     */
    public cz.burios.uniql.persistence.internal.sessions.AbstractSession getSession(String sessionName, String filename) {
        XMLSessionConfigLoader loader = new XMLSessionConfigLoader();
        loader.setSessionName(sessionName);
    ...
    public void setDefaultSession(Session defaultSession) {
        this.defaultSession = (cz.burios.uniql.persistence.internal.sessions.AbstractSession)defaultSession;
