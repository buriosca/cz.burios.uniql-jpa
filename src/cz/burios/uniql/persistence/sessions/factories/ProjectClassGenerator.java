...
import cz.burios.uniql.persistence.eis.*;
import cz.burios.uniql.persistence.eis.interactions.*;
...
import cz.burios.uniql.persistence.indirection.IndirectMap;
import cz.burios.uniql.persistence.internal.codegen.*;
...
import cz.burios.uniql.persistence.internal.indirection.*;
...
import cz.burios.uniql.persistence.mappings.converters.*;
...
import cz.burios.uniql.persistence.sequencing.*;
...
public class ProjectClassGenerator {
    ...
    protected void addForeignReferenceMappingLines(NonreflectiveMethodDefinition method, String mappingName, ForeignReferenceMapping mapping) {
        ...
        if (mapping.isCollectionMapping()) {
            ...
            if (mapping.getContainerPolicy().isCollectionPolicy()) {
                ...
                String keyMethodName = ((cz.burios.uniql.persistence.internal.queries.MapContainerPolicy)collectionMapping.getContainerPolicy()).getKeyName();
                if (policy instanceof TransparentIndirectionPolicy) {
    ...
    protected void addMappingLines(NonreflectiveMethodDefinition method, DatabaseMapping mapping) {
        ...
        if (packageName.equals("cz.burios.uniql.persistence.mappings")) {
    ...
    protected void addOptimisticLockingLines(NonreflectiveMethodDefinition method, OptimisticLockingPolicy policy) {
        ...
        if (packageName.equals("cz.burios.uniql.persistence.descriptors")) {
    ...
    protected void addXMLInteractionLines(NonreflectiveMethodDefinition method, XMLInteraction interaction, String variableName) {
        method.addLine("cz.burios.uniql.persistence.eis.XMLInteraction " + variableName + " = new cz.burios.uniql.persistence.eis.XMLInteraction();");
    ...
    protected ClassDefinition generateProjectClass() {
        ...
        classDefinition.setSuperClass("cz.burios.uniql.persistence.sessions.Project");
        classDefinition.setPackageName(getPackageName());

        classDefinition.addImport("cz.burios.uniql.persistence.sessions.*");
        classDefinition.addImport("cz.burios.uniql.persistence.descriptors.*");
        classDefinition.addImport("cz.burios.uniql.persistence.descriptors.invalidation.*");
        classDefinition.addImport("cz.burios.uniql.persistence.mappings.*");
        classDefinition.addImport("cz.burios.uniql.persistence.mappings.converters.*");
        classDefinition.addImport("cz.burios.uniql.persistence.queries.*");
        classDefinition.addImport("cz.burios.uniql.persistence.expressions.ExpressionBuilder");
        classDefinition.addImport("cz.burios.uniql.persistence.history.HistoryPolicy");
        classDefinition.addImport("cz.burios.uniql.persistence.sequencing.*");

        classDefinition.setComment("This class was generated by the TopLink project class generator." + Helper.cr() + "It stores the meta-data (descriptors) that define the TopLink mappings." + Helper.cr() + "## " + DatabaseLogin.getVersion() + " ##" + Helper.cr() + "@see cz.burios.uniql.persistence.sessions.factories.ProjectClassGenerator");
