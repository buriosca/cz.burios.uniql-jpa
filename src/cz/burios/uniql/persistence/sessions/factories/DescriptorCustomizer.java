 ...
 * @deprecated replaced by cz.burios.uniql.persistence.config.DescriptorCustomizer
 */
@Deprecated
public interface DescriptorCustomizer extends cz.burios.uniql.persistence.config.DescriptorCustomizer {
