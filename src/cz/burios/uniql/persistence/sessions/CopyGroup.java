...
public class CopyGroup extends AttributeGroup {
    ...
    protected transient cz.burios.uniql.persistence.internal.sessions.AbstractSession session;
     ...
     */
    public cz.burios.uniql.persistence.internal.sessions.AbstractSession getSession() {
        return session;
    }
     ...
     */
    public void setSession(cz.burios.uniql.persistence.internal.sessions.AbstractSession newSession) {
        session = newSession;
    }
