 ...
 ******************************************************************************/  
package cz.burios.uniql.persistence.expressions;
...
import cz.burios.uniql.persistence.internal.localization.*;
...
public abstract class Expression implements Serializable, Cloneable {
     ...
     * @see cz.burios.uniql.persistence.mappings.ForeignReferenceMapping#batchedValueFromRow
   ...
   public Expression currentTime() {
    ...
    public Expression decode(Map decodeableItems, String defaultItem) {
        ...
        Vector v = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(decodeableItems.size() + 1);
        v.add("DECODE(");
     ...
     * @see #asOf(cz.burios.uniql.persistence.history.AsOfClause)
     * @see #hasAsOfClause()
     */
    ...
    public Vector getFields() {
        return cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
    }
    ...
    public Expression getFunctionWithArguments(String functionName, List arguments) {
        ExpressionOperator anOperator = new ExpressionOperator();
        anOperator.setType(ExpressionOperator.FunctionOperator);
        Vector v = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(arguments.size());
        v.add(functionName + "(");
    ...
    public Expression postfixSQL(String sqlString) {
        ExpressionOperator anOperator = new ExpressionOperator();
        anOperator.setType(ExpressionOperator.FunctionOperator);
        Vector v = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
        v.add(sqlString);
        anOperator.printsAs(v);
