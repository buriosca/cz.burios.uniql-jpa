...
public class ExpressionOperator implements Serializable {
    ...
    public static ExpressionOperator oracleDateName() {
        ...
        Vector v = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(3);
        v.add("TO_CHAR(");
        v.add(", '");
        v.add("')");
    ...
    public Expression expressionFor(Expression base) {
        return expressionForArguments(base, cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(0));
    }
     ...
     * <p>Node classes given belong to cz.burios.uniql.persistence.internal.expressions.
     */
    ...
    public static ExpressionOperator simpleThreeArgumentFunction(int selector, String dbString) {
        ...
        Vector v = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(4);
        v.add(dbString + "(");
        v.add(", ");
        v.add(", ");
        v.add(")");
    ...
    public static ExpressionOperator simpleTwoArgumentFunction(int selector, String dbString) {
        ...
        exOperator.setSelector(selector);
        exOperator.setName(dbString);
        Vector v = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(5);
        v.add(dbString + "(");
        v.add(", ");
        v.add(")");
        exOperator.printsAs(v);
