...
public class ExceptionMessageGenerator {
    ...
    public static String buildMessage(Class exceptionClass, int errorNumber, Object[] arguments) {
        ...
        bundle = ResourceBundle.getBundle("cz.burios.uniql.persistence.exceptions.i18n." + shortClassName + "Resource", Locale.getDefault(), getLoader());
        ...
        try {
            ...
            bundle = ResourceBundle.getBundle("cz.burios.uniql.persistence.exceptions.i18n.ExceptionResource", Locale.getDefault(), getLoader());
