...
public class XMLMarshalExceptionResource extends ListResourceBundle {
    static final Object[][] contents = {
                                           ...
                                           { "25025", "The UnmappedContentHandler class {0} set on the XMLUnmarshaller must implement cz.burios.uniql.persistence.oxm.unmapped.UnmappedContentHandler." },
                                           ...
                                           { "25036", "The custom IDResolver {1} does not support multiple XML IDs {0}.  Custom IDResolvers must be subclasses cz.burios.uniql.persistence.jaxb.IDResolver if multiple IDs are used."},
