...
public class QueryExceptionResource extends ListResourceBundle {
    static final Object[][] contents = {
       ...
       { "6151", "An exception occurred while attempting to set a Redirector {0} passed through a JPA Query Hint {1}.  Please verify that the provided Redirector implements cz.burios.uniql.persistence.queries.QueryRedirector."},
