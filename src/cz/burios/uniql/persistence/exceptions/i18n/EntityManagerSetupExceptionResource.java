...
public class EntityManagerSetupExceptionResource extends ListResourceBundle {
    static final Object[][] contents = {
                                           ...
                                           { "28026", "cz.burios.uniql.persistence.jpa.osgi.PersistenceProvider does not support container deployment (createContainerEntityManagerFactory).  Use cz.burios.uniql.persistence.jpa.PersistenceProvider instead." },
