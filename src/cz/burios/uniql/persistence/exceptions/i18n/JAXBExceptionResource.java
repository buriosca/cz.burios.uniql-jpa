...
******************************************************************************/
package cz.burios.uniql.persistence.exceptions.i18n;
...
public class JAXBExceptionResource extends ListResourceBundle {
    static final Object[][] contents = {
        ...
        {"50029", "The class [{0}] provided on the XmlCustomizer does not implement the cz.burios.uniql.persistence.config.DescriptorCustomizer interface."},
        ...
        {"50038", "DynamicJAXBContext cannot be created from concrete Classes.  Please use cz.burios.uniql.persistence.jaxb.JAXBContext, or specify cz.burios.uniql.persistence.jaxb.JAXBContextFactory in your jaxb.properties file, to create a context from existing Classes."},
