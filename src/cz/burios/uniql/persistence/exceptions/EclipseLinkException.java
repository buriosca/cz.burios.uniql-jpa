...
public abstract class EclipseLinkException extends RuntimeException {
    ...
    protected static String cr() {
        return cz.burios.uniql.persistence.internal.helper.Helper.cr();
    }
    ...
    public String toString() {
        return getIndentationString() + ExceptionMessageGenerator.getHeader("ExceptionHeader") + getErrorCode() + "] (" + cz.burios.uniql.persistence.sessions.DatabaseLogin.getVersion() + "): " + getClass().getName() + getMessage();
    }
