 ...
 ******************************************************************************/  
package cz.burios.uniql.persistence.exceptions;
...
import cz.burios.uniql.persistence.exceptions.i18n.ExceptionMessageGenerator;
...
public class DescriptorException extends ValidationException {
    ...
    public static DescriptorException invalidContainerPolicy(cz.burios.uniql.persistence.internal.queries.ContainerPolicy containerPolicy, Class javaClass) {
    ...
    public static DescriptorException invalidContainerPolicyWithTransparentIndirection(DatabaseMapping mapping, cz.burios.uniql.persistence.internal.queries.ContainerPolicy containerPolicy) {
    ...
    public static DescriptorException invalidIndirectionContainerClass(cz.burios.uniql.persistence.internal.indirection.ContainerIndirectionPolicy policy, Class containerClass) {
    ...
    public static DescriptorException invalidIndirectionPolicyOperation(cz.burios.uniql.persistence.internal.indirection.IndirectionPolicy policy, String operation) {
    ...
    public static DescriptorException invalidUseOfTransparentIndirection(DatabaseMapping mapping) {
        ...
        String message = cz.burios.uniql.persistence.exceptions.i18n.ExceptionMessageGenerator.buildMessage(DescriptorException.class, INVALID_USE_OF_TRANSPARENT_INDIRECTION, args);
    ...
    public static DescriptorException isolateDescriptorReferencedBySharedDescriptor(String referenceClass, String sourceClass, DatabaseMapping mapping) {
        ...
        String message = cz.burios.uniql.persistence.exceptions.i18n.ExceptionMessageGenerator.buildMessage(DescriptorException.class, ISOLATED_DESCRIPTOR_REFERENCED_BY_SHARED_DESCRIPTOR, args);
        DescriptorException exception = new DescriptorException(message, mapping);
    ...
    public static DescriptorException noConstructorIndirectionContainerClass(cz.burios.uniql.persistence.internal.indirection.ContainerIndirectionPolicy policy, Class containerClass) {
        Object[] args = { containerClass };
    ...
    // Bug 2618982
    public static DescriptorException unsupportedTypeForBidirectionalRelationshipMaintenance(DatabaseMapping mapping, cz.burios.uniql.persistence.internal.queries.ContainerPolicy containerPolicy) {
