...
import cz.burios.uniql.persistence.mappings.querykeys.ManyToManyQueryKey;
...
public class QueryException extends ValidationException {
    ...
    public static QueryException illFormedExpression(cz.burios.uniql.persistence.expressions.Expression queryKey) {
    ...
    public static QueryException invalidDatabaseAccessor(cz.burios.uniql.persistence.internal.databaseaccess.Accessor accessor) {
