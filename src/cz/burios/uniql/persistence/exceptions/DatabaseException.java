...
public class DatabaseException extends EclipseLinkException {
    ...
    public static DatabaseException databaseAccessorNotConnected() {
        Object[] args = {  };
        String message = cz.burios.uniql.persistence.exceptions.i18n.ExceptionMessageGenerator.buildMessage(DatabaseException.class, DATABASE_ACCESSOR_NOT_CONNECTED, args);
    ...
    public static DatabaseException synchronizedUnitOfWorkDoesNotSupportCommitAndResume() {
        ...
        String message = cz.burios.uniql.persistence.exceptions.i18n.ExceptionMessageGenerator.buildMessage(DatabaseException.class, SYNCHRONIZED_UNITOFWORK_DOES_NOT_SUPPORT_COMMITANDRESUME, args);
        DatabaseException databaseException = new DatabaseException(message);
