 ...
 * <ul>
 * <li> It must extend the cz.burios.uniql.persistence.descriptors.ClassExtractor
 ...
 *
 * @see cz.burios.uniql.persistence.descriptors.ClassExtractor
 * @see cz.burios.uniql.persistence.descriptors.InheritancePolicy#setWithAllSubclassesExpression(Expression)
 * @see cz.burios.uniql.persistence.descriptors.InheritancePolicy#setOnlyInstancesExpression(Expression)
 *
...
public @interface ClassExtractor {
     ...
     */
    Class<? extends cz.burios.uniql.persistence.descriptors.ClassExtractor> value();
}
