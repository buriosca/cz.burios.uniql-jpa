...
import static cz.burios.uniql.persistence.annotations.CacheCoordinationType.SEND_OBJECT_CHANGES;
import static cz.burios.uniql.persistence.annotations.CacheType.SOFT_WEAK;
import static cz.burios.uniql.persistence.config.CacheIsolationType.SHARED;
 ...
 * @see cz.burios.uniql.persistence.annotations.CacheCoordinationType
 * 
 * @see cz.burios.uniql.persistence.descriptors.ClassDescriptor
...
public @interface Cache {
     ...
     * @see cz.burios.uniql.persistence.config.CacheIsolationType
     */
