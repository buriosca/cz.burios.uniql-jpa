 ...
 ******************************************************************************/
package cz.burios.uniql.persistence.logging;
...
public class JavaLog extends AbstractSessionLog {
     ...
     */
    public static final String TOPLINK_NAMESPACE = "cz.burios.uniql.persistence";
    protected static final String LOGGING_LOCALIZATION_STRING = "cz.burios.uniql.persistence.internal.localization.i18n.LoggingLocalizationResource";
    protected static final String TRACE_LOCALIZATION_STRING = "cz.burios.uniql.persistence.internal.localization.i18n.TraceLocalizationResource";
    ...
    /**
     * Stores the namespace for session, i.e."cz.burios.uniql.persistence.session.<sessionname>".
     */
    private String sessionNameSpace;

    /**
     * Stores the Logger for session namespace, i.e. "cz.burios.uniql.persistence.session.<sessionname>".
     */
