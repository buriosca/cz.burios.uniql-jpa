 ...
 ******************************************************************************/  
package cz.burios.uniql.persistence.tools.profiler;
...
import cz.burios.uniql.persistence.sessions.SessionProfilerAdapter;
...
public class PerformanceProfiler extends SessionProfilerAdapter implements Serializable, Cloneable {
     ...
     */
    public PerformanceProfiler(cz.burios.uniql.persistence.sessions.Session session) {
        this(session, true);
    }
     ...
     * @deprecated replaced by PerformanceProfiler()
     */
    public PerformanceProfiler(cz.burios.uniql.persistence.sessions.Session session, boolean shouldLogProfile) {
        super();
    ...
    public void setSession(cz.burios.uniql.persistence.sessions.Session session) {
        this.session = (AbstractSession)session;
    }
