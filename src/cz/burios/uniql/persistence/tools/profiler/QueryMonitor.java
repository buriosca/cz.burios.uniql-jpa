 ...
 * This monitor is enabled through the System property "cz.burios.uniql.persistence.querymonitor=true" or
...
public class QueryMonitor {
    ...
    public static boolean shouldMonitor() {
        if (shouldMonitor == null) {
            ...
            String property = System.getProperty("cz.burios.uniql.persistence.querymonitor");
