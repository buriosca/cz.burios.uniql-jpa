...
public class StoredProcedureGenerator {
    ...
    public void generateAmendmentClass(Writer outputWriter, String packageName, String className) throws ValidationException {
        ...
        try {
            ...
            outputWriter.write(methodComment);
            outputWriter.write("\npublic static void amendDescriptors(cz.burios.uniql.persistence.sessions.Project project) throws Exception{");
            ...
            outputWriter.write("\n\t\t\tMethod method = " + className + ".class.getMethod(\"amend\"+cz.burios.uniql.persistence.internal.helper.Helper.getShortClassName(descriptor.getJavaClass())+\"ClassDescriptor\", new Class[] {ClassDescriptor.class});");
     ...
     */
    protected void generateSequenceStoredProcedures(cz.burios.uniql.persistence.sessions.Project project) {
     ...
     */
    protected void verify() throws cz.burios.uniql.persistence.exceptions.ValidationException {
        if (getSession().getProject().usesOptimisticLocking()) {
            throw cz.burios.uniql.persistence.exceptions.ValidationException.optimisticLockingNotSupportedWithStoredProcedureGeneration();
        }
    }
