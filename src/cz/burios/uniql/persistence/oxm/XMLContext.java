...
import cz.burios.uniql.persistence.internal.oxm.accessor.OrmAttributeAccessor;
...
import cz.burios.uniql.persistence.oxm.platform.XMLPlatform;
 ...
 *
 *  @see cz.burios.uniql.persistence.oxm.XMLMarshaller
 *  @see cz.burios.uniql.persistence.oxm.XMLUnmarshaller
 *  @see cz.burios.uniql.persistence.oxm.XMLValidator
 *
 */
public class XMLContext extends Context<AbstractSession, XMLDescriptor, XMLField, NamespaceResolver, Project, DatabaseSession, SessionEventListener> {
    ...
    */
    ...
    public ConversionManager getOxmConversionManager() {
        return (cz.burios.uniql.persistence.internal.oxm.ConversionManager) getSession().getDatasourcePlatform().getConversionManager();
    }
