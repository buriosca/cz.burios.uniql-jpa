 ...
 */
public class XMLUnmarshaller extends cz.burios.uniql.persistence.internal.oxm.XMLUnmarshaller<AbstractSession, XMLContext, XMLDescriptor, IDResolver, MediaType, XMLRoot, XMLUnmarshallerHandler, XMLUnmarshalListener> implements Cloneable {

    public static final int NONVALIDATING = cz.burios.uniql.persistence.internal.oxm.XMLUnmarshaller.NONVALIDATING;
    public static final int SCHEMA_VALIDATION = cz.burios.uniql.persistence.internal.oxm.XMLUnmarshaller.SCHEMA_VALIDATION;
    public static final int DTD_VALIDATION = cz.burios.uniql.persistence.internal.oxm.XMLUnmarshaller.DTD_VALIDATION;
    ...
    public UnmarshalRecord createUnmarshalRecord(XMLDescriptor xmlDescriptor, AbstractSession session) {
        cz.burios.uniql.persistence.oxm.record.UnmarshalRecord wrapper = (cz.burios.uniql.persistence.oxm.record.UnmarshalRecord) xmlDescriptor.getObjectBuilder().createRecord((AbstractSession) session);
