 ...
 ******************************************************************************/
package cz.burios.uniql.persistence.oxm.record;
...
import cz.burios.uniql.persistence.core.queries.CoreAttributeGroup;
import cz.burios.uniql.persistence.internal.helper.DatabaseField;
import cz.burios.uniql.persistence.internal.oxm.ContainerValue;
import cz.burios.uniql.persistence.internal.oxm.NodeValue;
import cz.burios.uniql.persistence.internal.oxm.NullCapableValue;
import cz.burios.uniql.persistence.internal.oxm.Reference;
import cz.burios.uniql.persistence.internal.oxm.ReferenceResolver;
import cz.burios.uniql.persistence.internal.oxm.Root;
import cz.burios.uniql.persistence.internal.oxm.SAXFragmentBuilder;
import cz.burios.uniql.persistence.internal.oxm.TreeObjectBuilder;
...
import cz.burios.uniql.persistence.internal.oxm.record.UnmarshalContext;
import cz.burios.uniql.persistence.internal.oxm.record.UnmarshalRecordImpl;
import cz.burios.uniql.persistence.internal.oxm.record.XMLReader;
import cz.burios.uniql.persistence.internal.oxm.record.namespaces.UnmarshalNamespaceResolver;
import cz.burios.uniql.persistence.internal.sessions.AbstractSession;
import cz.burios.uniql.persistence.oxm.IDResolver;
import cz.burios.uniql.persistence.oxm.XMLUnmarshaller;

public class UnmarshalRecord extends XMLRecord implements cz.burios.uniql.persistence.internal.oxm.record.UnmarshalRecord<AbstractSession, DatabaseField, IDResolver, TreeObjectBuilder, DOMRecord, XMLUnmarshaller> {

    private cz.burios.uniql.persistence.internal.oxm.record.UnmarshalRecord<AbstractSession, DatabaseField, IDResolver, TreeObjectBuilder, DOMRecord, XMLUnmarshaller> unmarshalRecord;

    public UnmarshalRecord(cz.burios.uniql.persistence.internal.oxm.record.UnmarshalRecord unmarshalRecord) {
    ...
    public Object get(DatabaseField key) {
        return ((cz.burios.uniql.persistence.internal.oxm.record.UnmarshalRecord) unmarshalRecord)
                .get(key);
    }
     ...
     */
    @Override
    public cz.burios.uniql.persistence.internal.oxm.record.UnmarshalRecord getChildRecord() {
     ...
     */
    @Override
    public cz.burios.uniql.persistence.internal.oxm.record.UnmarshalRecord getChildUnmarshalRecord(
     ...
     */
    @Override
    public cz.burios.uniql.persistence.internal.oxm.record.UnmarshalRecord getParentRecord() {
     ...
     */
    public cz.burios.uniql.persistence.internal.oxm.record.UnmarshalRecord getUnmarshalRecord() {
     ...
     */
    @Override
    public cz.burios.uniql.persistence.internal.oxm.record.UnmarshalRecord initialize(TreeObjectBuilder objectBuilder) {
    ...
    @Override
    public void setChildRecord(cz.burios.uniql.persistence.internal.oxm.record.UnmarshalRecord childRecord) {
     ...
     */
    @Override
    public void setParentRecord(cz.burios.uniql.persistence.internal.oxm.record.UnmarshalRecord parentRecord) {
