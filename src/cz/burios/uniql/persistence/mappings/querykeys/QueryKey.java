...
public class QueryKey implements Cloneable, Serializable {
    ...
    public boolean isAbstractQueryKey() {
        return (this.getClass().equals(cz.burios.uniql.persistence.internal.helper.ClassConstants.QueryKey_Class));
    }
    ...
    public String toString() {
        return cz.burios.uniql.persistence.internal.helper.Helper.getShortClassName(this) + "(" + getName() + ")";
    }
}
