...
import cz.burios.uniql.persistence.internal.expressions.SQLDeleteStatement;
import cz.burios.uniql.persistence.internal.expressions.SQLInsertStatement;
...
import cz.burios.uniql.persistence.mappings.ForeignReferenceMapping.ExtendPessimisticLockScope;
...
public class RelationTableMechanism  implements Cloneable, java.io.Serializable {
    ...
    public RelationTableMechanism() {
        ...
        this.sourceRelationKeyFields = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
        this.targetRelationKeyFields = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
        this.sourceKeyFields = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
        this.targetKeyFields = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
    ...
    protected Vector cloneFields(Vector fields) {
        Vector clonedFields = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance();
