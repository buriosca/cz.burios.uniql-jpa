...
public class UnidirectionalOneToManyMapping extends OneToManyMapping {
     ...
     * @return cz.burios.uniql.persistence.internal.sessions.ChangeRecord
     */
    @Override
    ...
    public void postCalculateChanges(cz.burios.uniql.persistence.sessions.changesets.ChangeRecord changeRecord, UnitOfWorkImpl uow) {
        ...
        while(it.hasNext()) {
            ...
            if(!change.hasChanges()) {
                ...
                ((cz.burios.uniql.persistence.internal.sessions.UnitOfWorkChangeSet)change.getUOWChangeSet()).addObjectChangeSet(change, uow, false);
            }
        }
