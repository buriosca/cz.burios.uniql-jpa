...
import cz.burios.uniql.persistence.indirection.*;
...
public abstract class DatabaseMapping extends CoreMapping<AttributeAccessor, AbstractSession, ContainerPolicy, ClassDescriptor, DatabaseField> implements Cloneable, Serializable {
    ...
    protected static final Vector NO_FIELDS = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(0);
     ...
     */
    public void updateCollectionChangeRecord(cz.burios.uniql.persistence.descriptors.changetracking.CollectionChangeEvent event, ObjectChangeSet objectChangeSet, UnitOfWorkImpl uow) throws DescriptorException {
