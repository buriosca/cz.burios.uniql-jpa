...
public class ObjectRelationalDataTypeDescriptor extends RelationalDescriptor {
    ...
    public ObjectRelationalDataTypeDescriptor() {
        this.orderedFields = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance();
    }
    ...
    public Ref getRef(Object object, AbstractSession session) {
        ...
        statement.getFields().addElement(new cz.burios.uniql.persistence.expressions.ExpressionBuilder().ref());
