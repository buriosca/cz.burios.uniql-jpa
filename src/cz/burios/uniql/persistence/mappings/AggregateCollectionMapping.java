...
import cz.burios.uniql.persistence.expressions.ExpressionMath;
import cz.burios.uniql.persistence.indirection.IndirectList;
import cz.burios.uniql.persistence.indirection.ValueHolder;
...
import cz.burios.uniql.persistence.internal.expressions.SQLUpdateStatement;
...
import cz.burios.uniql.persistence.internal.helper.IdentityHashSet;
import cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector;
import cz.burios.uniql.persistence.internal.identitymaps.CacheId;
import cz.burios.uniql.persistence.internal.identitymaps.CacheKey;
import cz.burios.uniql.persistence.internal.mappings.converters.AttributeNameTokenizer.TokensIterator;
import cz.burios.uniql.persistence.internal.queries.AttributeItem;
...
import cz.burios.uniql.persistence.internal.sessions.AggregateCollectionChangeRecord;
...
import cz.burios.uniql.persistence.internal.sessions.UnitOfWorkChangeSet;
...
import cz.burios.uniql.persistence.mappings.foundation.MapComponentMapping;
...
import cz.burios.uniql.persistence.queries.ModifyQuery;
import cz.burios.uniql.persistence.queries.ObjectBuildingQuery;
import cz.burios.uniql.persistence.queries.ObjectLevelModifyQuery;
import cz.burios.uniql.persistence.queries.ObjectLevelReadQuery;
import cz.burios.uniql.persistence.queries.QueryByExamplePolicy;
...
public class AggregateCollectionMapping extends CollectionMapping implements RelationalMapping, MapComponentMapping, EmbeddableMapping {
    ...
    public AggregateCollectionMapping() {
        ...
        this.sourceKeyFields = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
        this.targetForeignKeyFields = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
    ...
    public Object clone() {
        ...
        mappingObject.setSourceKeyFields(cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(getSourceKeyFields()));
        mappingObject.setTargetForeignKeyFields(cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(getTargetForeignKeyFields()));
     ...
     * changeRecord
     * @return cz.burios.uniql.persistence.internal.sessions.AggregateCollectionChangeRecord the changerecord representing this AggregateCollectionMapping
     * @param owner cz.burios.uniql.persistence.internal.sessions.ObjectChangeSet the ChangeSet that uses this record
     * @param cloneCollection Object the collection to convert
     * @param session cz.burios.uniql.persistence.internal.sessions.AbstractSession
     */
    ...
    public void initializeParentInheritance(ClassDescriptor parentDescriptor, ClassDescriptor childDescriptor, AbstractSession session, 
        ...
        Vector children = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
    ...
    protected void initializeTargetForeignKeyToSourceKeysWithDefaults(AbstractSession session) throws DescriptorException {
        ...
        setSourceKeyFields(cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(sourceKeys));
        for (int index = 0; index < getTargetForeignKeyFields().size(); index++) {
            DatabaseField foreignKeyfield = getTargetForeignKeyFields().get(index);
            foreignKeyfield = getReferenceDescriptor().buildField(foreignKeyfield);
            getTargetForeignKeyFields().set(index, foreignKeyfield);
    ...
    public void setSourceKeyFieldNames(Vector fieldNames) {
        Vector fields = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(fieldNames.size());
