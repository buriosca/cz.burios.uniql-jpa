 ...
 *         "java.lang.NoClassDefFoundError: cz/burios/uniql/persistence/testing/models/jpa21/advanced/enums/Gender"  
 ******************************************************************************/  
...
import cz.burios.uniql.persistence.indirection.IndirectCollection;
...
import cz.burios.uniql.persistence.internal.descriptors.changetracking.AttributeChangeListener;
import cz.burios.uniql.persistence.internal.descriptors.changetracking.ObjectChangeListener;
...
import cz.burios.uniql.persistence.internal.queries.*;
...
import cz.burios.uniql.persistence.internal.sessions.remote.*;
...
public class DirectCollectionMapping extends CollectionMapping implements RelationalMapping {
    ...
    public DirectCollectionMapping() {
        ...
        this.referenceKeyFields = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
     ...
     */
    @Override
    public void postCalculateChanges(cz.burios.uniql.persistence.sessions.changesets.ChangeRecord changeRecord, UnitOfWorkImpl uow) {
     ...
     * @see cz.burios.uniql.persistence.mappings.DirectMapMapping
     */
