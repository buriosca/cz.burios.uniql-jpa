...
import cz.burios.uniql.persistence.internal.descriptors.CascadeLockingPolicy;
...
public class OneToOneMapping extends ObjectReferenceMapping implements RelationalMapping, MapKeyMapping {
    ...
    public OneToOneMapping() {
        ...
        this.foreignKeyFields = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
        this.sourceExpressionsToPostInitialize = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
        this.targetExpressionsToPostInitialize = cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(1);
    ...
    public Expression buildObjectJoinExpression(Expression expression, Expression argument, AbstractSession session) {
        Expression base = ((cz.burios.uniql.persistence.internal.expressions.ObjectExpression)expression).getBaseExpression();
        Expression foreignKeyJoin = null;
        if(this.mechanism == null) {
    ...
    public Object clone() {
        ...
        if(this.mechanism == null) {
            clone.setForeignKeyFields(cz.burios.uniql.persistence.internal.helper.NonSynchronizedVector.newInstance(getForeignKeyFields().size()));
