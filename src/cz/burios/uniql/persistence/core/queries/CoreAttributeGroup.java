 ...
 ******************************************************************************/
package cz.burios.uniql.persistence.core.queries;
...
import cz.burios.uniql.persistence.internal.core.queries.CoreAttributeConverter;
import cz.burios.uniql.persistence.internal.helper.StringHelper;
 ...
 * 
 * @see cz.burios.uniql.persistence.queries.AttributeGroup
...
public class CoreAttributeGroup<
        ...
        if (this.type == null){
            try{
                if (PrivilegedAccessHelper.shouldUsePrivilegedAccess()){
                    ...
                    this.type = cz.burios.uniql.persistence.internal.security.PrivilegedAccessHelper.getClassForName(this.typeName, true, classLoader);
                }
    ...
    /**
     * INTERNAL:
     * Lookup the {@link cz.burios.uniql.persistence.internal.queries.AttributeItem AttributeItem} for the provided attribute name or path.
     * 
     * @return item or null
     * @throws IllegalArgumentException if name is not valid attribute name or path
     */
